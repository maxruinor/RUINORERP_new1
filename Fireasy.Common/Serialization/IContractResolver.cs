            ...
            return _cache.GetOrAdd(type, k =>
            {
                return k.GetProperties()
                    ...
                    .Select(s => new SerializerPropertyMetadata
                    {
                        ...
                        Getter = s.CanRead ? o => ReflectionCache.GetAccessor(s).GetValue(o) : (Func<object, object>)null,
                        //{  if (s.CanRead) { Getter = o => ReflectionCache.GetAccessor(s).GetValue(o) }            },
                        Setter = s.CanWrite ? (o, v) => ReflectionCache.GetAccessor(s).SetValue(o, v) : (Action<object, object>)null,
                        PropertyInfo = s,
