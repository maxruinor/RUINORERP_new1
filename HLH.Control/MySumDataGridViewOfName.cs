...
namespace HLH.WinControl
{
    ...
    ///// </summary>
    //public partial class MySumDataGridViewOfName : System.Windows.Forms.DataGridView
    //{
    ...
    //    public string summaryDescription = "1，带有合计列功能;2,键盘上下可控制";
    ...
    //    public MySumDataGridViewOfName()
    //    {
    //        InitializeComponent();
    //        Ascending = false;
    ...
    //    public MySumDataGridViewOfName(IContainer container)
    //    {
    //        container.Add(this);
    ...
    //    ///数据绑定
    //    /// </summary>
    //    public void BindDataGrid(DataSet ds)
    //    {
    ...
    //        //如果表中已经有ID相同列名，则不处理
    //        if (!MyDataTable.Columns.Contains("ID"))
    //        {
    ...
    //            MyDataRow[MyArray[0].ToString()] = MyDataTable.Compute(MyArray[1], "ID is not null");
    //        }
