...
namespace OutlookStyleControls
{
    ...
    public interface IOutlookGridGroup : IComparable, ICloneable
    {
        ...
        /// 显示群组中要汇总字段的列表
        /// </summary>
        ArrayList GroupListText { get; set; }


        /// <summary>
        /// 要显示的字
        /// </summary>
        ArrayList GroupListShowText { get; set; }
        /// <summary>
    ...
    public class OutlookgGridDefaultGroup : IOutlookGridGroup
    {
        ...
        protected ArrayList _GroupListText;
        protected ArrayList _GroupListShowText;
        ...
        public virtual ArrayList GroupListText
        {
            get
            {
                return _GroupListText;
            }
            set { _GroupListText = value; }
        }



        public virtual ArrayList GroupListShowText
        {
            get
            {
                return _GroupListShowText;
            }
            set { _GroupListShowText = value; }
        }
        ...
        public virtual string Text
        {
            ...
            {
                if (column == null)
                    return string.Format("Unbound group: {0} ({1})", Value.ToString(), itemCount == 1 ? "1 项" : itemCount.ToString() + " 项");
                else
                    return string.Format("{0}: {1} ({2})", column.HeaderText, Value.ToString(), itemCount == 1 ? "1 项" : itemCount.ToString() + " 项");
            }
            set { text = value; }
        }
        ...
        public virtual object Clone()
        {
            ...
            gr.GroupListText = this.GroupListText;
        ...
        #region IOutlookGridGroup 成员

        ArrayList IOutlookGridGroup.GroupListText
        {
            get
            {
                return _GroupListText;
        ...
        ArrayList IOutlookGridGroup.GroupListShowText
        {
            get
            {
                return _GroupListShowText;
    ...
    public class OutlookGridAlphabeticGroup : OutlookgGridDefaultGroup
    {
        ...
        public override string Text
        {
            get
            {
                return string.Format("Alphabetic: {1} ({2})", column.HeaderText, Value.ToString(), itemCount == 1 ? "1 项" : itemCount.ToString() + " 项");
            }
            set { text = value; }
        }
