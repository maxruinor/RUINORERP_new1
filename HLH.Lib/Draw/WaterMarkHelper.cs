//http://www.cnblogs.com/pcajax/archive/2011/03/04/1970875.html
...
namespace HLH.Lib.Draw
{
    ...
    public class WaterMarkHelper
    {
        ...
        /// <param name="maxWidth">最大宽(规格:px)</param>
        /// <param name="maxHeight">最大高(规格:px)</param>
        /// <param name="quality">质量（范围0-100）</param>
