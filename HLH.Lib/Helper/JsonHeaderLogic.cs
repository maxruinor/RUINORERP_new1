...
namespace HLH.Lib.Helper
{
...

    {
        ...
        public Newtonsoft.Json.Linq.JToken Token { get; private set; }



        //内部构造函数，使用FromJToken来创建JsonHeaderLogic

        JsonHeaderLogic(Newtonsoft.Json.Linq.JToken token, string header, IEnumerable<JsonHeaderLogic> children)
        ...
        public static JsonHeaderLogic FromJToken(Newtonsoft.Json.Linq.JToken jtoken)
