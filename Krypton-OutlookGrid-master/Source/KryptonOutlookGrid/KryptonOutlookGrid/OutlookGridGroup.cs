...
namespace JDHSoftware.Krypton.Toolkit.KryptonOutlookGrid
{
    ...
    public class OutlookGridDefaultGroup : IOutlookGridGroup
    {
        ...
        public OutlookGridDefaultGroup()
        {
            _val = null;
            _column = null;
            if (KryptonManager.CurrentGlobalPalette.GetRenderer() == KryptonManager.RenderOffice2007)
                _height = StaticValues._2013OffsetHeight; // special height for office 2013
            else
