...
namespace Netron.GraphLib.Entitology
{
    ...
    [Serializable]
    [Description("结束")]
    [NetronGraphShape("结束", "62C55337-7A55-4BB0-80A5-D8C1338D4ACB", "Workflow", "Netron.GraphLib.Entitology.EndNode",
         "流程结束的节点图形")]
    public class EndNode : Shape
    {
        #region Fields
        ...
        public EndNode() : base()
        {
            ...
            g.DrawString("结束", font, brush, startPoint, format);
        ...
        /// </summary>
        public EndNode(IGraphSite site) : base(site)
        {
        ...
        protected EndNode(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        ...
        public override void AddProperties()
        {
            ...
            Bag.Properties.Add(new PropertySpec("NodeId", typeof(string)));
        ...
        protected override void SetPropertyBagValue(object sender, PropertySpecEventArgs e)
        {
            ...
            switch (e.Property.Name)
            {
                ...
                case "NodeId":
                    ...
                    {
                        mNodeId = System.Convert.ToString(e.Value);
                    }
                    else
                    {
