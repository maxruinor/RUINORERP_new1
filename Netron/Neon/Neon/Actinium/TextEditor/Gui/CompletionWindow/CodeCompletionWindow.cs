...
namespace Netron.Neon.TextEditor.Gui.CompletionWindow
{
	public class CodeCompletionWindow : AbstractCompletionWindow
	{
		...
		{
			System.Diagnostics.Debug.WriteLine("SET DECLARATION VIEW LOCATION.");
		...
		protected override void CaretOffsetChanged(object sender, EventArgs e)
		{
			...
			//System.Diagnostics.Debug.WriteLine("StartOffset {0} endOffset {1} - Offset {2}", startOffset, endOffset, offset);
		...
		void InsertSelectedItem()
		{
			...
			if (data != null) {
				...
				if (endOffset - startOffset > 0) {
					//System.Diagnostics.Debug.WriteLine("start {0} length {1}", startOffset, endOffset - startOffset);
