...
namespace Netron.GraphLib
{
    ...
    /// </summary>
    [Serializable]
    public abstract class Entity : IEntity, IDisposable, ISerializable
    {
        /// <summary>
        /// The default constructor
        /// </summary>
        public object _NodeStepPropertyValue = null;

        /// <summary>
        /// 用于保存所有属性的集合，这个属性是业务性属性，是每个节点，或条件的内容值
        /// </summary>
        public object NodeStepPropertyValue
        {
            get { return _NodeStepPropertyValue; }
            set { _NodeStepPropertyValue = value; }
        }
