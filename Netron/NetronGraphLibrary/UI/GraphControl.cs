...
namespace Netron.GraphLib.UI
{
    ...
    {
        /// <summary>
        /// ����һ���������������̵����ݣ�һ������ͼ��Ӧһ����������WorkFlowConfigData
        /// </summary>
        ...
        /// <summary>
        /// ���е�ǰ��꽹���ʵ�塣��HitHover��HitEntity���������Զ�����
        /// </summary>
                ...
                if ((e.Button == MouseButtons.Left) && (e.Clicks == 2))
                {
                    ...
                    if ((Hover != null) && (typeof(Entity).IsInstanceOfType(Hover)))
                    {
                        if (OnSetNodeProperties != null)
                        {
                            ...
                            {
                                MessageBox.Show("�����õ�ǰ�����ߵ�NodeStepPropertyValue����");
                            }
                            else
                            {
                    ...
                    if ((Hover != null) && Hover.GetType().BaseType.Name == "BaseNode")
                    {
                        ...
                        if (OnSetNodeProperties != null)
                        {
                            if (Hover.NodeStepPropertyValue == null)
                            {
                                MessageBox.Show("�����õ�ǰ�ڵ��NodeStepPropertyValue����");
                            }
                            else
                            {
                                OnSetNodeProperties(Hover, Hover.NodeStepPropertyValue);
                ...
                if (e.Button == MouseButtons.Right)
                {
                    ...
                    if (this.mEnableContextMenu)
                    {
                        ...
                        if (typeof(Shape).IsInstanceOfType(Hover))
                        {
                            ...
                            //���ѡ�е��ǽڵ������ӽڵ��������Բ˵���
                            // this.ContextMenu.MenuItems.Add("-");
                            //this.ContextMenu.MenuItems.Add(new MenuItem("���ýڵ�����", new EventHandler(OnShowNodesProperties)));
                        ...
                        else if (typeof(Connection).IsInstanceOfType(Hover))
                        {
                            ...
                            MenuItem[] subconnection = new MenuItem[2]{
                                                                          new MenuItem("���ӵ�",new EventHandler(AddConnectionPoint)),
                                                                          new MenuItem("ɾ����",new EventHandler(RemoveConnectionPoint))
                                                                      };


                            this.ContextMenu.MenuItems.Add(new MenuItem("������", subconnection));
                            //���ѡ�е�������һ������ָ���жϽڵ㣬����ʾ�������ò˵���
                            if ((Hover as Connection).From.BelongsTo.GetType().Name == "DecisionShape")
                            {
                                this.ContextMenu.MenuItems.Add("-");
                                this.ContextMenu.MenuItems.Add(new MenuItem("��������", new EventHandler(OnShowSetCondition)));
                            }
        ...
        private void LoadSelfLibrary()
        {
            ...
            //summ = new ShapeSummary(libPath, "8ED1469D-90B2-43ab-B000-4FF5C682F531", "��ʼ", "Basic shapes", "Netron.GraphLib.BasicShapes.StartNode", "���̿�ʼ�Ľڵ�");
            //lib.ShapeSummaries.Add(summ);
            //AddToContextMenu(summ);
			...
			*/
            ...
            else
            {
                try
                {
                    ...
                    {
                        MessageBox.Show("һ������ֻ����һ����ʼ�ڵ�.", "����", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        return;
                    }
                }
                catch
                {
                    MessageBox.Show("�Ҳ���Ҫ��������Ч��״����.", "�����ݴ���", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
                try
                {
                ...
                {
                    MessageBox.Show("�Ҳ���ͼ������. \n (�������˱�Ҫ��ͼ��Ԫ�ؿ���?)", "�����ݴ���", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
        ...
        protected void AddBaseMenu()
        {
            ...
            graphItem.MenuItems.Add("�½�", new EventHandler(OnNewGraph));
            graphItem.MenuItems.Add("ȫѡ", new EventHandler(OnSelectAll));
			...
			*/
            mContextMenu.MenuItems.Add(new MenuItem("&ɾ��", new EventHandler(OnDelete)));
            mContextMenu.MenuItems.Add("-");//add a separation
            mContextMenu.MenuItems.Add(new MenuItem("ת��Ϊ&Json", new EventHandler(OnToJson)));
            mContextMenu.MenuItems.Add("-");//add a separation
            mContextMenu.MenuItems.Add(new MenuItem("���Թ�����", new EventHandler(OnTestWorkflow)));
            mContextMenu.MenuItems.Add("-");//add a separation

            mContextMenu.MenuItems.Add(new MenuItem("����", new EventHandler(OnProperties)));
        }
