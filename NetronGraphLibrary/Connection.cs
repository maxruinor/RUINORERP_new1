...
{
	/// <summary>
	/// Connection：代表的是两个连接点之间的连接线The connection class captures a connection between two connectors and is derived from an entity.
	/// </summary>
	...
	[Serializable] public class Connection : Entity, IConnection, ISerializable
	{
		...
		/// <summary>
		/// 起点 The starting connector
		/// </summary>
		private Connector mFrom ;

		/// <summary>
		///目标点 the destination connector
		/// </summary>
