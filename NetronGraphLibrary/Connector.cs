...
{
	/// <summary>
	/// Connector����������ͼ�ζ����ϵ����ӵ㣬�������ӵ�֮����Բ���һ�������ߡ����ӵ����ֻ������ͼ�ζ�������ڡ�A Connector aka 'connection point' is the spot on a shape where a line (connection) will attach itself.
	...
	[Serializable] public  class Connector : Entity, ISerializable
	{
		...
		/// <summary>
		///ȷ�������Ƿ������µ��߻�����  only 1 connection allowed if false
		/// </summary>
		private bool mAllowMultipleConnections;

		/// <summary>
		/// ���汾���������Ǹ�shape,object this connector belongs to.
		/// </summary>
		private Shape mBelongsTo;

		/// <summary>
		/// ���ֶ������Ǳ��汾�������ӵ�����connection connections attached to this connector
		/// </summary>
		...
		/// <summary>
		///�������µ������뱾�� allow new connection to be attached to this connector
		/// </summary>
