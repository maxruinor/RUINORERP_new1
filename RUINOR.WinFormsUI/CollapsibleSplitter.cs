...
/*
 使用方法，设置属性
 左放一个panel ,然后拖这个控件，然后右边放一个panel，
 如果要双击该控件隐藏左边panel，则设置左边panel的Dock为Left,该控件的Dock为Left,然后，右边的控件为Fill,
 然后设置该控件的ControlToHide为左边控件。
       this.collapsibleSplitter1.AnimationDelay = 20;
       this.collapsibleSplitter1.AnimationStep = 20;
       this.collapsibleSplitter1.BorderStyle3D = System.Windows.Forms.Border3DStyle.Flat;
       this.collapsibleSplitter1.ControlToHide = this.groupBox1;
       this.collapsibleSplitter1.ExpandParentForm = false;
       this.collapsibleSplitter1.Location = new System.Drawing.Point(169, 0);
       ...
       this.collapsibleSplitter1.VisualStyle = VisualStyles.Mozilla;
        ...
        注意这三个地方注可以正常使用
        private System.Windows.Forms.GroupBox groupBox1; // Dock。left
        private CollapsibleSplitter collapsibleSplitter1; // ControlToHide = this.groupBox1;
        private System.Windows.Forms.GroupBox groupBox2;// dock.fill
 */
...
namespace RUINOR.WinFormsUI
{
    ...
    /// <summary>
    /// 隐藏分割器 A custom collapsible splitter that can resize, hide and show associated form controls
    /// </summary>
