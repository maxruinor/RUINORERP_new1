...
namespace RUINOR.WinFormsUI.OutlookGrid
{
    ...
    public class OutlookGridRow : DataGridViewRow
    {
        ...
        /// </summary>
        /// <param name="group">分组接口</param>
        /// <param name="isGroupRow">是否为分组行</param>
        ...
        protected override void Paint(System.Drawing.Graphics graphics, System.Drawing.Rectangle clipBounds, System.Drawing.Rectangle rowBounds, int rowIndex, DataGridViewElementStates rowState, bool isFirstDisplayedRow, bool isLastVisibleRow)
        {
            if (this.isGroupRow)
            {
                ...
                Brush brush2 = new SolidBrush(Color.FromArgb(63, 150, 255));//Color.FromKnownColor(KnownColor.GradientActiveCaption)
                ...
                //draw bottom line
                graphics.FillRectangle(brush2, rowBounds.Left + rowHeadersWidth - grid.HorizontalScrollingOffset, rowBounds.Bottom - 1, gridwidth - 1, 1);
               
                //绘制底部分组线
                //graphics.DrawLine(new Pen(new LinearGradientBrush(new Rectangle(rowBounds.Left + rowHeadersWidth - grid.HorizontalScrollingOffset,
                //    rowBounds.Bottom - 2, gridwidth - 1, 1), Color.FromArgb(63, 150, 255), Color.FromArgb(185, 216, 255), LinearGradientMode.ForwardDiagonal)),
                //    rowBounds.Left + rowHeadersWidth - grid.HorizontalScrollingOffset, rowBounds.Bottom - 2,
                //    rowBounds.Left + rowHeadersWidth + gridwidth - 1 - grid.HorizontalScrollingOffset, rowBounds.Bottom - 2);
    ...
    internal class OutlookGridRowComparer : IComparer
    {
        ...
        /// 比较方法
        /// </summary>
        /// <param name="x">OutlookGridRow行对象</param>
        /// <param name="y">OutlookGridRow行对象</param>
        /// <returns></returns>
