...
namespace SourceGrid2.Cells.Real
{
    ...
    public class Cell : Virtual.CellVirtual, ICell, ICellToolTipText, ICellCursor, ICellContextMenu
    {
        ...
        public override object GetTagValue(Position p_Position)
        {
            return TagValue;
        }
        ...
        public override void SetTagValue(Position p_Position, object p_TagValue)
        {
            if (m_TagValue != p_TagValue)
            {
                m_TagValue = p_TagValue;

                try
                {
                    OnTagValueChanged(new PositionEventArgs(p_Position, this));
                }
                catch (Exception)
                { }
                if (this.TagValueChanged != null) this.TagValueChanged(this, EventArgs.Empty);
            }
        }
        ...
        private object m_TagValue = null;
        /// <summary>
        /// Value of the cell 
        /// </summary>
        public virtual object TagValue
        {
            get { return m_TagValue; }
            set
            {
                SetTagValue(m_Range.Start, value);
            }
        }
        ...
        public Rectangle DisplayRectangle
        {
            get
            {
                return this.Grid.PositionToAbsoluteRect(new Position(this.Row, this.Column));
            }
        }
        new public bool bg;
        new public bool BackGround
        {
            get
            {
                return bg;
        ...
        private ColumnInfo _ownerColumn;


        public ColumnInfo OwnerColumn
        {
            get => _ownerColumn;
