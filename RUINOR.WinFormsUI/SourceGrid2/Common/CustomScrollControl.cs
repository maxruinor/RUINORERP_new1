...
//		}
		...
		private VScrollBarEx m_VScroll = null;
		private HScrollBarEx m_HScroll = null;
		...
		{
			if (this.m_VScroll!=null) m_VScroll.Value=y;
		}
		...
		protected virtual void InsertHScrollBar()
		{
			lock(this)
			{
				if (this.NoHScroll) return ;
				if (m_HScroll == null)
				{
					m_HScroll = new  HScrollBarEx(this);
		...
		protected virtual void InsertVScrollBar()
		{
			lock(this)
			{
				if (this.NoVScroll) return ;
				if (m_VScroll == null)
				{
					m_VScroll = new  VScrollBarEx(this);
		...
		private bool nohscroll=false;
		public bool NoHScroll 
		{
			get
			{
			...
			set
			{
				this.nohscroll=value;
			}
		}
		private bool novscroll=false;
		public bool NoVScroll 
		{
			get
			{
				return this.novscroll;
			}
			set
			{
				this.novscroll=value;
			}
		}
		public void OnScrollBarMouseDown(Point p)
		{
			if (this.VScrollBar==null) return ;
			Point po=p;
			po.Offset(-this.VScrollBar.Left,-this.VScrollBar.Top);
			this.VScrollBar.OnMouse(po);
		}
		...
		private Color summarycolor=Color.LightBlue;
