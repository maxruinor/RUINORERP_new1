...
namespace SourceGrid2
{
	...
	public delegate void ValidatingTagValueEventHandler(object sender, ValidatingTagValueEventArgs e);
	...
	public class ValidatingEventArgs : System.ComponentModel.CancelEventArgs
	{
		...
		public object NewTagValue
		{
			get { return m_NewTagValue; }
			set { m_NewTagValue = value; }
		}
	...
	public class ValidatingTagValueEventArgs : ValidatingEventArgs
	{
		private Cells.ICellVirtual m_Cell;
		public ValidatingTagValueEventArgs(Cells.ICellVirtual p_Cell, object p_NewValue) : base(p_NewValue)
		{
			m_Cell = p_Cell;
		}
