...
namespace SourceGrid2
{
    ...
    public class Utility
    {
        ...
        /// Default Cell height
        /// </summary>
        public const int DefaultCellHeight = 18;
        /// <summary>
        /// Default cell width
        /// </summary>
            ...
            )
        {
            ...
            if (p_Text == null || p_Text == "") arrow = false;
            #region Image
            //Image
            if (p_Image != null)
            {
            ...
            if (arrow)
            {
                DrawLine(new Point(1, p_displayRectangle.Top + p_displayRectangle.Height / 2), new Point(10, p_displayRectangle.Top + p_displayRectangle.Height / 2), g);
                //画了箭头
            }
            #endregion
        ...
        private static int arrowwidth = 6;
        ...
        private static void DrawLine(Point startPoint, Point endPoint, Graphics g)
        {
            //根据方向 
            ...
            Brush sb = new LinearGradientBrush(new Point(0, 0), new Point(0, 100), Color.FromArgb(255, 230, 170), Color.FromArgb(255, 255, 230));//,90,false);
                                                                                                                                                 //sb=new SolidBrush(风格管理.当前风格.箭头色);
            GraphicsPath gp = new GraphicsPath();
            //			Color ShadowColor=Color.FromArgb(213,214,219);
            //			Color ShadowColor2=Color.FromArgb(233,234,239);


            gp.AddLine(startPoint.X, startPoint.Y - LineWidth, endPoint.X - ArrowWidth, endPoint.Y - LineWidth);
            //画 向上的边
            gp.AddLine(endPoint.X - ArrowWidth, endPoint.Y - LineWidth, endPoint.X - ArrowWidth, endPoint.Y - ArrowWidth);
            //画 三角的边缘
            gp.AddLine(endPoint.X - ArrowWidth, endPoint.Y - ArrowWidth, endPoint.X, endPoint.Y);
            //画 下边缘
            gp.AddLine(endPoint.X, endPoint.Y, endPoint.X - ArrowWidth, endPoint.Y + ArrowWidth);
            gp.AddLine(endPoint.X - ArrowWidth, endPoint.Y + ArrowWidth, endPoint.X - ArrowWidth, endPoint.Y + LineWidth);
            gp.AddLine(endPoint.X - ArrowWidth, endPoint.Y + LineWidth, startPoint.X, endPoint.Y + LineWidth);
            gp.AddLine(startPoint.X, startPoint.Y + LineWidth, startPoint.X, startPoint.Y - LineWidth);
    ...
    internal class Const
    {
        ...
        public static string c_ImagePath = @"RUINOR.WinFormsUI.SourceGrid2.Common.Icons.";
    }
    ...
    public class PositionCollection : System.Collections.CollectionBase
    {
        ...
        public class Enumerator : System.Collections.IEnumerator
        {
            ...
            public Position Current
            {
                get
                {
                    return (Position)(wrapped.Current);
                }
            }
    ...
    public class LinkedControlsList : System.Collections.DictionaryBase
    {
        ...
        public virtual Position this[Control key]
        {
            get
            {
                return (Position)Dictionary[key];
            }
            set
            {
        ...
        {
            foreach (Position item in Dictionary.Values)
            {
                if (item == value)
                    return true;
            }
