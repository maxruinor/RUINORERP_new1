...
namespace SourceGrid2.DataModels
{
	public class EditorTextBoxButton : EditorControlBase
	{
		...
		{
			TextBoxButton l_ComboBox = new TextBoxButton();
		...
		public override void InternalStartEdit(Cells.ICellVirtual p_Cell, Position p_Position, object p_StartEditValue)
		{
			...
			SourceLibrary.Windows.Forms.TextBoxTypedButton l_Combo = GetEditorTextBoxTypedButton(p_Cell.Grid.PanelAtPosition(p_Position));
		...
		{
			return GetEditorTextBoxTypedButton(EditCell.Grid.PanelAtPosition(EditPosition)).Tag;
		}
