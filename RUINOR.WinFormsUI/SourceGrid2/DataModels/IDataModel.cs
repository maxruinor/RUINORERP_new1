...
//		bool InternalApplyEdit();
		...
		/// <returns></returns>
		bool SetCellTagValue(Cells.ICellVirtual p_Cell, Position p_Position, object p_NewTagValue);
		...
		event ValidatingTagValueEventHandler ValidatingForTagValue;

		event CellEventHandler ValidatedForTagValue;
