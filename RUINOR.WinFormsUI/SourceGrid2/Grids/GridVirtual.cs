...
namespace SourceGrid2
{
    ...
    public class GridVirtual : CustomScrollControl
    {
        ...
        public virtual Rectangle RangeToAbsoluteRect(Range p_Range)
        {
            ...
            int l_Left = Columns[p_Range.Start.Column].Left + this.BorderWidth;
            int l_Top = Rows[p_Range.Start.Row].Top + this.BorderWidth;
        ...
        private Position mm_FocusPosition = Position.Empty;
        public Position m_FocusPosition
        {
            get
            {
                return mm_FocusPosition;
            }
            set
            {
                mm_FocusPosition = value;
            }
        }
        /// <summary>
        ...
        public bool SetFocusCell(Position p_CellToSetFocus)
        {
            ...
            if (l_bControlPress == false || Selection.EnableMultiSelection == false)
                ok = SetFocusCell(p_CellToSetFocus, true);
            else
                ok = SetFocusCell(p_CellToSetFocus, false);
            if (this.FocusChange != null) this.FocusChange(this, EventArgs.Empty);
        ...
        protected virtual void ProcessSpecialGridKey(KeyEventArgs e)
        {
            ...
            if (m_FocusPosition.IsEmpty() == false)
            {
                ...
                if (l_FocusCell != null)
                {
                    ...
                    else if (e.KeyCode == Keys.Tab && l_enableTab || (e.KeyCode == Keys.Enter && l_enableEnter))//se ?premuto tab e non ho trovato nessuna cella provo a muovermi sulla riga in basso e partendo nuovamente dall'inizio ricerco una cella valida
                    {
                        int tmpRow = m_FocusPosition.Row;
                        int tmpCol = m_FocusPosition.Column;
                        //indietro
        ...
        virtual public void SetFocusStatus()
        {

        }
        private bool keepfocus = true;
        ...
        virtual public void OnLostFocusStatus()
        {
        ...
        private bool header3d = false;
        public bool Header3D
        {
            get
            {
        ...
        protected virtual void PanelPaint(GridSubPanel p_Panel, PaintEventArgs e)
        {
            ...
            //如果 需要 画summary 
            if (this.m_ScrollablePanel == p_Panel)
            {
                if (this.Summary)
                {
                    //画 Summary 行 
                    e.Graphics.ResetClip();
                    this.PaintSummary(p_Panel, e);
                }
                //PaintBorder(p_Panel,e);
            }

        }
        protected virtual void PaintSummary(GridSubPanel p_Panel, PaintEventArgs e)
        {
        }
        /// <summary>
        ...
        public bool OnScrollBar(Point p)
        {
            if (this.VScrollBar != null)
            {
                Rectangle rr = new Rectangle(this.VScrollBar.Left, this.VScrollBar.Top, this.VScrollBar.Width, this.VScrollBar.Height);
        ...
        public virtual void OnGridClick(EventArgs e)
        {
				...
				m_MouseDownCell.Focused == true //tolto altrimenti non funzionava per le celle Selectable==false*/)
            {
                ...
                if (l_MouseDownCell != null)
                {
                    ...
                    if (this.CellClick != null) this.InvokeCellClick(l_MouseDownCell, EventArgs.Empty);
                }
            }
        }
        /// <summary>
        ...
        public void InvokeCellArrowClick(object sender, EventArgs e)
        {
            if (this.ArrowClick != null) this.ArrowClick(sender, e);
        }

        public event EventHandler CellEditEnd;
        public void InvokeCellEditEnd(object sender, EventArgs e)
        {
            if (this.CellEditEnd != null) this.CellEditEnd(sender, e);
        }

        public event EventHandler CellClick;

        public void InvokeCellClick(object sender, EventArgs e)
        {
            if (this.CellClick != null) this.CellClick(sender, e);
        }
        public void InvokeCellDBClick(object sender, EventArgs e)
        {
            if (this.CellDoubleClick != null) this.CellDoubleClick(sender, e);
        }
        ...
        public virtual void OnGridDoubleClick(EventArgs e)
        {
            ...
            if (m_MouseDownPosition.IsEmpty() == false)
            {
                ...
                if (l_MouseDownCell != null)
                {
                    ...
                    if (this.CellDoubleClick != null) this.CellDoubleClick(l_MouseDownCell, EventArgs.Empty);
                }
            }
        }
        #endregion
        ...
        public virtual void OnGridKeyPress(KeyPressEventArgs e)
        {
            ...
            if (m_FocusPosition.IsEmpty() || e.KeyChar == '\t' || e.KeyChar == '\r' || e.KeyChar == 13 ||
        ...
        protected virtual void RefreshGridLayout()
        {
            ...
            if (this.Summary) CustomScrollArea = new Size(Columns.Right, Rows.Bottom + this.SummaryHeight);
        ...
        private void CalculatePanelsLocation()
        {
            ...
            m_LeftPanel.Location = new Point(this.BorderWidth, l_Height + this.BorderWidth);
            m_LeftPanel.Size = new Size(l_Width - this.BorderWidth, l_DisplayRectangle.Height - l_Height);
            m_TopPanel.Location = new Point(l_Width + this.BorderWidth, this.BorderWidth);
            m_TopPanel.Size = new Size(l_DisplayRectangle.Width - l_Width, l_Height);
            m_ScrollablePanel.Location = new Point(l_Width + this.BorderWidth, l_Height + this.BorderWidth);
            m_ScrollablePanel.Size = new Size(l_DisplayRectangle.Width - l_Width - 2 * BorderWidth, l_DisplayRectangle.Height - l_Height - 2 * this.BorderWidth);
        }
        ...
        protected virtual void PaintBorder(Control p_Panel, PaintEventArgs e)
        {
            e.Graphics.DrawLine(Pens.DarkGray, 0, 0, 0, p_Panel.Height);
            e.Graphics.DrawLine(Pens.DarkGray, 0, 0, p_Panel.Width, 0);
            e.Graphics.DrawLine(Pens.White, 0, p_Panel.Height - 1, p_Panel.Width - 1, p_Panel.Height - 1);
            e.Graphics.DrawLine(Pens.White, p_Panel.Width - 1, 0, p_Panel.Width - 1, p_Panel.Height - 1);

        }
        //		protected override void OnPaint(PaintEventArgs e)
        //		{
        //			this.PaintBorder(this,e);
        //		}
        ...
        public int ColumnsCount
        {
            ...
            set
            {
                if (ColumnsCount < value)
                {
                    if (ColumnNames != null)
                    {
                        m_Columns.InsertRange(ColumnsCount, ColumnNames);
                    }
                    else
                    {
        ...
        ///        grid.RowsCount = 3;
        ///        或在属性中设置 ColumnsCount和RowsCount的值
        ///方法3: grid.Rows.Insert(3);
        ///不能重复应用
        /// </summary>
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        public virtual Position PositionAtPoint(Point p_RelativeViewPoint, bool p_bSearchInFixedCells)
        {
            ...
            //如果 超出了 Summary 的范围 那么 直接返回
            if (this.Summary && p_RelativeViewPoint.Y > this.Height - this.SummaryHeight)
            {
                return l_Found;
            }
            if (l_Found.IsEmpty())
        ...
        private bool focuscelledit = false;

        /// <summary>
        /// 没作用
        /// </summary>
        public bool FocusCellEdit
        {
            get
            {
                return focuscelledit;
            }
            set
            {
                focuscelledit = value;
