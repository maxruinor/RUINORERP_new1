...
namespace SourceGrid2.VisualModels
{
    ...
    public class Header : Common
    {
        ...
        private int m_HeaderTopLeftWidth = 2;//3D时要求最小为2，他的代码中是1，暂时不清楚原因
        private int m_HeaderBottomRightWidth = 2;//3D时最小为2，他的代码中是1，暂时不清楚原因
        ...
        protected override void DrawCell_Border(SourceGrid2.Cells.ICellVirtual p_Cell, Position p_CellPosition, PaintEventArgs e, Rectangle p_ClientRectangle, DrawCellStatus p_Status)
        {
            ...
            else
            {
                ...
                if (p_CellPosition == p_Cell.Grid.MouseDownPosition)
                    SourceLibrary.Drawing.ControlPaint.DrawSingle3DBorder(e.Graphics, p_ClientRectangle, l_BackColor, Color.Black, BackColor, HeaderShadowBorderWidth, HeaderLightBorderWidth, SourceLibrary.Drawing.Gradient3DBorderStyle.Sunken);
                else
                    SourceLibrary.Drawing.ControlPaint.DrawSingle3DBorder(e.Graphics, p_ClientRectangle, l_BackColor, Color.Black, BackColor, HeaderShadowBorderWidth, HeaderLightBorderWidth, SourceLibrary.Drawing.Gradient3DBorderStyle.Raised);
