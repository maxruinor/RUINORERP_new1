...
namespace SourceLibrary.Windows.Forms
{
	...
	public class ButtonMultiSelection : System.Windows.Forms.UserControl, IButtonControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.btArrow.Image = ((System.Drawing.Image)(resources.GetObject("btArrow.Image")));
		...
		public override Color BackColor
		{
			...
			set
			{
				btMain.BackColor = value;
				btArrow.BackColor = value;
		...
		{
			get{return btMain.ImageList;}
			set{btMain.ImageList = value;}
		}
		...
		{
			get{return btMain.ImageIndex;}
			set{btMain.ImageIndex = value;}
		}
		...
		{
			get{return btMain.FlatStyle;}
			set
			{
				btMain.FlatStyle = value;
				btArrow.FlatStyle = value;
			}
		}
	...
	public class SubButtonItem
	{
		...
		public SubButtonItem(string p_Text, EventHandler p_Event, Image p_Image)
		{
			...
			{
				m_MenuItem = new MenuItemImage();
				((MenuItemImage)m_MenuItem).SetImage(p_Image);
			}
		...
		public SubButtonItem(string p_Text, EventHandler p_Event, ImageList p_ImageList, int p_ImageIndex)
		{
			...
			{
				m_MenuItem = new MenuItemImage();
				((MenuItemImage)m_MenuItem).SetImage(p_ImageList, p_ImageIndex);
			}
