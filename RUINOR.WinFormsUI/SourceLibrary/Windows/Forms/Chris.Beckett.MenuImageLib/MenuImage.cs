...
namespace Chris.Beckett.MenuImageLib
{
	...
	internal class MenuImage : Component, IExtenderProvider
	{
		...
		private class MenuHelper
		{
			...
			static MenuHelper()
			{
				System.IO.Stream stream = System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("SourceLibrary.Windows.Forms.Chris.Beckett.MenuImageLib.SubItem16.ico") ;
