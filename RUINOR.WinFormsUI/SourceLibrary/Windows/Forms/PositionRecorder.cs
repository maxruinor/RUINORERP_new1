...
namespace SourceLibrary.Windows.Forms
{
	...
	public class PositionRecorderIsolatedStorage : SourceLibrary.IO.IsolatedStorage.IsolatedStorageSettingVersionBase
	{
		...
		protected override void OnSave(System.IO.IsolatedStorage.IsolatedStorageFileStream p_File)
		{
			...
			Write(p_File, m_Location.X);
			Write(p_File, m_Location.Y);
			Write(p_File, m_Size.Width);
			Write(p_File, m_Size.Height);
			Write(p_File, (int)m_WindowState);
		}
