...
namespace RUINORERP.Business.Processor
{
    ...
    /// 维修入库单
    /// </summary>
    public partial class tb_AS_RepairInStockProcessor:BaseProcessor 
    {
        ...
        public override QueryFilter GetQueryFilter()
        {
            ...
            queryFilter.SetQueryField<tb_AS_RepairInStock, tb_CustomerVendor>(c => c.CustomerVendor_ID, lambda);

            //可以根据关联外键自动加载条件，条件用公共虚方法
            queryFilter.SetQueryField<tb_AS_RepairInStock>(c => c.RepairInStockNo);
            queryFilter.SetQueryField<tb_AS_RepairInStock>(c => c.RepairOrderNo);
