...
namespace RUINORERP.Business.Processor
{
    ...
    public partial class tb_BOM_SDetailProcessor : BaseProcessor
    {
        ...
        public override QueryFilter GetQueryFilter()
        {
            ...
            queryFilter.SetQueryField<tb_BOM_SDetail>(c => c.property);
            queryFilter.SetQueryField<tb_BOM_SDetail>(c => c.SubItemName);
            queryFilter.SetQueryField<tb_BOM_SDetail>(c => c.SubItemSpec);
