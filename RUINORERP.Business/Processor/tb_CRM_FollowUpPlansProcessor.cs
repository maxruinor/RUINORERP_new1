...
namespace RUINORERP.Business.Processor
{
    ...
    public partial class tb_CRM_FollowUpPlansProcessor : BaseProcessor
    {
        ...
        public override QueryFilter GetQueryFilter()
        {
            ...
            queryFilter.SetQueryField<tb_CRM_FollowUpPlans>(c => c.Customer_id, typeof(tb_CRM_Customer), true, lambdaCustomer);
            ...
            queryFilter.SetQueryField<tb_CRM_FollowUpPlans>(c => c.Employee_ID, typeof(tb_Employee), true, lambdaEmp);
