...
namespace RUINORERP.Business.Processor
{
    ...
    /// 应收应付 用于对账单生成时的查询
    /// </summary>
    public partial class tb_FM_ReceivablePayableProcessorByStatement : BaseProcessor
    {
        public tb_FM_ReceivablePayableProcessorByStatement(ILogger<BaseProcessor> logger, IUnitOfWorkManage unitOfWorkManage, ApplicationContext appContext = null) : base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
