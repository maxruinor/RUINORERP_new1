...
namespace RUINORERP.Business.Processor
{
    ...
    { 
        ...
        public override QueryFilter GetQueryFilter()
        {
            ...
            queryFilter.SetQueryField<tb_MRP_ReworkReturn, tb_FinishedGoodsInv>(c => c.FG_ID, c => c.DeliveryBillNo, t => t.DeliveryBillNo);
            ...
            queryFilter.SetQueryField<tb_MRP_ReworkReturn>(c => c.DataStatus, QueryFieldType.CmbEnum, typeof(DataStatus));
