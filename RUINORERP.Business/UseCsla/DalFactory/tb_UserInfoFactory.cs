...
namespace RUINORERP.Business.UseCsla
{
    ...
    /// 用户表
    /// </summary>
    public class tb_UserInfoFactory : Csla.Server.ObjectFactory, IDependencyDal
    {
    
      public tb_UserInfoFactory(ApplicationContext applicationContext)
      : base(applicationContext) { }


    public tb_UserInfoEditInfo Create()
    {
      var result = ApplicationContext.CreateInstanceDI<tb_UserInfoEditInfo>();
    ...
    public tb_UserInfoEditInfo Fetch()
    {
      var result = ApplicationContext.CreateInstanceDI<tb_UserInfoEditInfo>();
      //LoadProperty(result, PersonEdit.NameProperty, "Xiaoping");
      CheckRules(result);
      ...
      return result;
        ...
        public List<tb_UserInfoEditInfo> FetchList()
        {
            ...
            try
            {
                ...
                list = db.Queryable<tb_UserInfo>().ToList();
        ...
        public void Insert(tb_UserInfoEditInfo item)
        {
            throw new NotImplementedException();
        }

        public void Update(tb_UserInfoEditInfo item)
        {
            throw new NotImplementedException();
        }
