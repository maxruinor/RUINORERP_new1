...
namespace RUINORERP.Business
{
    ...
    public partial class tb_CRM_ContactValidator:BaseValidatorGeneric<tb_CRM_Contact>
    {
     ...
     {
      RuleFor(tb_CRM_Contact =>tb_CRM_Contact.Customer_id).Must(CheckForeignKeyValueCanNull).WithMessage("机会客户:下拉选择值不正确。");
 RuleFor(tb_CRM_Contact =>tb_CRM_Contact.Customer_id).NotEmpty().When(x => x.Customer_id.HasValue);
