...
namespace RUINORERP.Business
{
    ...
    public partial class tb_FM_ExpenseClaimValidator : BaseValidatorGeneric<tb_FM_ExpenseClaim>
    {
        public tb_FM_ExpenseClaimValidator()
        {
            ...
            RuleFor(x => x.ClaimAmount).PrecisionScale(19, 6, true).WithMessage("报销金额:小数位不能超过6。");
            RuleFor(x => x.ApprovedAmount).PrecisionScale(19, 6, true).WithMessage("核准金额:小数位不能超过6。");
