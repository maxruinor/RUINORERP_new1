...
namespace RUINORERP.Business
{
    ...
    public partial class tb_FM_ProfitLossValidator:BaseValidatorGeneric<tb_FM_ProfitLoss>
    {
     ...
     public tb_FM_ProfitLossValidator(ApplicationContext appContext = null) : base(appContext)
     {
...
//***** 
 RuleFor(tb_FM_ProfitLoss =>tb_FM_ProfitLoss.ProfitLossDirection).NotNull().WithMessage("盈亏方向:不能为空。");
