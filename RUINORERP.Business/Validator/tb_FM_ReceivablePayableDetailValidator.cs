...
namespace RUINORERP.Business
{
 ...
 RuleFor(x => x.ForeignPrepaidAmount).PrecisionScale(19,4,true).WithMessage("金额外币:小数位不能超过4。");

 RuleFor(x => x.LocalPrepaidAmount).PrecisionScale(19,4,true).WithMessage("金额本币:小数位不能超过4。");
