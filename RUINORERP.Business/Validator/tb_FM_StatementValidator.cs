...
namespace RUINORERP.Business
{
    ...
    public partial class tb_FM_StatementValidator:BaseValidatorGeneric<tb_FM_Statement>
    {
     ...
     public tb_FM_StatementValidator(ApplicationContext appContext = null) : base(appContext)
     {
...
//***** 
 RuleFor(tb_FM_Statement =>tb_FM_Statement.StatementType).NotNull().WithMessage("对账类型:不能为空。");
