...
namespace RUINORERP.Business
{
    ...
    public partial class tb_FinishedGoodsInvValidator:BaseValidatorGeneric<tb_FinishedGoodsInv>
    {
     ...
     public tb_FinishedGoodsInvValidator(ApplicationContext appContext = null) : base(appContext)
     {
 ...
 RuleFor(tb_FinishedGoodsInv =>tb_FinishedGoodsInv.PayStatus).NotEmpty().When(x => x.PayStatus.HasValue);
