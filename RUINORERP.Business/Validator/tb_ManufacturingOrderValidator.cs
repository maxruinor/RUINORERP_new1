...
//***** 
 ...
 RuleFor(tb_ManufacturingOrder =>tb_ManufacturingOrder.SKU).MaximumLength(40).WithMessage("SKU码:不能超过最大长度,40.");
 RuleFor(tb_ManufacturingOrder =>tb_ManufacturingOrder.CNName).MaximumLength(127).WithMessage("品名:不能超过最大长度,127.");
 RuleFor(tb_ManufacturingOrder =>tb_ManufacturingOrder.CNName).NotEmpty().WithMessage("品名:不能为空。");
 ...
 RuleFor(tb_ManufacturingOrder =>tb_ManufacturingOrder.Type_ID).Must(CheckForeignKeyValueCanNull).WithMessage("产品类型:下拉选择值不正确。");
 ...
 RuleFor(tb_ManufacturingOrder =>tb_ManufacturingOrder.Specifications).MaximumLength(500).WithMessage("规格:不能超过最大长度,500.");
 RuleFor(tb_ManufacturingOrder =>tb_ManufacturingOrder.property).MaximumLength(127).WithMessage("属性:不能超过最大长度,127.");
