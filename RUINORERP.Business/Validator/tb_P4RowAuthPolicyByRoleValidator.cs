...
namespace RUINORERP.Business
{
    ...
    public partial class tb_P4RowAuthPolicyByRoleValidator:BaseValidatorGeneric<tb_P4RowAuthPolicyByRole>
    {
     ...
     public tb_P4RowAuthPolicyByRoleValidator(IOptionsMonitor<GlobalValidatorConfig> config)
     {
 ...
 RuleFor(tb_P4RowAuthPolicyByRole =>tb_P4RowAuthPolicyByRole.PolicyId).Must(CheckForeignKeyValue).WithMessage(":下拉选择值不正确。");
