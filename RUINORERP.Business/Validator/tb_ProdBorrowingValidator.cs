...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ProdBorrowingValidator : AbstractValidator<tb_ProdBorrowing>
    {
        public tb_ProdBorrowingValidator()
        {
            ...
            RuleFor(tb_ProdBorrowing => tb_ProdBorrowing.Employee_ID).Must(CheckForeignKeyValue).WithMessage("经办人:下拉选择值不正确。");
            ...
            //RuleFor(tb_ProdBorrowing => tb_ProdBorrowing.Reason).MinimumLength(5).WithMessage("借出原因:不能小于5个字符.");
            RuleFor(customer => customer.Reason).Length(5, 250).WithMessage("借出原因:字符长度必须在5-250之间.");
