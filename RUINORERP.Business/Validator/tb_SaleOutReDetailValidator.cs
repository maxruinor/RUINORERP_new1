...
//***** 
 ...
 RuleFor(x => x.SubtotalTaxAmount).PrecisionScale(19,6,true).WithMessage(":小数位不能超过6。");
 RuleFor(x => x.CommissionAmount).PrecisionScale(19,6,true).WithMessage("抽成返还:小数位不能超过6。");
