...
namespace RUINORERP.Business
{
    ...
    public partial class tb_StockInDetailValidator:BaseValidatorGeneric<tb_StockInDetail>
    {
     ...
     public tb_StockInDetailValidator(ApplicationContext appContext = null) : base(appContext)
     {
...
//***** 
 ...
 RuleFor(tb_StockInDetail =>tb_StockInDetail.Summary).MaximumMixedLength(1000).WithMessage("摘要:不能超过最大长度,1000.");
