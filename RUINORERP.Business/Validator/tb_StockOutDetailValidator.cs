...
namespace RUINORERP.Business
{
    ...
    public partial class tb_StockOutDetailValidator : AbstractValidator<tb_StockOutDetail>
    {
        public tb_StockOutDetailValidator()
        {
            ...
            RuleFor(tb_StockOutDetail => tb_StockOutDetail.ProdDetailID).Must(CheckForeignKeyValue).WithMessage("产品:下拉选择值不正确。");
            ...
            RuleFor(tb_StockOutDetail => tb_StockOutDetail.Qty).GreaterThanOrEqualTo(1).WithMessage("数量:不能小于或等于零。");
            ...
            RuleFor(tb_StockOutDetail => tb_StockOutDetail.Summary).MaximumLength(255).WithMessage("摘要:不能超过最大长度,255.");
            ...
            RuleFor(tb_StockOutDetail => tb_StockOutDetail.property).MaximumLength(255).WithMessage("属性:不能超过最大长度,255.");
