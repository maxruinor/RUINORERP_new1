...
namespace RUINORERP.Business
{
    ...
    public partial class tb_StockOutValidator : AbstractValidator<tb_StockOut>
    {
        public tb_StockOutValidator()
        {
            ...
            RuleFor(tb_StockOut => tb_StockOut.Employee_ID).Must(CheckForeignKeyValueCanNull).WithMessage("经办人:下拉选择值不正确。");
            RuleFor(tb_StockOut => tb_StockOut.BillNo).MaximumLength(50).WithMessage("其它出库单号:不能超过最大长度,50.");
            //***** 
