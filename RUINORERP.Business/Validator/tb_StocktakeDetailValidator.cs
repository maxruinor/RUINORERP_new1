...
namespace RUINORERP.Business
{
    ...
    public partial class tb_StocktakeDetailValidator : AbstractValidator<tb_StocktakeDetail>
    {
        public tb_StocktakeDetailValidator()
        {
            ...
            RuleFor(tb_StocktakeDetail => tb_StocktakeDetail.Notes).MaximumLength(255).WithMessage("备注:不能超过最大长度,255.");
            RuleFor(tb_StocktakeDetail => tb_StocktakeDetail.property).MaximumLength(255).WithMessage("属性:不能超过最大长度,255.");
