...
namespace RUINORERP.Business
{
    ...
    public partial class tb_UserPersonalizedValidator:BaseValidatorGeneric<tb_UserPersonalized>
    {
     ...
     public tb_UserPersonalizedValidator(ApplicationContext appContext = null) : base(appContext)
     {
 ...
 RuleFor(tb_UserPersonalized =>tb_UserPersonalized.PrinterName).MaximumMixedLength(200).WithMessage(":不能超过最大长度,200.");
