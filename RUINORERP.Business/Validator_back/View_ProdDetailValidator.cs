...
namespace RUINORERP.Business
{
 ...
 RuleFor(View_ProdDetail =>View_ProdDetail.CNName).MaximumLength(255).WithMessage(":不能超过最大长度,255.");
 RuleFor(View_ProdDetail =>View_ProdDetail.CNName).NotEmpty().WithMessage(":不能为空。");
 RuleFor(View_ProdDetail =>View_ProdDetail.Specifications).MaximumLength(200).WithMessage(":不能超过最大长度,200.");
 ...
 RuleFor(View_ProdDetail =>View_ProdDetail.ProductNo).MaximumLength(40).WithMessage(":不能超过最大长度,40.");
 ...
 RuleFor(View_ProdDetail =>View_ProdDetail.Model).MaximumLength(50).WithMessage(":不能超过最大长度,50.");
 ...
 RuleFor(View_ProdDetail =>View_ProdDetail.ENName).MaximumLength(255).WithMessage(":不能超过最大长度,255.");
 RuleFor(View_ProdDetail =>View_ProdDetail.Brand).MaximumLength(50).WithMessage(":不能超过最大长度,50.");
 ...
 RuleFor(View_ProdDetail =>View_ProdDetail.Notes).MaximumLength(255).WithMessage(":不能超过最大长度,255.");
//***** 
 RuleFor(View_ProdDetail =>View_ProdDetail.Type_ID).NotNull().WithMessage(":不能为空。");
 RuleFor(View_ProdDetail =>View_ProdDetail.ShortCode).MaximumLength(50).WithMessage(":不能超过最大长度,50.");
 RuleFor(View_ProdDetail =>View_ProdDetail.SourceType).NotEmpty().When(x => x.SourceType.HasValue);
 RuleFor(View_ProdDetail =>View_ProdDetail.BarCode).MaximumLength(50).WithMessage(":不能超过最大长度,50.");
 ...
 RuleFor(View_ProdDetail =>View_ProdDetail.SKU).MaximumLength(80).WithMessage(":不能超过最大长度,80.");
