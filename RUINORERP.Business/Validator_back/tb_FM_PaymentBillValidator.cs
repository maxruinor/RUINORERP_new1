...
namespace RUINORERP.Business
{
 ...
 RuleFor(tb_FM_PaymentBill =>tb_FM_PaymentBill.accountNo).MaximumLength(30).WithMessage("账号:不能超过最大长度,30.");
 ...
 RuleFor(tb_FM_PaymentBill =>tb_FM_PaymentBill.Notes).MaximumLength(300).WithMessage("备注:不能超过最大长度,300.");
 RuleFor(tb_FM_PaymentBill =>tb_FM_PaymentBill.VoucherNumber).MaximumLength(50).WithMessage("凭证号码:不能超过最大长度,50.");
 RuleFor(tb_FM_PaymentBill =>tb_FM_PaymentBill.Reason).MaximumLength(200).WithMessage("付款原因:不能超过最大长度,200.");
 ...
 RuleFor(tb_FM_PaymentBill =>tb_FM_PaymentBill.SourceBillNO).MaximumLength(30).WithMessage("来源单号:不能超过最大长度,30.");
 ...
 RuleFor(tb_FM_PaymentBill =>tb_FM_PaymentBill.ApprovalOpinions).MaximumLength(255).WithMessage("审批意见:不能超过最大长度,255.");
