...
namespace RUINORERP.Business
{
 ...
 RuleFor(tb_FM_PrePaymentBillDetail =>tb_FM_PrePaymentBillDetail.PaymentReason).MaximumLength(50).WithMessage("事由:不能超过最大长度,50.");
 ...
 RuleFor(tb_FM_PrePaymentBillDetail =>tb_FM_PrePaymentBillDetail.SourceBillNO).MaximumLength(30).WithMessage("来源单号:不能超过最大长度,30.");
 RuleFor(tb_FM_PrePaymentBillDetail =>tb_FM_PrePaymentBillDetail.Reason).MaximumLength(50).WithMessage("原因:不能超过最大长度,50.");
 RuleFor(tb_FM_PrePaymentBillDetail =>tb_FM_PrePaymentBillDetail.OffsetMethod).MaximumLength(50).WithMessage("冲销方式:不能超过最大长度,50.");
 ...
 RuleFor(tb_FM_PrePaymentBillDetail =>tb_FM_PrePaymentBillDetail.Notes).MaximumLength(30).WithMessage("备注:不能超过最大长度,30.");
