...
namespace RUINORERP.Business
{
 ...
 RuleFor(tb_ManufacturingOrderDetail =>tb_ManufacturingOrderDetail.BOM_NO).MaximumLength(50).WithMessage("配方编号:不能超过最大长度,50.");
 ...
 RuleFor(tb_ManufacturingOrderDetail =>tb_ManufacturingOrderDetail.BOM_ID).MaximumLength(50).WithMessage("配方:不能超过最大长度,50.");
 RuleFor(tb_ManufacturingOrderDetail =>tb_ManufacturingOrderDetail.Summary).MaximumLength(255).WithMessage("摘要:不能超过最大长度,255.");
