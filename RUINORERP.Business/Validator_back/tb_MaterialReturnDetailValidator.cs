...
namespace RUINORERP.Business
{
    ...
    public partial class tb_MaterialReturnDetailValidator:AbstractValidator<tb_MaterialReturnDetail>
    {
     ...
     {
     //***** 
 RuleFor(tb_MaterialReturnDetail =>tb_MaterialReturnDetail.MainID).NotNull().WithMessage("主单:不能为空。");
...
//***** 
 ...
 RuleFor(tb_MaterialReturnDetail =>tb_MaterialReturnDetail.Summary).MaximumLength(255).WithMessage("摘要:不能超过最大长度,255.");
