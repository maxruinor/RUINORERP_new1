...
namespace RUINORERP.Business
{
 ...
 RuleFor(tb_ProduceGoodsRecommendDetail =>tb_ProduceGoodsRecommendDetail.property).MaximumLength(255).WithMessage("属性:不能超过最大长度,255.");
 RuleFor(tb_ProduceGoodsRecommendDetail =>tb_ProduceGoodsRecommendDetail.MainID).Must(CheckForeignKeyValueCanNull).WithMessage("标准配方:下拉选择值不正确。");
 RuleFor(tb_ProduceGoodsRecommendDetail =>tb_ProduceGoodsRecommendDetail.MainID).NotEmpty().When(x => x.MainID.HasValue);
 RuleFor(tb_ProduceGoodsRecommendDetail =>tb_ProduceGoodsRecommendDetail.BOM_NO).MaximumLength(50).WithMessage("配方编号:不能超过最大长度,50.");
...
//***** 
 ...
 RuleFor(tb_ProduceGoodsRecommendDetail =>tb_ProduceGoodsRecommendDetail.Summary).MaximumLength(255).WithMessage("摘要:不能超过最大长度,255.");
 RuleFor(tb_ProduceGoodsRecommendDetail =>tb_ProduceGoodsRecommendDetail.RefBillNO).MaximumLength(100).WithMessage("生成单号:不能超过最大长度,100.");
