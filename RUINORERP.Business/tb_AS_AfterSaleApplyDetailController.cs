...
namespace RUINORERP.Business
{
    ...
    public partial class tb_AS_AfterSaleApplyDetailController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_AS_AfterSaleApplyDetailController(ILogger<tb_AS_AfterSaleApplyDetailController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_AS_AfterSaleApplyDetailServices tb_AS_AfterSaleApplyDetailServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_AS_AfterSaleApplyDetail>> SaveOrUpdate(tb_AS_AfterSaleApplyDetail entity)
        {
            ...
            try
            {
                ...
                if (entity.ASApplyDetailID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_AS_AfterSaleApplyDetail>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_AS_AfterSaleApplyDetail>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_AS_AfterSaleApplyDetail>(entitys);
            }
            return rs;
        }
        ...
        public tb_AS_AfterSaleApplyDetail AddReEntity(tb_AS_AfterSaleApplyDetail entity)
        {
            tb_AS_AfterSaleApplyDetail AddEntity =  _tb_AS_AfterSaleApplyDetailServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_AS_AfterSaleApplyDetail>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_AS_AfterSaleApplyDetail> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_AS_AfterSaleApplyDetail>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_AS_AfterSaleApplyDetail entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_AS_AfterSaleApplyDetail>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_AS_AfterSaleApplyDetail>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_AS_AfterSaleApplyDetail>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_AS_AfterSaleApplyDetail>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_AS_AfterSaleApplyDetail>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_AS_AfterSaleApplyDetail>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
