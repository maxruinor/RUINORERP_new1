...
namespace RUINORERP.Business
{
    ...
    public partial class tb_AS_AfterSaleDeliveryController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_AS_AfterSaleDeliveryController(ILogger<tb_AS_AfterSaleDeliveryController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_AS_AfterSaleDeliveryServices tb_AS_AfterSaleDeliveryServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_AS_AfterSaleDelivery>> SaveOrUpdate(tb_AS_AfterSaleDelivery entity)
        {
            ...
            try
            {
                ...
                if (entity.ASDeliveryID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_AS_AfterSaleDelivery>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_AS_AfterSaleDelivery>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_AS_AfterSaleDelivery>(entitys);
            }
            return rs;
        }
        ...
        public tb_AS_AfterSaleDelivery AddReEntity(tb_AS_AfterSaleDelivery entity)
        {
            tb_AS_AfterSaleDelivery AddEntity =  _tb_AS_AfterSaleDeliveryServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_AS_AfterSaleDelivery>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_AS_AfterSaleDelivery> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_AS_AfterSaleDelivery>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_AS_AfterSaleDelivery entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_AS_AfterSaleDelivery>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_AS_AfterSaleDelivery>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_AS_AfterSaleDelivery>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_AS_AfterSaleDelivery>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_AS_AfterSaleDelivery>(list);
            return list;
        }
