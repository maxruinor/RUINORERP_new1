...
namespace RUINORERP.Business
{
    ...
    public partial class tb_AS_RepairOrderController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_AS_RepairOrderController(ILogger<tb_AS_RepairOrderController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_AS_RepairOrderServices tb_AS_RepairOrderServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_AS_RepairOrder>> SaveOrUpdate(tb_AS_RepairOrder entity)
        {
            ...
            try
            {
                ...
                if (entity.RepairOrderID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_AS_RepairOrder>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_AS_RepairOrder>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_AS_RepairOrder>(entitys);
            }
            return rs;
        }
        ...
        public tb_AS_RepairOrder AddReEntity(tb_AS_RepairOrder entity)
        {
            tb_AS_RepairOrder AddEntity =  _tb_AS_RepairOrderServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_AS_RepairOrder>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_AS_RepairOrder> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_AS_RepairOrder>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_AS_RepairOrder entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_AS_RepairOrder>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_AS_RepairOrder>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_AS_RepairOrder>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_AS_RepairOrder>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_AS_RepairOrder>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_AS_RepairOrder>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
