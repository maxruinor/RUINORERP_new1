...
namespace RUINORERP.Business
{
    ...
    public partial class tb_AS_RepairOrderDetailController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_AS_RepairOrderDetailController(ILogger<tb_AS_RepairOrderDetailController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_AS_RepairOrderDetailServices tb_AS_RepairOrderDetailServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_AS_RepairOrderDetail>> SaveOrUpdate(tb_AS_RepairOrderDetail entity)
        {
            ...
            try
            {
                ...
                if (entity.RepairOrderDetailID > 0)
                {
                    ...
                    if (rs)
                    {
                        MyCacheManager.Instance.UpdateEntityList<tb_AS_RepairOrderDetail>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                MyCacheManager.Instance.DeleteEntityList<tb_AS_RepairOrderDetail>(entity);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            if (c>0)
            {
                rs=true;
                ////生成时暂时只考虑了一个主键的情况
                 long[] result = entitys.Select(e => e.RepairOrderDetailID).ToArray();
                MyCacheManager.Instance.DeleteEntityList<tb_AS_RepairOrderDetail>(result);
            }
            return rs;
        }
        ...
        public tb_AS_RepairOrderDetail AddReEntity(tb_AS_RepairOrderDetail entity)
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_AS_RepairOrderDetail>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_AS_RepairOrderDetail> infos)
        {
            ...
            {
                 MyCacheManager.Instance.UpdateEntityList<tb_AS_RepairOrderDetail>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_AS_RepairOrderDetail>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_AS_RepairOrderDetail>(ids);
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_AS_RepairOrderDetail>> QueryAsync()
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_AS_RepairOrderDetail>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_AS_RepairOrderDetail>().Where(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
