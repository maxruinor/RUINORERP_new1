...
namespace RUINORERP.Business
{
    ...
    public partial class tb_AS_RepairOrderMaterialDetailController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_AS_RepairOrderMaterialDetailController(ILogger<tb_AS_RepairOrderMaterialDetailController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_AS_RepairOrderMaterialDetailServices tb_AS_RepairOrderMaterialDetailServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_AS_RepairOrderMaterialDetail>> SaveOrUpdate(tb_AS_RepairOrderMaterialDetail entity)
        {
            ...
            try
            {
                ...
                if (entity.RepairMaterialDetailID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_AS_RepairOrderMaterialDetail>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_AS_RepairOrderMaterialDetail>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_AS_RepairOrderMaterialDetail>(entitys);
            }
            return rs;
        }
        ...
        public tb_AS_RepairOrderMaterialDetail AddReEntity(tb_AS_RepairOrderMaterialDetail entity)
        {
            tb_AS_RepairOrderMaterialDetail AddEntity =  _tb_AS_RepairOrderMaterialDetailServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_AS_RepairOrderMaterialDetail>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_AS_RepairOrderMaterialDetail> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_AS_RepairOrderMaterialDetail>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_AS_RepairOrderMaterialDetail entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_AS_RepairOrderMaterialDetail>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_AS_RepairOrderMaterialDetail>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_AS_RepairOrderMaterialDetail>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_AS_RepairOrderMaterialDetail>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_AS_RepairOrderMaterialDetail>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_AS_RepairOrderMaterialDetail>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
