...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ApprovalController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_ApprovalController(ILogger<tb_ApprovalController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_ApprovalServices tb_ApprovalServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public ValidationResult Validator(tb_Approval info)
        {
           ...
           tb_ApprovalValidator validator = _appContext.GetRequiredService<tb_ApprovalValidator>();
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_Approval>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_Approval>(entitys);
            }
            return rs;
        }
        ...
        public tb_Approval AddReEntity(tb_Approval entity)
        {
            tb_Approval AddEntity =  _tb_ApprovalServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_Approval>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_Approval> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_Approval>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_Approval>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_Approval>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_Approval>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_Approval>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_Approval>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
