...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ApprovalProcessDetailController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_ApprovalProcessDetailController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_ApprovalProcessDetailServices tb_ApprovalProcessDetailServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
