...
namespace RUINORERP.Business
{
    ...
    public partial class tb_BOMConfigHistoryController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_BOMConfigHistoryController(ILogger<tb_BOMConfigHistoryController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_BOMConfigHistoryServices tb_BOMConfigHistoryServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public ValidationResult Validator(tb_BOMConfigHistory info)
        {
           ...
           tb_BOMConfigHistoryValidator validator = _appContext.GetRequiredService<tb_BOMConfigHistoryValidator>();
        ...
        public async Task<ReturnResults<tb_BOMConfigHistory>> SaveOrUpdate(tb_BOMConfigHistory entity)
        {
            ...
            try
            {
                ...
                if (entity.BOM_S_VERID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_BOMConfigHistory>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_BOMConfigHistory>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_BOMConfigHistory>(entitys);
            }
            return rs;
        }
        ...
        public tb_BOMConfigHistory AddReEntity(tb_BOMConfigHistory entity)
        {
            tb_BOMConfigHistory AddEntity =  _tb_BOMConfigHistoryServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_BOMConfigHistory>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_BOMConfigHistory> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_BOMConfigHistory>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_BOMConfigHistory entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_BOMConfigHistory>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_BOMConfigHistory>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_BOMConfigHistory>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_BOMConfigHistory>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_BOMConfigHistory>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_BOMConfigHistory>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
