...
namespace RUINORERP.Business
{
    ...
    public partial class tb_BOMConfigHistoryController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_BOMConfigHistoryController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_BOMConfigHistoryServices tb_BOMConfigHistoryServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
