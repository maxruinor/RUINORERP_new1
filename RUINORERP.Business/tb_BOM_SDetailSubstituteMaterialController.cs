...
namespace RUINORERP.Business
{
    ...
    public partial class tb_BOM_SDetailSubstituteMaterialController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_BOM_SDetailSubstituteMaterialController(ILogger<tb_BOM_SDetailSubstituteMaterialController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_BOM_SDetailSubstituteMaterialServices tb_BOM_SDetailSubstituteMaterialServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        /// <returns></returns>
        public async Task<ReturnResults<tb_BOM_SDetailSubstituteMaterial>> SaveOrUpdate(tb_BOM_SDetailSubstituteMaterial entity)
        {
            ReturnResults<tb_BOM_SDetailSubstituteMaterial> rr = new ReturnResults<tb_BOM_SDetailSubstituteMaterial>();
            tb_BOM_SDetailSubstituteMaterial Returnobj;
            try
            {
                //生成时暂时只考虑了一个主键的情况
                if (entity.SubstituteMaterialID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_BOM_SDetailSubstituteMaterial>(entity);
                    }
                    Returnobj = entity;
                }
                else
                {
                    Returnobj = await _tb_BOM_SDetailSubstituteMaterialServices.AddReEntityAsync(entity);
                    _eventDrivenCacheManager.UpdateEntity<tb_BOM_SDetailSubstituteMaterial>(entity);
                }
        ...
        public async override Task<List<T>> BaseQueryAsync(string wheresql) 
        {
            ...
            {
                tb_BOM_SDetailSubstituteMaterial entity = item as tb_BOM_SDetailSubstituteMaterial;
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_BOM_SDetailSubstituteMaterial>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_BOM_SDetailSubstituteMaterial>(entitys);
            }
            return rs;
        }
        ...
        public tb_BOM_SDetailSubstituteMaterial AddReEntity(tb_BOM_SDetailSubstituteMaterial entity)
        {
            tb_BOM_SDetailSubstituteMaterial AddEntity =  _tb_BOM_SDetailSubstituteMaterialServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_BOM_SDetailSubstituteMaterial>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_BOM_SDetailSubstituteMaterial> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_BOM_SDetailSubstituteMaterial>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_BOM_SDetailSubstituteMaterial entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_BOM_SDetailSubstituteMaterial>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_BOM_SDetailSubstituteMaterial>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_BOM_SDetailSubstituteMaterial>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_BOM_SDetailSubstituteMaterial>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_BOM_SDetailSubstituteMaterial>(list);
            return list;
        }
        ...
        /// <returns></returns>
        public async Task<List<tb_BOM_SDetailSubstituteMaterial>> QueryAsync(Expression<Func<tb_BOM_SDetailSubstituteMaterial, bool>> exp)
        {
            List<tb_BOM_SDetailSubstituteMaterial> list = await _unitOfWorkManage.GetDbClient().Queryable<tb_BOM_SDetailSubstituteMaterial>().Where(exp).ToListAsync();
            foreach (var item in list)
            {
                item.AcceptChanges();
            }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_BOM_SDetailSubstituteMaterial>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
