...
namespace RUINORERP.Business
{
    ...
    public partial class tb_BatchNumberController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_BatchNumberController(ILogger<tb_BatchNumberController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_BatchNumberServices tb_BatchNumberServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public ValidationResult Validator(tb_BatchNumber info)
        {
           ...
           tb_BatchNumberValidator validator = _appContext.GetRequiredService<tb_BatchNumberValidator>();
        ...
        public async Task<ReturnResults<tb_BatchNumber>> SaveOrUpdate(tb_BatchNumber entity)
        {
            ...
            try
            {
                ...
                if (entity.Batch_ID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_BatchNumber>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_BatchNumber>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_BatchNumber>(entitys);
            }
            return rs;
        }
        ...
        public async override Task<ReturnMainSubResults<T>> BaseSaveOrUpdateWithChild<C>(T model) where C : class
        {
            ...
            if (entity.Batch_ID > 0)
            {
                                 ...
                                 var result= await _unitOfWorkManage.GetDbClient().Updateable<tb_BatchNumber>(entity as tb_BatchNumber)
                    .ExecuteCommandAsync();
                    if (result > 0)
                    {
                        rs = true;
        ...
        {
                                  var result= await _unitOfWorkManage.GetDbClient().Insertable<tb_BatchNumber>(entity as tb_BatchNumber)
        ...
        public tb_BatchNumber AddReEntity(tb_BatchNumber entity)
        {
            tb_BatchNumber AddEntity =  _tb_BatchNumberServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_BatchNumber>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_BatchNumber> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_BatchNumber>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_BatchNumber entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_BatchNumber>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_BatchNumber>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_BatchNumber>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_BatchNumber>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_BatchNumber>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_BatchNumber>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
