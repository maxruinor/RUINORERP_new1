...
namespace RUINORERP.Business
{
    ...
    public partial class tb_BatchNumberController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_BatchNumberController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_BatchNumberServices tb_BatchNumberServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
