...
namespace RUINORERP.Business
{
    ...
    public partial class tb_BillMarkingController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_BillMarkingController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_BillMarkingServices tb_BillMarkingServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
