...
namespace RUINORERP.Business
{
    ...
    public partial class tb_BillingInformationController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_BillingInformationController(ILogger<tb_BillingInformationController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_BillingInformationServices tb_BillingInformationServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_BillingInformation>> SaveOrUpdate(tb_BillingInformation entity)
        {
            ...
            try
            {
                ...
                if (entity.BillingInfo_ID > 0)
                {
                    ...
                    if (rs)
                    {
                        MyCacheManager.Instance.UpdateEntityList<tb_BillingInformation>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                MyCacheManager.Instance.DeleteEntityList<tb_BillingInformation>(entity);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            if (c>0)
            {
                rs=true;
                ////生成时暂时只考虑了一个主键的情况
                 long[] result = entitys.Select(e => e.BillingInfo_ID).ToArray();
                MyCacheManager.Instance.DeleteEntityList<tb_BillingInformation>(result);
            }
            return rs;
        }
        ...
        public async override Task<ReturnMainSubResults<T>> BaseSaveOrUpdateWithChild<C>(T model) where C : class
        {
            ...
            if (entity.BillingInfo_ID > 0)
            {
                                 ...
                                 var result= await _unitOfWorkManage.GetDbClient().Updateable<tb_BillingInformation>(entity as tb_BillingInformation)
                    .ExecuteCommandAsync();
                    if (result > 0)
                    {
                        rs = true;
        ...
        {
                                  var result= await _unitOfWorkManage.GetDbClient().Insertable<tb_BillingInformation>(entity as tb_BillingInformation)
        ...
        public tb_BillingInformation AddReEntity(tb_BillingInformation entity)
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_BillingInformation>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_BillingInformation> infos)
        {
            ...
            {
                 MyCacheManager.Instance.UpdateEntityList<tb_BillingInformation>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_BillingInformation>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_BillingInformation>(ids);
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_BillingInformation>> QueryAsync()
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_BillingInformation>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_BillingInformation>().Where(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
