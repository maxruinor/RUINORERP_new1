...
namespace RUINORERP.Business
{
    ...
    public partial class tb_BizTypeController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_BizTypeController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_BizTypeServices tb_BizTypeServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
