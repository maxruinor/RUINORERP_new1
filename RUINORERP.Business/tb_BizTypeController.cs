...
namespace RUINORERP.Business
{
    ...
    public partial class tb_BizTypeController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_BizTypeController(ILogger<tb_BizTypeController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_BizTypeServices tb_BizTypeServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public ValidationResult Validator(tb_BizType info)
        {
           ...
           tb_BizTypeValidator validator = _appContext.GetRequiredService<tb_BizTypeValidator>();
        ...
        public async Task<ReturnResults<tb_BizType>> SaveOrUpdate(tb_BizType entity)
        {
            ...
            try
            {
                ...
                if (entity.Type_ID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_BizType>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_BizType>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_BizType>(entitys);
            }
            return rs;
        }
        ...
        public async override Task<ReturnMainSubResults<T>> BaseSaveOrUpdateWithChild<C>(T model) where C : class
        {
            ...
            if (entity.Type_ID > 0)
            {
                                 ...
                                 var result= await _unitOfWorkManage.GetDbClient().Updateable<tb_BizType>(entity as tb_BizType)
                    .ExecuteCommandAsync();
                    if (result > 0)
                    {
                        rs = true;
        ...
        {
                                  var result= await _unitOfWorkManage.GetDbClient().Insertable<tb_BizType>(entity as tb_BizType)
        ...
        public tb_BizType AddReEntity(tb_BizType entity)
        {
            tb_BizType AddEntity =  _tb_BizTypeServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_BizType>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_BizType> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_BizType>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_BizType entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_BizType>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_BizType>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_BizType>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_BizType>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_BizType>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_BizType>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
