...
namespace RUINORERP.Business
{
    ...
    public partial class tb_BoxRulesController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_BoxRulesController(ILogger<tb_BoxRulesController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_BoxRulesServices tb_BoxRulesServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_BoxRules>> SaveOrUpdate(tb_BoxRules entity)
        {
            ...
            try
            {
                ...
                if (entity.BoxRules_ID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_BoxRules>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_BoxRules>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_BoxRules>(entitys);
            }
            return rs;
        }
        ...
        public async override Task<ReturnMainSubResults<T>> BaseSaveOrUpdateWithChild<C>(T model) where C : class
        {
            ...
            if (entity.BoxRules_ID > 0)
            {
                                 ...
                                 var result= await _unitOfWorkManage.GetDbClient().Updateable<tb_BoxRules>(entity as tb_BoxRules)
                    .ExecuteCommandAsync();
                    if (result > 0)
                    {
                        rs = true;
        ...
        {
                                  var result= await _unitOfWorkManage.GetDbClient().Insertable<tb_BoxRules>(entity as tb_BoxRules)
        ...
        public tb_BoxRules AddReEntity(tb_BoxRules entity)
        {
            tb_BoxRules AddEntity =  _tb_BoxRulesServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_BoxRules>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_BoxRules> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_BoxRules>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_BoxRules entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_BoxRules>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_BoxRules>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_BoxRules>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_BoxRules>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_BoxRules>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_BoxRules>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
