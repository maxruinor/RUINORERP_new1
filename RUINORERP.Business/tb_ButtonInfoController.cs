...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ButtonInfoController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_ButtonInfoController(ILogger<tb_ButtonInfoController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_ButtonInfoServices tb_ButtonInfoServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
