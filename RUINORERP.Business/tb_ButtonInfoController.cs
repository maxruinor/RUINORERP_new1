...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ButtonInfoController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_ButtonInfoController(ILogger<tb_ButtonInfoController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_ButtonInfoServices tb_ButtonInfoServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public ValidationResult Validator(tb_ButtonInfo info)
        {
           ...
           tb_ButtonInfoValidator validator = _appContext.GetRequiredService<tb_ButtonInfoValidator>();
        ...
        public async Task<ReturnResults<tb_ButtonInfo>> SaveOrUpdate(tb_ButtonInfo entity)
        {
            ...
            try
            {
                ...
                if (entity.ButtonInfo_ID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_ButtonInfo>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_ButtonInfo>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_ButtonInfo>(entitys);
            }
            return rs;
        }
        ...
        public tb_ButtonInfo AddReEntity(tb_ButtonInfo entity)
        {
            tb_ButtonInfo AddEntity =  _tb_ButtonInfoServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_ButtonInfo>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_ButtonInfo> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_ButtonInfo>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_ButtonInfo entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_ButtonInfo>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_ButtonInfo>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_ButtonInfo>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_ButtonInfo>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_ButtonInfo>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_ButtonInfo>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
