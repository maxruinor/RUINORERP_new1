...
namespace RUINORERP.Business
{
    ...
    public partial class tb_BuyingRequisitionController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_BuyingRequisitionController(ILogger<tb_BuyingRequisitionController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_BuyingRequisitionServices tb_BuyingRequisitionServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_BuyingRequisition>> SaveOrUpdate(tb_BuyingRequisition entity)
        {
            ...
            try
            {
                ...
                if (entity.PuRequisition_ID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_BuyingRequisition>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_BuyingRequisition>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_BuyingRequisition>(entitys);
            }
            return rs;
        }
        ...
        public tb_BuyingRequisition AddReEntity(tb_BuyingRequisition entity)
        {
            tb_BuyingRequisition AddEntity =  _tb_BuyingRequisitionServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_BuyingRequisition>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_BuyingRequisition> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_BuyingRequisition>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_BuyingRequisition entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_BuyingRequisition>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_BuyingRequisition>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_BuyingRequisition>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_BuyingRequisition>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_BuyingRequisition>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_BuyingRequisition>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
