...
namespace RUINORERP.Business
{
    ...
    public partial class tb_CRM_ContactController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_CRM_ContactController(ILogger<tb_CRM_ContactController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_CRM_ContactServices tb_CRM_ContactServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public ValidationResult Validator(tb_CRM_Contact info)
        {
           ...
           tb_CRM_ContactValidator validator = _appContext.GetRequiredService<tb_CRM_ContactValidator>();
        ...
        public async Task<ReturnResults<tb_CRM_Contact>> SaveOrUpdate(tb_CRM_Contact entity)
        {
            ...
            try
            {
                ...
                if (entity.Contact_id > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_CRM_Contact>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_CRM_Contact>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_CRM_Contact>(entitys);
            }
            return rs;
        }
        ...
        public async override Task<ReturnMainSubResults<T>> BaseSaveOrUpdateWithChild<C>(T model) where C : class
        {
            ...
            if (entity.Contact_id > 0)
            {
                                 ...
                                 var result= await _unitOfWorkManage.GetDbClient().Updateable<tb_CRM_Contact>(entity as tb_CRM_Contact)
                    .ExecuteCommandAsync();
                    if (result > 0)
                    {
                        rs = true;
        ...
        {
                                  var result= await _unitOfWorkManage.GetDbClient().Insertable<tb_CRM_Contact>(entity as tb_CRM_Contact)
        ...
        public tb_CRM_Contact AddReEntity(tb_CRM_Contact entity)
        {
            tb_CRM_Contact AddEntity =  _tb_CRM_ContactServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_CRM_Contact>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_CRM_Contact> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_CRM_Contact>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_CRM_Contact entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_CRM_Contact>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_CRM_Contact>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_CRM_Contact>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_CRM_Contact>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_CRM_Contact>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_CRM_Contact>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
