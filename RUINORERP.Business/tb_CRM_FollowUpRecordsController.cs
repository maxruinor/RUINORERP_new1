...
namespace RUINORERP.Business
{
    ...
    public partial class tb_CRM_FollowUpRecordsController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_CRM_FollowUpRecordsController(ILogger<tb_CRM_FollowUpRecordsController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_CRM_FollowUpRecordsServices tb_CRM_FollowUpRecordsServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public ValidationResult Validator(tb_CRM_FollowUpRecords info)
        {
           ...
           tb_CRM_FollowUpRecordsValidator validator = _appContext.GetRequiredService<tb_CRM_FollowUpRecordsValidator>();
        ...
        public async Task<ReturnResults<tb_CRM_FollowUpRecords>> SaveOrUpdate(tb_CRM_FollowUpRecords entity)
        {
            ...
            try
            {
                ...
                if (entity.RecordID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_CRM_FollowUpRecords>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_CRM_FollowUpRecords>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_CRM_FollowUpRecords>(entitys);
            }
            return rs;
        }
        ...
        public async override Task<ReturnMainSubResults<T>> BaseSaveOrUpdateWithChild<C>(T model) where C : class
        {
            ...
            if (entity.RecordID > 0)
            {
                                 ...
                                 var result= await _unitOfWorkManage.GetDbClient().Updateable<tb_CRM_FollowUpRecords>(entity as tb_CRM_FollowUpRecords)
                    .ExecuteCommandAsync();
                    if (result > 0)
                    {
                        rs = true;
        ...
        {
                                  var result= await _unitOfWorkManage.GetDbClient().Insertable<tb_CRM_FollowUpRecords>(entity as tb_CRM_FollowUpRecords)
        ...
        public tb_CRM_FollowUpRecords AddReEntity(tb_CRM_FollowUpRecords entity)
        {
            tb_CRM_FollowUpRecords AddEntity =  _tb_CRM_FollowUpRecordsServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_CRM_FollowUpRecords>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_CRM_FollowUpRecords> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_CRM_FollowUpRecords>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_CRM_FollowUpRecords entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_CRM_FollowUpRecords>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_CRM_FollowUpRecords>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_CRM_FollowUpRecords>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_CRM_FollowUpRecords>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_CRM_FollowUpRecords>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_CRM_FollowUpRecords>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
