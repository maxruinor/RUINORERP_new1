    ...
    public partial class tb_CRM_LeadsController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public ValidationResult Validator(tb_CRM_Leads info)
        {
           ...
           tb_CRM_LeadsValidator validator = _appContext.GetRequiredService<tb_CRM_LeadsValidator>();
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_CRM_Leads>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
