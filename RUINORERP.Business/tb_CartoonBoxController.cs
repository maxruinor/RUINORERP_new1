...
namespace RUINORERP.Business
{
    ...
    public partial class tb_CartoonBoxController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_CartoonBoxController(ILogger<tb_CartoonBoxController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_CartoonBoxServices tb_CartoonBoxServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_CartoonBox>> SaveOrUpdate(tb_CartoonBox entity)
        {
            ...
            try
            {
                ...
                if (entity.CartonID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_CartoonBox>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_CartoonBox>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_CartoonBox>(entitys);
            }
            return rs;
        }
        ...
        public tb_CartoonBox AddReEntity(tb_CartoonBox entity)
        {
            tb_CartoonBox AddEntity =  _tb_CartoonBoxServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_CartoonBox>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_CartoonBox> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_CartoonBox>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_CartoonBox entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_CartoonBox>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_CartoonBox>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_CartoonBox>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_CartoonBox>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_CartoonBox>(list);
            return list;
        }
