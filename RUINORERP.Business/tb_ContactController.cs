...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ContactController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_ContactController(ILogger<tb_ContactController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_ContactServices tb_ContactServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
