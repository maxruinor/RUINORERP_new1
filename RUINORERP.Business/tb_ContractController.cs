...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ContractController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_ContractController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_ContractServices tb_ContractServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
