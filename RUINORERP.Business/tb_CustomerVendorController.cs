...
namespace RUINORERP.Business
{
    ...
    public partial class tb_CustomerVendorController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_CustomerVendorController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_CustomerVendorServices tb_CustomerVendorServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
