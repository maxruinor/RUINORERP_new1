...
namespace RUINORERP.Business
{
    ...
    public partial class tb_CustomerVendorFilesController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_CustomerVendorFilesController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_CustomerVendorFilesServices tb_CustomerVendorFilesServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
