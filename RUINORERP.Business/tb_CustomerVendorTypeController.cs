...
namespace RUINORERP.Business
{
    ...
    public partial class tb_CustomerVendorTypeController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_CustomerVendorTypeController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_CustomerVendorTypeServices tb_CustomerVendorTypeServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
