...
namespace RUINORERP.Business
{
    ...
    public partial class tb_Customer_interactionController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_Customer_interactionController(ILogger<tb_Customer_interactionController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_Customer_interactionServices tb_Customer_interactionServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
