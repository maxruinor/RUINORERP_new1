...
namespace RUINORERP.Business
{
    ...
    public partial class tb_DocumentsController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_DocumentsController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_DocumentsServices tb_DocumentsServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
