...
namespace RUINORERP.Business
{
    ...
    public partial class tb_EmployeeController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_EmployeeController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_EmployeeServices tb_EmployeeServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
