...
namespace RUINORERP.Business
{
    ...
    public partial class tb_FM_ExpenseClaimDetailController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_FM_ExpenseClaimDetailController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_FM_ExpenseClaimDetailServices tb_FM_ExpenseClaimDetailServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
