...
namespace RUINORERP.Business
{
    ...
    public partial class tb_FM_ExpenseTypeController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_FM_ExpenseTypeController(ILogger<tb_FM_ExpenseTypeController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_FM_ExpenseTypeServices tb_FM_ExpenseTypeServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
