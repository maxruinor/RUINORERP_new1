...
namespace RUINORERP.Business
{
    ...
    public partial class tb_FM_Initial_PayAndReceivableController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_FM_Initial_PayAndReceivableController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_FM_Initial_PayAndReceivableServices tb_FM_Initial_PayAndReceivableServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
