...
namespace RUINORERP.Business
{
    ...
    public partial class tb_FM_InvoiceDetailController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_FM_InvoiceDetailController(ILogger<tb_FM_InvoiceDetailController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_FM_InvoiceDetailServices tb_FM_InvoiceDetailServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_FM_InvoiceDetail>> SaveOrUpdate(tb_FM_InvoiceDetail entity)
        {
            ...
            try
            {
                ...
                if (entity.InvoiceDetailID > 0)
                {
                    ...
                    if (rs)
                    {
                        MyCacheManager.Instance.UpdateEntityList<tb_FM_InvoiceDetail>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                MyCacheManager.Instance.DeleteEntityList<tb_FM_InvoiceDetail>(entity);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            if (c>0)
            {
                rs=true;
                ////生成时暂时只考虑了一个主键的情况
                 long[] result = entitys.Select(e => e.InvoiceDetailID).ToArray();
                MyCacheManager.Instance.DeleteEntityList<tb_FM_InvoiceDetail>(result);
            }
            return rs;
        }
        ...
        public tb_FM_InvoiceDetail AddReEntity(tb_FM_InvoiceDetail entity)
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_FM_InvoiceDetail>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_FM_InvoiceDetail> infos)
        {
            ...
            {
                 MyCacheManager.Instance.UpdateEntityList<tb_FM_InvoiceDetail>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_FM_InvoiceDetail>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_FM_InvoiceDetail>(ids);
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_FM_InvoiceDetail>> QueryAsync()
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_FM_InvoiceDetail>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_FM_InvoiceDetail>().Where(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
