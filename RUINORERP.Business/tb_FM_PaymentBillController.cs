...
namespace RUINORERP.Business
{
    ...
    public partial class tb_FM_PaymentBillController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_FM_PaymentBillController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_FM_PaymentBillServices tb_FM_PaymentBillServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
