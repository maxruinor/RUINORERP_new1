...
namespace RUINORERP.Business
{
    ...
    public partial class tb_FM_PrePaymentBillController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_FM_PrePaymentBillController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_FM_PrePaymentBillServices tb_FM_PrePaymentBillServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
