...
namespace RUINORERP.Business
{
    ...
    public partial class tb_FavoriteController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_FavoriteController(ILogger<tb_FavoriteController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_FavoriteServices tb_FavoriteServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_Favorite>> SaveOrUpdate(tb_Favorite entity)
        {
            ...
            try
            {
                ...
                if (entity.ID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_Favorite>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_Favorite>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_Favorite>(entitys);
            }
            return rs;
        }
        ...
        public tb_Favorite AddReEntity(tb_Favorite entity)
        {
            tb_Favorite AddEntity =  _tb_FavoriteServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_Favorite>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_Favorite> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_Favorite>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_Favorite entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_Favorite>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_Favorite>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_Favorite>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_Favorite>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_Favorite>(list);
            return list;
        }
