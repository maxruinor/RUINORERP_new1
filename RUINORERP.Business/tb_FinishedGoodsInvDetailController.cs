...
namespace RUINORERP.Business
{
    ...
    public partial class tb_FinishedGoodsInvDetailController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_FinishedGoodsInvDetailController(ILogger<tb_FinishedGoodsInvDetailController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_FinishedGoodsInvDetailServices tb_FinishedGoodsInvDetailServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_FinishedGoodsInvDetail>> SaveOrUpdate(tb_FinishedGoodsInvDetail entity)
        {
            ...
            try
            {
                ...
                if (entity.Sub_ID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_FinishedGoodsInvDetail>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_FinishedGoodsInvDetail>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_FinishedGoodsInvDetail>(entitys);
            }
            return rs;
        }
        ...
        public tb_FinishedGoodsInvDetail AddReEntity(tb_FinishedGoodsInvDetail entity)
        {
            tb_FinishedGoodsInvDetail AddEntity =  _tb_FinishedGoodsInvDetailServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_FinishedGoodsInvDetail>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_FinishedGoodsInvDetail> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_FinishedGoodsInvDetail>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_FinishedGoodsInvDetail entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_FinishedGoodsInvDetail>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_FinishedGoodsInvDetail>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_FinishedGoodsInvDetail>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_FinishedGoodsInvDetail>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_FinishedGoodsInvDetail>(list);
            return list;
        }
