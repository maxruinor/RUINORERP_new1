...
namespace RUINORERP.Business
{
    ...
    public partial class tb_FlowchartItemController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_FlowchartItemController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_FlowchartItemServices tb_FlowchartItemServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
