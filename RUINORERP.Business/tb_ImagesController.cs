...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ImagesController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_ImagesController(ILogger<tb_ImagesController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_ImagesServices tb_ImagesServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
