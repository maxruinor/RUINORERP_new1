...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ImagesController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_ImagesController(ILogger<tb_ImagesController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_ImagesServices tb_ImagesServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public ValidationResult Validator(tb_Images info)
        {
           ...
           tb_ImagesValidator validator = _appContext.GetRequiredService<tb_ImagesValidator>();
        ...
        public async Task<ReturnResults<tb_Images>> SaveOrUpdate(tb_Images entity)
        {
            ...
            try
            {
                ...
                if (entity.Images_ID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_Images>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_Images>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_Images>(entitys);
            }
            return rs;
        }
        ...
        public tb_Images AddReEntity(tb_Images entity)
        {
            tb_Images AddEntity =  _tb_ImagesServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_Images>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_Images> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_Images>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_Images entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_Images>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_Images>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_Images>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_Images>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_Images>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_Images>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
