...
namespace RUINORERP.Business
{
    ...
    public partial class tb_Inv_Alert_AttributeController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_Inv_Alert_AttributeController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_Inv_Alert_AttributeServices tb_Inv_Alert_AttributeServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
