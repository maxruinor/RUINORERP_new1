...
namespace RUINORERP.Business
{
    ...
    public partial class tb_InventoryController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_InventoryController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_InventoryServices tb_InventoryServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_Inventory>().Where(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
