...
namespace RUINORERP.Business
{
    ...
    public partial class tb_InventorySnapshotController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_InventorySnapshotController(ILogger<tb_InventorySnapshotController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_InventorySnapshotServices tb_InventorySnapshotServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_InventorySnapshot>> SaveOrUpdate(tb_InventorySnapshot entity)
        {
            ...
            try
            {
                ...
                if (entity.SnapshotID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_InventorySnapshot>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_InventorySnapshot>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_InventorySnapshot>(entitys);
            }
            return rs;
        }
        ...
        public tb_InventorySnapshot AddReEntity(tb_InventorySnapshot entity)
        {
            tb_InventorySnapshot AddEntity =  _tb_InventorySnapshotServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_InventorySnapshot>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_InventorySnapshot> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_InventorySnapshot>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_InventorySnapshot entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_InventorySnapshot>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_InventorySnapshot>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_InventorySnapshot>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_InventorySnapshot>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_InventorySnapshot>(list);
            return list;
        }
