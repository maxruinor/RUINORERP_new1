...
namespace RUINORERP.Business
{
    ...
    public partial class tb_InvoiceInfoController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_InvoiceInfoController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_InvoiceInfoServices tb_InvoiceInfoServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
