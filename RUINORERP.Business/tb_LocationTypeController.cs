...
namespace RUINORERP.Business
{
    ...
    public partial class tb_LocationTypeController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_LocationTypeController(ILogger<tb_LocationTypeController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_LocationTypeServices tb_LocationTypeServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_LocationType>> SaveOrUpdate(tb_LocationType entity)
        {
            ...
            try
            {
                ...
                if (entity.LocationType_ID > 0)
                {
                    ...
                    if (rs)
                    {
                        MyCacheManager.Instance.UpdateEntityList<tb_LocationType>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                MyCacheManager.Instance.DeleteEntityList<tb_LocationType>(entity);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            if (c>0)
            {
                rs=true;
                ////生成时暂时只考虑了一个主键的情况
                 long[] result = entitys.Select(e => e.LocationType_ID).ToArray();
                MyCacheManager.Instance.DeleteEntityList<tb_LocationType>(result);
            }
            return rs;
        }
        ...
        public tb_LocationType AddReEntity(tb_LocationType entity)
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_LocationType>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_LocationType> infos)
        {
            ...
            {
                 MyCacheManager.Instance.UpdateEntityList<tb_LocationType>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_LocationType>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_LocationType>(ids);
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_LocationType>> QueryAsync()
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_LocationType>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_LocationType>().Where(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
