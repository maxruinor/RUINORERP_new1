...
namespace RUINORERP.Business
{
    ...
    public partial class tb_MRP_ReworkReturnDetailController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_MRP_ReworkReturnDetailController(ILogger<tb_MRP_ReworkReturnDetailController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_MRP_ReworkReturnDetailServices tb_MRP_ReworkReturnDetailServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_MRP_ReworkReturnDetail>> SaveOrUpdate(tb_MRP_ReworkReturnDetail entity)
        {
            ...
            try
            {
                ...
                if (entity.ReworkReturnCID > 0)
                {
                    ...
                    if (rs)
                    {
                        MyCacheManager.Instance.UpdateEntityList<tb_MRP_ReworkReturnDetail>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                MyCacheManager.Instance.DeleteEntityList<tb_MRP_ReworkReturnDetail>(entity);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            if (c>0)
            {
                rs=true;
                ////生成时暂时只考虑了一个主键的情况
                 long[] result = entitys.Select(e => e.ReworkReturnCID).ToArray();
                MyCacheManager.Instance.DeleteEntityList<tb_MRP_ReworkReturnDetail>(result);
            }
            return rs;
        }
        ...
        public async override Task<ReturnMainSubResults<T>> BaseSaveOrUpdateWithChild<C>(T model) where C : class
        {
            ...
            if (entity.ReworkReturnCID > 0)
            {
                rs = await _unitOfWorkManage.GetDbClient().UpdateNav<tb_MRP_ReworkReturnDetail>(entity as tb_MRP_ReworkReturnDetail)
        ...
        {
            rs = await _unitOfWorkManage.GetDbClient().InsertNav<tb_MRP_ReworkReturnDetail>(entity as tb_MRP_ReworkReturnDetail)
                //这里一般是子表，或没有一对多外键的情况 ，用自动的只是为了语法正常一般不会调用这个方法
                .IncludesAllFirstLayer()//自动更新导航 只能两层。这里项目中有时会失效，具体看文档
                                .ExecuteCommandAsync();
        }
        ...
        public tb_MRP_ReworkReturnDetail AddReEntity(tb_MRP_ReworkReturnDetail entity)
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_MRP_ReworkReturnDetail>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_MRP_ReworkReturnDetail> infos)
        {
            ...
            {
                 MyCacheManager.Instance.UpdateEntityList<tb_MRP_ReworkReturnDetail>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_MRP_ReworkReturnDetail>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_MRP_ReworkReturnDetail>(ids);
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_MRP_ReworkReturnDetail>> QueryAsync()
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_MRP_ReworkReturnDetail>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_MRP_ReworkReturnDetail>().Where(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
