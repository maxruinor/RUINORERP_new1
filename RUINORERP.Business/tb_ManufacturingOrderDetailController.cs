...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ManufacturingOrderDetailController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_ManufacturingOrderDetailController(ILogger<tb_ManufacturingOrderDetailController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_ManufacturingOrderDetailServices tb_ManufacturingOrderDetailServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_ManufacturingOrderDetail>> SaveOrUpdate(tb_ManufacturingOrderDetail entity)
        {
            ...
            try
            {
                ...
                if (entity.MOCID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_ManufacturingOrderDetail>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_ManufacturingOrderDetail>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_ManufacturingOrderDetail>(entitys);
            }
            return rs;
        }
        ...
        public async override Task<ReturnMainSubResults<T>> BaseSaveOrUpdateWithChild<C>(T model) where C : class
        {
            ...
            if (entity.MOCID > 0)
            {
                                 ...
                                 var result= await _unitOfWorkManage.GetDbClient().Updateable<tb_ManufacturingOrderDetail>(entity as tb_ManufacturingOrderDetail)
                    .ExecuteCommandAsync();
                    if (result > 0)
                    {
                        rs = true;
        ...
        {
                                  var result= await _unitOfWorkManage.GetDbClient().Insertable<tb_ManufacturingOrderDetail>(entity as tb_ManufacturingOrderDetail)
        ...
        public tb_ManufacturingOrderDetail AddReEntity(tb_ManufacturingOrderDetail entity)
        {
            tb_ManufacturingOrderDetail AddEntity =  _tb_ManufacturingOrderDetailServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_ManufacturingOrderDetail>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_ManufacturingOrderDetail> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_ManufacturingOrderDetail>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_ManufacturingOrderDetail entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_ManufacturingOrderDetail>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_ManufacturingOrderDetail>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_ManufacturingOrderDetail>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_ManufacturingOrderDetail>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_ManufacturingOrderDetail>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_ManufacturingOrderDetail>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
