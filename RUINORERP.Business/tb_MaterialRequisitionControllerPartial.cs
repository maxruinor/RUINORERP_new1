...
namespace RUINORERP.Business
{
    ...
    public partial class tb_MaterialRequisitionController<T> : BaseController<T> where T : class
    {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public async virtual Task<ReturnResults<bool>> BatchApprovalAsync(List<tb_MaterialRequisition> entitys, ApprovalEntity approvalEntity)
        {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public async virtual Task<ReturnResults<bool>> AntiApprovalAsync(List<tb_MaterialRequisition> entitys)
        {
            ReturnResults<bool> rs = new ReturnResults<bool>();
            try
            {
                ...
                foreach (tb_MaterialRequisition entity in entitys)
                {
                    //判断是否能反审?
