...
namespace RUINORERP.Business
{
    ...
    public partial class tb_MaterialReturnDetailController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_MaterialReturnDetailController(ILogger<tb_MaterialReturnDetailController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_MaterialReturnDetailServices tb_MaterialReturnDetailServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_MaterialReturnDetail>> SaveOrUpdate(tb_MaterialReturnDetail entity)
        {
            ...
            try
            {
                ...
                if (entity.Sub_ID > 0)
                {
                    ...
                    if (rs)
                    {
                        MyCacheManager.Instance.UpdateEntityList<tb_MaterialReturnDetail>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                MyCacheManager.Instance.DeleteEntityList<tb_MaterialReturnDetail>(entity);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            if (c>0)
            {
                ...
                MyCacheManager.Instance.DeleteEntityList<tb_MaterialReturnDetail>(result);
            }
            return rs;
        }
        ...
        public async override Task<ReturnMainSubResults<T>> BaseSaveOrUpdateWithChild<C>(T model) where C : class
        {
            ...
            if (entity.Sub_ID > 0)
            {
                rs = await _unitOfWorkManage.GetDbClient().UpdateNav<tb_MaterialReturnDetail>(entity as tb_MaterialReturnDetail)
        ...
        {
            rs = await _unitOfWorkManage.GetDbClient().InsertNav<tb_MaterialReturnDetail>(entity as tb_MaterialReturnDetail)
                //这里一般是子表，或没有一对多外键的情况 ，用自动的只是为了语法正常一般不会调用这个方法
                .IncludesAllFirstLayer()//自动更新导航 只能两层。这里项目中有时会失效，具体看文档
                                .ExecuteCommandAsync();
        }
        ...
        public tb_MaterialReturnDetail AddReEntity(tb_MaterialReturnDetail entity)
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_MaterialReturnDetail>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_MaterialReturnDetail> infos)
        {
            ...
            {
                 MyCacheManager.Instance.UpdateEntityList<tb_MaterialReturnDetail>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_MaterialReturnDetail>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_MaterialReturnDetail>(ids);
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_MaterialReturnDetail>> QueryAsync()
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_MaterialReturnDetail>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_MaterialReturnDetail>().Where(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
