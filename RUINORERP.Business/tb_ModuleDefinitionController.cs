    ...
    public partial class tb_ModuleDefinitionController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public ValidationResult Validator(tb_ModuleDefinition info)
        {
           ...
           tb_ModuleDefinitionValidator validator = _appContext.GetRequiredService<tb_ModuleDefinitionValidator>();
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_ModuleDefinition>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
