...
namespace RUINORERP.Business
{
    ...
    public partial class tb_NextNodesController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_NextNodesController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_NextNodesServices tb_NextNodesServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
