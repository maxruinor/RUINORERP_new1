...
namespace RUINORERP.Business
{
    ...
    public partial class tb_OpeningInventoryController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_OpeningInventoryController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_OpeningInventoryServices tb_OpeningInventoryServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
