...
namespace RUINORERP.Business
{
    ...
    public partial class tb_OrderPackingController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_OrderPackingController(ILogger<tb_OrderPackingController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_OrderPackingServices tb_OrderPackingServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_OrderPacking>> SaveOrUpdate(tb_OrderPacking entity)
        {
            ...
            try
            {
                ...
                if (entity.OrderPackaging_ID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_OrderPacking>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_OrderPacking>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_OrderPacking>(entitys);
            }
            return rs;
        }
        ...
        public tb_OrderPacking AddReEntity(tb_OrderPacking entity)
        {
            tb_OrderPacking AddEntity =  _tb_OrderPackingServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_OrderPacking>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_OrderPacking> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_OrderPacking>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_OrderPacking entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_OrderPacking>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_OrderPacking>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_OrderPacking>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_OrderPacking>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_OrderPacking>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_OrderPacking>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
