...
namespace RUINORERP.Business
{
    ...
    public partial class tb_Outsourcing_orderController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_Outsourcing_orderController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_Outsourcing_orderServices tb_Outsourcing_orderServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
