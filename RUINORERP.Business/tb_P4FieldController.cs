...
namespace RUINORERP.Business
{
    ...
    public partial class tb_P4FieldController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_P4FieldController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_P4FieldServices tb_P4FieldServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
