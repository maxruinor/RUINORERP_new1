...
namespace RUINORERP.Business
{
    ...
    public partial class tb_P4MenuController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_P4MenuController(ILogger<tb_P4MenuController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_P4MenuServices tb_P4MenuServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_P4Menu>> SaveOrUpdate(tb_P4Menu entity)
        {
            ...
            try
            {
                ...
                if (entity.P4Menu_ID > 0)
                {
                    ...
                    if (rs)
                    {
                        MyCacheManager.Instance.UpdateEntityList<tb_P4Menu>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                MyCacheManager.Instance.DeleteEntityList<tb_P4Menu>(entity);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            if (c>0)
            {
                rs=true;
                ////生成时暂时只考虑了一个主键的情况
                 long[] result = entitys.Select(e => e.P4Menu_ID).ToArray();
                MyCacheManager.Instance.DeleteEntityList<tb_P4Menu>(result);
            }
            return rs;
        }
        ...
        public async override Task<ReturnMainSubResults<T>> BaseSaveOrUpdateWithChild<C>(T model) where C : class
        {
            ...
            if (entity.P4Menu_ID > 0)
            {
                rs = await _unitOfWorkManage.GetDbClient().UpdateNav<tb_P4Menu>(entity as tb_P4Menu)
        ...
        {
            rs = await _unitOfWorkManage.GetDbClient().InsertNav<tb_P4Menu>(entity as tb_P4Menu)
                //这里一般是子表，或没有一对多外键的情况 ，用自动的只是为了语法正常一般不会调用这个方法
                .IncludesAllFirstLayer()//自动更新导航 只能两层。这里项目中有时会失效，具体看文档
                                .ExecuteCommandAsync();
        }
        ...
        public tb_P4Menu AddReEntity(tb_P4Menu entity)
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_P4Menu>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_P4Menu> infos)
        {
            ...
            {
                 MyCacheManager.Instance.UpdateEntityList<tb_P4Menu>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_P4Menu>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_P4Menu>(ids);
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_P4Menu>> QueryAsync()
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_P4Menu>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_P4Menu>().Where(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
