...
namespace RUINORERP.Business
{
    ...
    public partial class tb_P4MenuController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_P4MenuController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_P4MenuServices tb_P4MenuServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
