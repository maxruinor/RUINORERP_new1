...
namespace RUINORERP.Business
{
    ...
    public partial class tb_P4ModuleController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_P4ModuleController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_P4ModuleServices tb_P4ModuleServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
