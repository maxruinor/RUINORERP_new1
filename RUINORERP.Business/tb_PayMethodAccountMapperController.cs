...
namespace RUINORERP.Business
{
    ...
    public partial class tb_PayMethodAccountMapperController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_PayMethodAccountMapperController(ILogger<tb_PayMethodAccountMapperController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_PayMethodAccountMapperServices tb_PayMethodAccountMapperServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_PayMethodAccountMapper>> SaveOrUpdate(tb_PayMethodAccountMapper entity)
        {
            ...
            try
            {
                ...
                if (entity.PAMID > 0)
                {
                    ...
                    if (rs)
                    {
                        MyCacheManager.Instance.UpdateEntityList<tb_PayMethodAccountMapper>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                MyCacheManager.Instance.DeleteEntityList<tb_PayMethodAccountMapper>(entity);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            if (c>0)
            {
                rs=true;
                ////生成时暂时只考虑了一个主键的情况
                 long[] result = entitys.Select(e => e.PAMID).ToArray();
                MyCacheManager.Instance.DeleteEntityList<tb_PayMethodAccountMapper>(result);
            }
            return rs;
        }
        ...
        public tb_PayMethodAccountMapper AddReEntity(tb_PayMethodAccountMapper entity)
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_PayMethodAccountMapper>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_PayMethodAccountMapper> infos)
        {
            ...
            {
                 MyCacheManager.Instance.UpdateEntityList<tb_PayMethodAccountMapper>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_PayMethodAccountMapper>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_PayMethodAccountMapper>(ids);
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_PayMethodAccountMapper>> QueryAsync()
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_PayMethodAccountMapper>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_PayMethodAccountMapper>().Where(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
