...
namespace RUINORERP.Business
{
    ...
    public partial class tb_PaymentMethodDetailController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_PaymentMethodDetailController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_PaymentMethodDetailServices tb_PaymentMethodDetailServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
