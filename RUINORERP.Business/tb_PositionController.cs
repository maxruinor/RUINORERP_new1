...
namespace RUINORERP.Business
{
    ...
    public partial class tb_PositionController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_PositionController(ILogger<tb_PositionController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_PositionServices tb_PositionServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public ValidationResult Validator(tb_Position info)
        {
           ...
           tb_PositionValidator validator = _appContext.GetRequiredService<tb_PositionValidator>();
        ...
        public async Task<ReturnResults<tb_Position>> SaveOrUpdate(tb_Position entity)
        {
            ...
            try
            {
                ...
                if (entity.Position_Id > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_Position>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_Position>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_Position>(entitys);
            }
            return rs;
        }
        ...
        public tb_Position AddReEntity(tb_Position entity)
        {
            tb_Position AddEntity =  _tb_PositionServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_Position>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_Position> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_Position>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_Position entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_Position>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_Position>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_Position>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_Position>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_Position>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_Position>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
