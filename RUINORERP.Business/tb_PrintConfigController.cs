...
namespace RUINORERP.Business
{
    ...
    public partial class tb_PrintConfigController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_PrintConfigController(ILogger<tb_PrintConfigController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_PrintConfigServices tb_PrintConfigServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
