...
namespace RUINORERP.Business
{
    ...
    public partial class tb_PrintConfigController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_PrintConfigController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_PrintConfigServices tb_PrintConfigServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_PrintConfig>> SaveOrUpdate(tb_PrintConfig entity)
        {
            ...
            try
            {
                ...
                if (entity.PrintConfigID > 0)
                {
                    ...
                    if (rs)
                    {
                        MyCacheManager.Instance.UpdateEntityList<tb_PrintConfig>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                MyCacheManager.Instance.DeleteEntityList<tb_PrintConfig>(entity);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            if (c>0)
            {
                rs=true;
                ////生成时暂时只考虑了一个主键的情况
                 long[] result = entitys.Select(e => e.PrintConfigID).ToArray();
                MyCacheManager.Instance.DeleteEntityList<tb_PrintConfig>(result);
            }
            return rs;
        }
        ...
        public tb_PrintConfig AddReEntity(tb_PrintConfig entity)
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_PrintConfig>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_PrintConfig> infos)
        {
            ...
            {
                 MyCacheManager.Instance.UpdateEntityList<tb_PrintConfig>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_PrintConfig>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_PrintConfig>(ids);
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_PrintConfig>> QueryAsync()
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_PrintConfig>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_PrintConfig>().Where(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
