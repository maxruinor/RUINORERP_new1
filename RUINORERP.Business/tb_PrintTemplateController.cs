...
namespace RUINORERP.Business
{
    ...
    public partial class tb_PrintTemplateController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_PrintTemplateController(ILogger<tb_PrintTemplateController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_PrintTemplateServices tb_PrintTemplateServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
