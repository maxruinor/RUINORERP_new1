...
namespace RUINORERP.Business
{
    ...
    public partial class tb_PrintTemplateController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_PrintTemplateController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_PrintTemplateServices tb_PrintTemplateServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_PrintTemplate>> SaveOrUpdate(tb_PrintTemplate entity)
        {
            ...
            try
            {
                ...
                if (entity.ID > 0)
                {
                    ...
                    if (rs)
                    {
                        MyCacheManager.Instance.UpdateEntityList<tb_PrintTemplate>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                MyCacheManager.Instance.DeleteEntityList<tb_PrintTemplate>(entity);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            if (c>0)
            {
                ...
                MyCacheManager.Instance.DeleteEntityList<tb_PrintTemplate>(result);
            }
            return rs;
        }
        ...
        public async override Task<ReturnMainSubResults<T>> BaseSaveOrUpdateWithChild<C>(T model) where C : class
        {
            ...
            if (entity.ID > 0)
            {
                rs = await _unitOfWorkManage.GetDbClient().UpdateNav<tb_PrintTemplate>(entity as tb_PrintTemplate)
        ...
        {
            rs = await _unitOfWorkManage.GetDbClient().InsertNav<tb_PrintTemplate>(entity as tb_PrintTemplate)
        //这里一般是子表，或没有一对多外键的情况 ，用自动的只是为了语法正常一般不会调用这个方法
                .IncludesAllFirstLayer()//自动更新导航 只能两层。这里项目中有时会失效，具体看文档
                                .ExecuteCommandAsync();
        }
        ...
        public tb_PrintTemplate AddReEntity(tb_PrintTemplate entity)
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_PrintTemplate>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_PrintTemplate> infos)
        {
            ...
            {
                 MyCacheManager.Instance.UpdateEntityList<tb_PrintTemplate>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_PrintTemplate>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_PrintTemplate>(ids);
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_PrintTemplate>> QueryAsync()
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_PrintTemplate>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_PrintTemplate>().Where(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
