...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ProcessDefinitionController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_ProcessDefinitionController(ILogger<tb_ProcessDefinitionController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_ProcessDefinitionServices tb_ProcessDefinitionServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
