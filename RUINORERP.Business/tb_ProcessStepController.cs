...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ProcessStepController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_ProcessStepController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_ProcessStepServices tb_ProcessStepServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_ProcessStep>().Where(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
