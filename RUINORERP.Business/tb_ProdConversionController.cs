...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ProdConversionController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_ProdConversionController(ILogger<tb_ProdConversionController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_ProdConversionServices tb_ProdConversionServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_ProdConversion>> SaveOrUpdate(tb_ProdConversion entity)
        {
            ...
            try
            {
                ...
                if (entity.ConversionID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_ProdConversion>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_ProdConversion>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_ProdConversion>(entitys);
            }
            return rs;
        }
        ...
        public tb_ProdConversion AddReEntity(tb_ProdConversion entity)
        {
            tb_ProdConversion AddEntity =  _tb_ProdConversionServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_ProdConversion>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_ProdConversion> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_ProdConversion>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_ProdConversion entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_ProdConversion>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_ProdConversion>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_ProdConversion>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_ProdConversion>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_ProdConversion>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_ProdConversion>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
