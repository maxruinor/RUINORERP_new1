    ...
    public partial class tb_ProdDetailController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public ValidationResult Validator(tb_ProdDetail info)
        {
           ...
           tb_ProdDetailValidator validator = _appContext.GetRequiredService<tb_ProdDetailValidator>();
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_ProdDetail>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
