...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ProdMergeController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_ProdMergeController(ILogger<tb_ProdMergeController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_ProdMergeServices tb_ProdMergeServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_ProdMerge>> SaveOrUpdate(tb_ProdMerge entity)
        {
            ...
            try
            {
                ...
                if (entity.MergeID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_ProdMerge>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_ProdMerge>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_ProdMerge>(entitys);
            }
            return rs;
        }
        ...
        public tb_ProdMerge AddReEntity(tb_ProdMerge entity)
        {
            tb_ProdMerge AddEntity =  _tb_ProdMergeServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_ProdMerge>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_ProdMerge> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_ProdMerge>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_ProdMerge entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_ProdMerge>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_ProdMerge>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_ProdMerge>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_ProdMerge>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_ProdMerge>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_ProdMerge>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
