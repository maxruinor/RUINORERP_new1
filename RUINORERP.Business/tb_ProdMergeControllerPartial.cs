...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ProdMergeController<T> : BaseController<T> where T : class
    {
        ...
        /// <returns></returns>
        public async virtual Task<ReturnResults<bool>> AdjustingAsync(List<tb_ProdMerge> entitys, ApprovalEntity approvalEntity)
        {
                              ...
                              */
                                ...
                                if (rr.Succeeded)
                                {
                                    if (Opening)
                                    {
                                        ...
                                        oinv.InitInvDate = entity.MergeDate;
                                        oinv.RefBillID = entity.MergeID;
                                        oinv.RefNO = entity.MergeNo;
                                        oinv.Notes = entity.MergeNo + "由母件组合得到";//后面修改数据库是不需要？
                                        oinv.InitQty = 0;
        ...
        /// <returns></returns>
        public async virtual Task<ReturnResults<bool>> AntiApprovalAsync(List<tb_ProdMerge> entitys)
        {
            ReturnResults<bool> rs = new ReturnResults<bool>();
            try
            {
