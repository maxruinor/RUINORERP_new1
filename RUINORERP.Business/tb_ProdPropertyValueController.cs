...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ProdPropertyValueController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_ProdPropertyValueController(ILogger<tb_ProdPropertyValueController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_ProdPropertyValueServices tb_ProdPropertyValueServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        /// <returns></returns>
        public async Task<ReturnResults<tb_ProdPropertyValue>> SaveOrUpdate(tb_ProdPropertyValue entity)
        {
            ReturnResults<tb_ProdPropertyValue> rr = new ReturnResults<tb_ProdPropertyValue>();
            tb_ProdPropertyValue Returnobj;
            try
            {
                //生成时暂时只考虑了一个主键的情况
                if (entity.PropertyValueID > 0)
                {
                    ...
                    if (rs)
                    {
                        MyCacheManager.Instance.UpdateEntityList<tb_ProdPropertyValue>(entity);
                    }
                    Returnobj = entity;
                }
                else
                {
                    Returnobj = await _tb_ProdPropertyValueServices.AddReEntityAsync(entity);
                    MyCacheManager.Instance.UpdateEntityList<tb_ProdPropertyValue>(entity);
                }
        ...
        public async override Task<List<T>> BaseQueryAsync(string wheresql) 
        {
            ...
            {
                tb_ProdPropertyValue entity = item as tb_ProdPropertyValue;
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                MyCacheManager.Instance.DeleteEntityList<tb_ProdPropertyValue>(entity);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            if (c>0)
            {
                rs=true;
                ////生成时暂时只考虑了一个主键的情况
                 long[] result = entitys.Select(e => e.PropertyValueID).ToArray();
                MyCacheManager.Instance.DeleteEntityList<tb_ProdPropertyValue>(result);
            }
            return rs;
        }
        ...
        public tb_ProdPropertyValue AddReEntity(tb_ProdPropertyValue entity)
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_ProdPropertyValue>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_ProdPropertyValue> infos)
        {
            ...
            {
                 MyCacheManager.Instance.UpdateEntityList<tb_ProdPropertyValue>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_ProdPropertyValue>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_ProdPropertyValue>(ids);
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_ProdPropertyValue>> QueryAsync()
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_ProdPropertyValue>(list);
            return list;
        }
        ...
        /// <returns></returns>
        public async Task<List<tb_ProdPropertyValue>> QueryAsync(Expression<Func<tb_ProdPropertyValue, bool>> exp)
        {
            List<tb_ProdPropertyValue> list = await _unitOfWorkManage.GetDbClient().Queryable<tb_ProdPropertyValue>().Where(exp).ToListAsync();
            foreach (var item in list)
            {
                item.HasChanged = false;
            }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_ProdPropertyValue>().Where(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
