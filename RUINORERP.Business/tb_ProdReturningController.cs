...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ProdReturningController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_ProdReturningController(ILogger<tb_ProdReturningController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_ProdReturningServices tb_ProdReturningServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_ProdReturning>> SaveOrUpdate(tb_ProdReturning entity)
        {
            ...
            try
            {
                ...
                if (entity.ReturnID > 0)
                {
                    ...
                    if (rs)
                    {
                        MyCacheManager.Instance.UpdateEntityList<tb_ProdReturning>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                MyCacheManager.Instance.DeleteEntityList<tb_ProdReturning>(entity);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            if (c>0)
            {
                rs=true;
                ////生成时暂时只考虑了一个主键的情况
                 long[] result = entitys.Select(e => e.ReturnID).ToArray();
                MyCacheManager.Instance.DeleteEntityList<tb_ProdReturning>(result);
            }
            return rs;
        }
        ...
        public tb_ProdReturning AddReEntity(tb_ProdReturning entity)
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_ProdReturning>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_ProdReturning> infos)
        {
            ...
            {
                 MyCacheManager.Instance.UpdateEntityList<tb_ProdReturning>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_ProdReturning>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_ProdReturning>(ids);
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_ProdReturning>> QueryAsync()
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_ProdReturning>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_ProdReturning>().Where(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
