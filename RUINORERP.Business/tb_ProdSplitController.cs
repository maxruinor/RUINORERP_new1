...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ProdSplitController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_ProdSplitController(ILogger<tb_ProdSplitController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_ProdSplitServices tb_ProdSplitServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_ProdSplit>> SaveOrUpdate(tb_ProdSplit entity)
        {
            ...
            try
            {
                ...
                if (entity.SplitID > 0)
                {
                    ...
                    if (rs)
                    {
                        MyCacheManager.Instance.UpdateEntityList<tb_ProdSplit>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                MyCacheManager.Instance.DeleteEntityList<tb_ProdSplit>(entity);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            if (c>0)
            {
                rs=true;
                ////生成时暂时只考虑了一个主键的情况
                 long[] result = entitys.Select(e => e.SplitID).ToArray();
                MyCacheManager.Instance.DeleteEntityList<tb_ProdSplit>(result);
            }
            return rs;
        }
        ...
        public tb_ProdSplit AddReEntity(tb_ProdSplit entity)
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_ProdSplit>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_ProdSplit> infos)
        {
            ...
            {
                 MyCacheManager.Instance.UpdateEntityList<tb_ProdSplit>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_ProdSplit>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_ProdSplit>(ids);
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_ProdSplit>> QueryAsync()
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_ProdSplit>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_ProdSplit>().Where(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
