...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ProdSplitController<T> : BaseController<T> where T : class
    {
        ...
        /// <returns></returns>
        public async virtual Task<ReturnResults<bool>> AdjustingAsync(List<tb_ProdSplit> entitys, ApprovalEntity approvalEntity)
        {
        ...
        /// <returns></returns>
        public async virtual Task<ReturnResults<bool>> AntiApprovalAsync(List<tb_ProdSplit> entitys)
        {
            ReturnResults<bool> rs = new ReturnResults<bool>();
            try
            {
