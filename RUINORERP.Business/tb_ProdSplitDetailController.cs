...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ProdSplitDetailController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_ProdSplitDetailController(ILogger<tb_ProdSplitDetailController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_ProdSplitDetailServices tb_ProdSplitDetailServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_ProdSplitDetail>> SaveOrUpdate(tb_ProdSplitDetail entity)
        {
            ...
            try
            {
                ...
                if (entity.SplitSub_ID > 0)
                {
                    ...
                    if (rs)
                    {
                        MyCacheManager.Instance.UpdateEntityList<tb_ProdSplitDetail>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                MyCacheManager.Instance.DeleteEntityList<tb_ProdSplitDetail>(entity);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            if (c>0)
            {
                rs=true;
                ////生成时暂时只考虑了一个主键的情况
                 long[] result = entitys.Select(e => e.SplitSub_ID).ToArray();
                MyCacheManager.Instance.DeleteEntityList<tb_ProdSplitDetail>(result);
            }
            return rs;
        }
        ...
        public async override Task<ReturnMainSubResults<T>> BaseSaveOrUpdateWithChild<C>(T model) where C : class
        {
            ...
            if (entity.SplitSub_ID > 0)
            {
                rs = await _unitOfWorkManage.GetDbClient().UpdateNav<tb_ProdSplitDetail>(entity as tb_ProdSplitDetail)
        ...
        {
            rs = await _unitOfWorkManage.GetDbClient().InsertNav<tb_ProdSplitDetail>(entity as tb_ProdSplitDetail)
                //这里一般是子表，或没有一对多外键的情况 ，用自动的只是为了语法正常一般不会调用这个方法
                .IncludesAllFirstLayer()//自动更新导航 只能两层。这里项目中有时会失效，具体看文档
                                .ExecuteCommandAsync();
        }
        ...
        public tb_ProdSplitDetail AddReEntity(tb_ProdSplitDetail entity)
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_ProdSplitDetail>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_ProdSplitDetail> infos)
        {
            ...
            {
                 MyCacheManager.Instance.UpdateEntityList<tb_ProdSplitDetail>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_ProdSplitDetail>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_ProdSplitDetail>(ids);
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_ProdSplitDetail>> QueryAsync()
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_ProdSplitDetail>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_ProdSplitDetail>().Where(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
