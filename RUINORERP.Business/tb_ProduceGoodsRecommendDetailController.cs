...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ProduceGoodsRecommendDetailController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_ProduceGoodsRecommendDetailController(ILogger<tb_ProduceGoodsRecommendDetailController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_ProduceGoodsRecommendDetailServices tb_ProduceGoodsRecommendDetailServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public ValidationResult Validator(tb_ProduceGoodsRecommendDetail info)
        {
           ...
           tb_ProduceGoodsRecommendDetailValidator validator = _appContext.GetRequiredService<tb_ProduceGoodsRecommendDetailValidator>();
        ...
        public async Task<ReturnResults<tb_ProduceGoodsRecommendDetail>> SaveOrUpdate(tb_ProduceGoodsRecommendDetail entity)
        {
            ...
            try
            {
                ...
                if (entity.PDCID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_ProduceGoodsRecommendDetail>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_ProduceGoodsRecommendDetail>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_ProduceGoodsRecommendDetail>(entitys);
            }
            return rs;
        }
        ...
        public tb_ProduceGoodsRecommendDetail AddReEntity(tb_ProduceGoodsRecommendDetail entity)
        {
            tb_ProduceGoodsRecommendDetail AddEntity =  _tb_ProduceGoodsRecommendDetailServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_ProduceGoodsRecommendDetail>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_ProduceGoodsRecommendDetail> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_ProduceGoodsRecommendDetail>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_ProduceGoodsRecommendDetail entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_ProduceGoodsRecommendDetail>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_ProduceGoodsRecommendDetail>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_ProduceGoodsRecommendDetail>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_ProduceGoodsRecommendDetail>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_ProduceGoodsRecommendDetail>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_ProduceGoodsRecommendDetail>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
