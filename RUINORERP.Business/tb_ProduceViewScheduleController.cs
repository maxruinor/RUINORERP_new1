...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ProduceViewScheduleController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_ProduceViewScheduleController(ILogger<tb_ProduceViewScheduleController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_ProduceViewScheduleServices tb_ProduceViewScheduleServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_ProduceViewSchedule>> SaveOrUpdate(tb_ProduceViewSchedule entity)
        {
            ...
            try
            {
                ...
                if (entity.id > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_ProduceViewSchedule>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_ProduceViewSchedule>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_ProduceViewSchedule>(entitys);
            }
            return rs;
        }
        ...
        public tb_ProduceViewSchedule AddReEntity(tb_ProduceViewSchedule entity)
        {
            tb_ProduceViewSchedule AddEntity =  _tb_ProduceViewScheduleServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_ProduceViewSchedule>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_ProduceViewSchedule> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_ProduceViewSchedule>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_ProduceViewSchedule entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_ProduceViewSchedule>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_ProduceViewSchedule>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_ProduceViewSchedule>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_ProduceViewSchedule>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_ProduceViewSchedule>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_ProduceViewSchedule>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
