...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ProductionPlanController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_ProductionPlanController(ILogger<tb_ProductionPlanController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_ProductionPlanServices tb_ProductionPlanServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_ProductionPlan>> SaveOrUpdate(tb_ProductionPlan entity)
        {
            ...
            try
            {
                ...
                if (entity.PPID > 0)
                {
                    ...
                    if (rs)
                    {
                        MyCacheManager.Instance.UpdateEntityList<tb_ProductionPlan>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                MyCacheManager.Instance.DeleteEntityList<tb_ProductionPlan>(entity);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            if (c>0)
            {
                rs=true;
                ////生成时暂时只考虑了一个主键的情况
                 long[] result = entitys.Select(e => e.PPID).ToArray();
                MyCacheManager.Instance.DeleteEntityList<tb_ProductionPlan>(result);
            }
            return rs;
        }
        ...
        public tb_ProductionPlan AddReEntity(tb_ProductionPlan entity)
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_ProductionPlan>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_ProductionPlan> infos)
        {
            ...
            {
                 MyCacheManager.Instance.UpdateEntityList<tb_ProductionPlan>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_ProductionPlan>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_ProductionPlan>(ids);
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_ProductionPlan>> QueryAsync()
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_ProductionPlan>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_ProductionPlan>().Where(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
