...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ProjectGroupAccountMapperController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_ProjectGroupAccountMapperController(ILogger<tb_ProjectGroupAccountMapperController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_ProjectGroupAccountMapperServices tb_ProjectGroupAccountMapperServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_ProjectGroupAccountMapper>> SaveOrUpdate(tb_ProjectGroupAccountMapper entity)
        {
            ...
            try
            {
                ...
                if (entity.PGAMID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_ProjectGroupAccountMapper>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_ProjectGroupAccountMapper>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_ProjectGroupAccountMapper>(entitys);
            }
            return rs;
        }
        ...
        public tb_ProjectGroupAccountMapper AddReEntity(tb_ProjectGroupAccountMapper entity)
        {
            tb_ProjectGroupAccountMapper AddEntity =  _tb_ProjectGroupAccountMapperServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_ProjectGroupAccountMapper>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_ProjectGroupAccountMapper> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_ProjectGroupAccountMapper>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_ProjectGroupAccountMapper entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_ProjectGroupAccountMapper>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_ProjectGroupAccountMapper>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_ProjectGroupAccountMapper>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_ProjectGroupAccountMapper>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_ProjectGroupAccountMapper>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_ProjectGroupAccountMapper>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
