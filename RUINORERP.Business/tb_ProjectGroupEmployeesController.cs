...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ProjectGroupEmployeesController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_ProjectGroupEmployeesController(ILogger<tb_ProjectGroupEmployeesController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_ProjectGroupEmployeesServices tb_ProjectGroupEmployeesServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_ProjectGroupEmployees>> SaveOrUpdate(tb_ProjectGroupEmployees entity)
        {
            ...
            try
            {
                ...
                if (entity.ProjectGroupEmpID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_ProjectGroupEmployees>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_ProjectGroupEmployees>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_ProjectGroupEmployees>(entitys);
            }
            return rs;
        }
        ...
        public tb_ProjectGroupEmployees AddReEntity(tb_ProjectGroupEmployees entity)
        {
            tb_ProjectGroupEmployees AddEntity =  _tb_ProjectGroupEmployeesServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_ProjectGroupEmployees>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_ProjectGroupEmployees> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_ProjectGroupEmployees>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_ProjectGroupEmployees entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_ProjectGroupEmployees>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_ProjectGroupEmployees>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_ProjectGroupEmployees>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_ProjectGroupEmployees>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_ProjectGroupEmployees>(list);
            return list;
        }
