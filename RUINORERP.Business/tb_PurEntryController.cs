...
namespace RUINORERP.Business
{
    ...
    public partial class tb_PurEntryController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_PurEntryController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_PurEntryServices tb_PurEntryServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
