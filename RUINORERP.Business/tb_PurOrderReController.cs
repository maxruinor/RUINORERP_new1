...
namespace RUINORERP.Business
{
    ...
    public partial class tb_PurOrderReController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_PurOrderReController(ILogger<tb_PurOrderReController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_PurOrderReServices tb_PurOrderReServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public ValidationResult Validator(tb_PurOrderRe info)
        {
           ...
           tb_PurOrderReValidator validator = _appContext.GetRequiredService<tb_PurOrderReValidator>();
        ...
        public async Task<ReturnResults<tb_PurOrderRe>> SaveOrUpdate(tb_PurOrderRe entity)
        {
            ...
            try
            {
                ...
                if (entity.PurRetrunID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_PurOrderRe>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_PurOrderRe>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_PurOrderRe>(entitys);
            }
            return rs;
        }
        ...
        public tb_PurOrderRe AddReEntity(tb_PurOrderRe entity)
        {
            tb_PurOrderRe AddEntity =  _tb_PurOrderReServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_PurOrderRe>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_PurOrderRe> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_PurOrderRe>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_PurOrderRe entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_PurOrderRe>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_PurOrderRe>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_PurOrderRe>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_PurOrderRe>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_PurOrderRe>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_PurOrderRe>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
