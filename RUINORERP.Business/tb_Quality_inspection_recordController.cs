...
namespace RUINORERP.Business
{
    ...
    public partial class tb_Quality_inspection_recordController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_Quality_inspection_recordController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_Quality_inspection_recordServices tb_Quality_inspection_recordServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
