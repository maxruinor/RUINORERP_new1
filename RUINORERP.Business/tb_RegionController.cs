...
namespace RUINORERP.Business
{
    ...
    public partial class tb_RegionController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_RegionController(ILogger<tb_RegionController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_RegionServices tb_RegionServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
