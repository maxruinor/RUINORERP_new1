       ...
       // private readonly ApplicationContext _appContext;
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            if (c>0)
            {
                ...
                _cacheManager.DeleteEntityList<tb_ReminderAlert>(entitys);
            }
            return rs;
        }
        ...
        public tb_ReminderAlert AddReEntity(tb_ReminderAlert entity)
        {
            ...
            _cacheManager.UpdateEntity<tb_ReminderAlert>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_ReminderAlert> infos)
        {
            ...
            {
                 _cacheManager.UpdateEntityList<tb_ReminderAlert>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_ReminderAlert entity)
        {
            ...
            if (rs)
            {
                _cacheManager.DeleteEntity<tb_ReminderAlert>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
                _cacheManager.DeleteEntity<tb_ReminderAlert>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                _cacheManager.DeleteEntity<tb_ReminderAlert>(ids);
            }
            return rs;
        }
