...
namespace RUINORERP.Business
{
    ...
    public partial class tb_ReturnDetailController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_ReturnDetailController(ILogger<tb_ReturnDetailController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_ReturnDetailServices tb_ReturnDetailServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public ValidationResult Validator(tb_ReturnDetail info)
        {
           ...
           tb_ReturnDetailValidator validator = _appContext.GetRequiredService<tb_ReturnDetailValidator>();
        ...
        public async override Task<ReturnMainSubResults<T>> BaseSaveOrUpdateWithChild<C>(T model) where C : class
        {
            ...
            if (entity.ReDetail_ID > 0)
            {
                                 ...
                                 var result= await _unitOfWorkManage.GetDbClient().Updateable<tb_ReturnDetail>(entity as tb_ReturnDetail)
                    .ExecuteCommandAsync();
                    if (result > 0)
                    {
                        rs = true;
        ...
        {
                                  var result= await _unitOfWorkManage.GetDbClient().Insertable<tb_ReturnDetail>(entity as tb_ReturnDetail)
                    .ExecuteCommandAsync();
                    if (result > 0)
                    {
                        rs = true;
