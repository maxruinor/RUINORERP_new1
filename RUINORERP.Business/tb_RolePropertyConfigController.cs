...
namespace RUINORERP.Business
{
    ...
    public partial class tb_RolePropertyConfigController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_RolePropertyConfigController(ILogger<tb_RolePropertyConfigController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_RolePropertyConfigServices tb_RolePropertyConfigServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public ValidationResult Validator(tb_RolePropertyConfig info)
        {
           ...
           tb_RolePropertyConfigValidator validator = _appContext.GetRequiredService<tb_RolePropertyConfigValidator>();
        ...
        public async Task<ReturnResults<tb_RolePropertyConfig>> SaveOrUpdate(tb_RolePropertyConfig entity)
        {
            ...
            try
            {
                ...
                if (entity.RolePropertyID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_RolePropertyConfig>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_RolePropertyConfig>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_RolePropertyConfig>(entitys);
            }
            return rs;
        }
        ...
        public tb_RolePropertyConfig AddReEntity(tb_RolePropertyConfig entity)
        {
            tb_RolePropertyConfig AddEntity =  _tb_RolePropertyConfigServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_RolePropertyConfig>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_RolePropertyConfig> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_RolePropertyConfig>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_RolePropertyConfig entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_RolePropertyConfig>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_RolePropertyConfig>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_RolePropertyConfig>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_RolePropertyConfig>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_RolePropertyConfig>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_RolePropertyConfig>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
