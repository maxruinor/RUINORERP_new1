...
namespace RUINORERP.Business
{
    ...
    public partial class tb_SalaryController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_SalaryController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_SalaryServices tb_SalaryServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
