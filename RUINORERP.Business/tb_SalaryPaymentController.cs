...
namespace RUINORERP.Business
{
    ...
    public partial class tb_SalaryPaymentController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_SalaryPaymentController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_SalaryPaymentServices tb_SalaryPaymentServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
