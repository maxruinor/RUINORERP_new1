...
namespace RUINORERP.Business
{
    ...
    public partial class tb_SaleOutReRefurbishedMaterialsDetailController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_SaleOutReRefurbishedMaterialsDetailController(ILogger<tb_SaleOutReRefurbishedMaterialsDetailController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_SaleOutReRefurbishedMaterialsDetailServices tb_SaleOutReRefurbishedMaterialsDetailServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public ValidationResult Validator(tb_SaleOutReRefurbishedMaterialsDetail info)
        {
           ...
           tb_SaleOutReRefurbishedMaterialsDetailValidator validator = _appContext.GetRequiredService<tb_SaleOutReRefurbishedMaterialsDetailValidator>();
        ...
        public async Task<ReturnResults<tb_SaleOutReRefurbishedMaterialsDetail>> SaveOrUpdate(tb_SaleOutReRefurbishedMaterialsDetail entity)
        {
            ...
            try
            {
                ...
                if (entity.SOutReturnDetail_ID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_SaleOutReRefurbishedMaterialsDetail>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_SaleOutReRefurbishedMaterialsDetail>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_SaleOutReRefurbishedMaterialsDetail>(entitys);
            }
            return rs;
        }
        ...
        public async override Task<ReturnMainSubResults<T>> BaseSaveOrUpdateWithChild<C>(T model) where C : class
        {
            ...
            if (entity.SOutReturnDetail_ID > 0)
            {
                                 ...
                                 var result= await _unitOfWorkManage.GetDbClient().Updateable<tb_SaleOutReRefurbishedMaterialsDetail>(entity as tb_SaleOutReRefurbishedMaterialsDetail)
                    .ExecuteCommandAsync();
                    if (result > 0)
                    {
                        rs = true;
        ...
        {
                                  var result= await _unitOfWorkManage.GetDbClient().Insertable<tb_SaleOutReRefurbishedMaterialsDetail>(entity as tb_SaleOutReRefurbishedMaterialsDetail)
        ...
        public tb_SaleOutReRefurbishedMaterialsDetail AddReEntity(tb_SaleOutReRefurbishedMaterialsDetail entity)
        {
            tb_SaleOutReRefurbishedMaterialsDetail AddEntity =  _tb_SaleOutReRefurbishedMaterialsDetailServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_SaleOutReRefurbishedMaterialsDetail>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_SaleOutReRefurbishedMaterialsDetail> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_SaleOutReRefurbishedMaterialsDetail>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_SaleOutReRefurbishedMaterialsDetail entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_SaleOutReRefurbishedMaterialsDetail>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_SaleOutReRefurbishedMaterialsDetail>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_SaleOutReRefurbishedMaterialsDetail>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_SaleOutReRefurbishedMaterialsDetail>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_SaleOutReRefurbishedMaterialsDetail>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_SaleOutReRefurbishedMaterialsDetail>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
