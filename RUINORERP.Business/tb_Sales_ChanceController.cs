...
namespace RUINORERP.Business
{
    ...
    public partial class tb_Sales_ChanceController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_Sales_ChanceController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_Sales_ChanceServices tb_Sales_ChanceServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
