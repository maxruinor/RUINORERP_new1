...
namespace RUINORERP.Business
{
    ...
    public partial class tb_StepBodyController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_StepBodyController(ILogger<tb_StepBodyController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_StepBodyServices tb_StepBodyServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_StepBody>> SaveOrUpdate(tb_StepBody entity)
        {
            ...
            try
            {
                ...
                if (entity.StepBodyld > 0)
                {
                    ...
                    if (rs)
                    {
                        MyCacheManager.Instance.UpdateEntityList<tb_StepBody>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                MyCacheManager.Instance.DeleteEntityList<tb_StepBody>(entity);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            if (c>0)
            {
                rs=true;
                ////生成时暂时只考虑了一个主键的情况
                 long[] result = entitys.Select(e => e.StepBodyld).ToArray();
                MyCacheManager.Instance.DeleteEntityList<tb_StepBody>(result);
            }
            return rs;
        }
        ...
        public tb_StepBody AddReEntity(tb_StepBody entity)
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_StepBody>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_StepBody> infos)
        {
            ...
            {
                 MyCacheManager.Instance.UpdateEntityList<tb_StepBody>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_StepBody>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_StepBody>(ids);
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_StepBody>> QueryAsync()
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_StepBody>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_StepBody>().Where(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
