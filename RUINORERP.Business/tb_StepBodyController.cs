...
namespace RUINORERP.Business
{
    ...
    public partial class tb_StepBodyController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_StepBodyController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_StepBodyServices tb_StepBodyServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
