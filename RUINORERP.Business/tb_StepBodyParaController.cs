...
namespace RUINORERP.Business
{
    ...
    public partial class tb_StepBodyParaController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_StepBodyParaController(ILogger<tb_StepBodyParaController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_StepBodyParaServices tb_StepBodyParaServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_StepBodyPara>> SaveOrUpdate(tb_StepBodyPara entity)
        {
            ...
            try
            {
                ...
                if (entity.Para_Id > 0)
                {
                    ...
                    if (rs)
                    {
                        MyCacheManager.Instance.UpdateEntityList<tb_StepBodyPara>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                MyCacheManager.Instance.DeleteEntityList<tb_StepBodyPara>(entity);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            if (c>0)
            {
                rs=true;
                ////生成时暂时只考虑了一个主键的情况
                 long[] result = entitys.Select(e => e.Para_Id).ToArray();
                MyCacheManager.Instance.DeleteEntityList<tb_StepBodyPara>(result);
            }
            return rs;
        }
        ...
        public tb_StepBodyPara AddReEntity(tb_StepBodyPara entity)
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_StepBodyPara>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_StepBodyPara> infos)
        {
            ...
            {
                 MyCacheManager.Instance.UpdateEntityList<tb_StepBodyPara>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_StepBodyPara>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_StepBodyPara>(ids);
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_StepBodyPara>> QueryAsync()
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_StepBodyPara>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_StepBodyPara>().Where(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
