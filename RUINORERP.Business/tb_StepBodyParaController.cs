...
namespace RUINORERP.Business
{
    ...
    public partial class tb_StepBodyParaController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_StepBodyParaController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_StepBodyParaServices tb_StepBodyParaServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
