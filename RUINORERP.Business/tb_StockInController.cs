...
namespace RUINORERP.Business
{
    ...
    public partial class tb_StockInController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_StockInController(ILogger<tb_StockInController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_StockInServices tb_StockInServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_StockIn>> SaveOrUpdate(tb_StockIn entity)
        {
            ...
            try
            {
                ...
                if (entity.MainID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_StockIn>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_StockIn>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_StockIn>(entitys);
            }
            return rs;
        }
        ...
        public tb_StockIn AddReEntity(tb_StockIn entity)
        {
            tb_StockIn AddEntity =  _tb_StockInServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_StockIn>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_StockIn> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_StockIn>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_StockIn entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_StockIn>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_StockIn>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_StockIn>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_StockIn>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_StockIn>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_StockIn>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
