...
namespace RUINORERP.Business
{
    ...
    public partial class tb_StockOutController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_StockOutController(ILogger<tb_StockOutController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_StockOutServices tb_StockOutServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_StockOut>> SaveOrUpdate(tb_StockOut entity)
        {
            ...
            try
            {
                ...
                if (entity.MainID > 0)
                {
                    ...
                    if (rs)
                    {
                        MyCacheManager.Instance.UpdateEntityList<tb_StockOut>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                MyCacheManager.Instance.DeleteEntityList<tb_StockOut>(entity);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            if (c>0)
            {
                ...
                MyCacheManager.Instance.DeleteEntityList<tb_StockOut>(result);
            }
            return rs;
        }
        ...
        public tb_StockOut AddReEntity(tb_StockOut entity)
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_StockOut>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_StockOut> infos)
        {
            ...
            {
                 MyCacheManager.Instance.UpdateEntityList<tb_StockOut>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_StockOut>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_StockOut>(ids);
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_StockOut>> QueryAsync()
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_StockOut>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_StockOut>().Where(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
