...
namespace RUINORERP.Business
{
    ...
    public partial class tb_StocktakeDetailController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_StocktakeDetailController(ILogger<tb_StocktakeDetailController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_StocktakeDetailServices tb_StocktakeDetailServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public ValidationResult Validator(tb_StocktakeDetail info)
        {
           ...
           tb_StocktakeDetailValidator validator = _appContext.GetRequiredService<tb_StocktakeDetailValidator>();
        ...
        public async Task<ReturnResults<tb_StocktakeDetail>> SaveOrUpdate(tb_StocktakeDetail entity)
        {
            ...
            try
            {
                ...
                if (entity.SubID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_StocktakeDetail>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_StocktakeDetail>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_StocktakeDetail>(entitys);
            }
            return rs;
        }
        ...
        public async override Task<ReturnMainSubResults<T>> BaseSaveOrUpdateWithChild<C>(T model) where C : class
        {
            ...
            if (entity.SubID > 0)
            {
                                 ...
                                 var result= await _unitOfWorkManage.GetDbClient().Updateable<tb_StocktakeDetail>(entity as tb_StocktakeDetail)
                    .ExecuteCommandAsync();
                    if (result > 0)
                    {
                        rs = true;
        ...
        {
                                  var result= await _unitOfWorkManage.GetDbClient().Insertable<tb_StocktakeDetail>(entity as tb_StocktakeDetail)
        ...
        public tb_StocktakeDetail AddReEntity(tb_StocktakeDetail entity)
        {
            tb_StocktakeDetail AddEntity =  _tb_StocktakeDetailServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_StocktakeDetail>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_StocktakeDetail> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_StocktakeDetail>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_StocktakeDetail entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_StocktakeDetail>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_StocktakeDetail>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_StocktakeDetail>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_StocktakeDetail>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
