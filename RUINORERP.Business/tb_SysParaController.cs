...
namespace RUINORERP.Business
{
    ...
    public partial class tb_SysParaController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_SysParaController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_SysParaServices tb_SysParaServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
