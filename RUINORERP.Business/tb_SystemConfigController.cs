...
namespace RUINORERP.Business
{
    ...
    public partial class tb_SystemConfigController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_SystemConfigController(ILogger<tb_SystemConfigController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_SystemConfigServices tb_SystemConfigServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_SystemConfig>> SaveOrUpdate(tb_SystemConfig entity)
        {
            ...
            try
            {
                ...
                if (entity.ID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_SystemConfig>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_SystemConfig>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_SystemConfig>(entitys);
            }
            return rs;
        }
        ...
        public tb_SystemConfig AddReEntity(tb_SystemConfig entity)
        {
            tb_SystemConfig AddEntity =  _tb_SystemConfigServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_SystemConfig>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_SystemConfig> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_SystemConfig>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_SystemConfig entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_SystemConfig>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_SystemConfig>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_SystemConfig>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_SystemConfig>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_SystemConfig>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_SystemConfig>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
