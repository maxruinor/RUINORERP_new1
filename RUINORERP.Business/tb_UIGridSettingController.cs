...
namespace RUINORERP.Business
{
    ...
    public partial class tb_UIGridSettingController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_UIGridSettingController(ILogger<tb_UIGridSettingController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_UIGridSettingServices tb_UIGridSettingServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_UIGridSetting>> SaveOrUpdate(tb_UIGridSetting entity)
        {
            ...
            try
            {
                ...
                if (entity.UIGID > 0)
                {
                    ...
                    if (rs)
                    {
                        MyCacheManager.Instance.UpdateEntityList<tb_UIGridSetting>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                MyCacheManager.Instance.DeleteEntityList<tb_UIGridSetting>(entity);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            if (c>0)
            {
                rs=true;
                ////生成时暂时只考虑了一个主键的情况
                 long[] result = entitys.Select(e => e.UIGID).ToArray();
                MyCacheManager.Instance.DeleteEntityList<tb_UIGridSetting>(result);
            }
            return rs;
        }
        ...
        public tb_UIGridSetting AddReEntity(tb_UIGridSetting entity)
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_UIGridSetting>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_UIGridSetting> infos)
        {
            ...
            {
                 MyCacheManager.Instance.UpdateEntityList<tb_UIGridSetting>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_UIGridSetting>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_UIGridSetting>(ids);
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_UIGridSetting>> QueryAsync()
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_UIGridSetting>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_UIGridSetting>().Where(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
