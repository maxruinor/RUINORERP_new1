...
namespace RUINORERP.Business
{
    ...
    public partial class tb_UIInputDataFieldController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_UIInputDataFieldController(ILogger<tb_UIInputDataFieldController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_UIInputDataFieldServices tb_UIInputDataFieldServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_UIInputDataField>> SaveOrUpdate(tb_UIInputDataField entity)
        {
            ...
            try
            {
                ...
                if (entity.PresetValueID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_UIInputDataField>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_UIInputDataField>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_UIInputDataField>(entitys);
            }
            return rs;
        }
        ...
        public tb_UIInputDataField AddReEntity(tb_UIInputDataField entity)
        {
            tb_UIInputDataField AddEntity =  _tb_UIInputDataFieldServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_UIInputDataField>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_UIInputDataField> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_UIInputDataField>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_UIInputDataField entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_UIInputDataField>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_UIInputDataField>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_UIInputDataField>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_UIInputDataField>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_UIInputDataField>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_UIInputDataField>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
