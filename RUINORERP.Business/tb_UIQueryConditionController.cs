...
namespace RUINORERP.Business
{
    ...
    public partial class tb_UIQueryConditionController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_UIQueryConditionController(ILogger<tb_UIQueryConditionController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_UIQueryConditionServices tb_UIQueryConditionServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public ValidationResult Validator(tb_UIQueryCondition info)
        {
           ...
           tb_UIQueryConditionValidator validator = _appContext.GetRequiredService<tb_UIQueryConditionValidator>();
        ...
        public async Task<ReturnResults<tb_UIQueryCondition>> SaveOrUpdate(tb_UIQueryCondition entity)
        {
            ...
            try
            {
                ...
                if (entity.UIQCID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_UIQueryCondition>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_UIQueryCondition>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_UIQueryCondition>(entitys);
            }
            return rs;
        }
        ...
        public async override Task<ReturnMainSubResults<T>> BaseSaveOrUpdateWithChild<C>(T model) where C : class
        {
            ...
            if (entity.UIQCID > 0)
            {
                                 ...
                                 var result= await _unitOfWorkManage.GetDbClient().Updateable<tb_UIQueryCondition>(entity as tb_UIQueryCondition)
                    .ExecuteCommandAsync();
                    if (result > 0)
                    {
                        rs = true;
        ...
        {
                                  var result= await _unitOfWorkManage.GetDbClient().Insertable<tb_UIQueryCondition>(entity as tb_UIQueryCondition)
        ...
        public tb_UIQueryCondition AddReEntity(tb_UIQueryCondition entity)
        {
            tb_UIQueryCondition AddEntity =  _tb_UIQueryConditionServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_UIQueryCondition>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_UIQueryCondition> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_UIQueryCondition>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_UIQueryCondition entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_UIQueryCondition>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_UIQueryCondition>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_UIQueryCondition>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_UIQueryCondition>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_UIQueryCondition>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_UIQueryCondition>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
