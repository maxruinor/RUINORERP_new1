...
namespace RUINORERP.Business
{
    ...
    public partial class tb_UnitController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_UnitController(ILogger<tb_UnitController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_UnitServices tb_UnitServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            if (c>0)
            {
                rs=true;
                ////生成时暂时只考虑了一个主键的情况
                 long[] result = entitys.Select(e => e.Unit_ID).ToArray();
                MyCacheManager.Instance.DeleteEntityList<tb_Unit>(result);
            }
            return rs;
        }
        ...
        public async override Task<ReturnMainSubResults<T>> BaseSaveOrUpdateWithChild<C>(T model) where C : class
        {
            ...
            if (entity.Unit_ID > 0)
            {
                rs = await _unitOfWorkManage.GetDbClient().UpdateNav<tb_Unit>(entity as tb_Unit)
                    ...
                    .Include(m => m.tb_Unit_ConversionsS)
                    .Include(m => m.tb_Unit_ConversionsT)
        ...
        public async override Task<List<T>> BaseQueryByAdvancedNavAsync(bool useLike, object dto)
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_Unit>()
                        ...
                        .Includes(m => m.tb_Unit_ConversionsS)
                        .Includes(m => m.tb_Unit_ConversionsT)
        ...
        public tb_Unit AddReEntity(tb_Unit entity)
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_Unit>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_Unit> infos)
        {
            ...
            {
                 MyCacheManager.Instance.UpdateEntityList<tb_Unit>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_Unit>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                MyCacheManager.Instance.DeleteEntityList<tb_Unit>(ids);
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_Unit>> QueryAsync()
        {
            ...
            MyCacheManager.Instance.UpdateEntityList<tb_Unit>(list);
            return list;
        }
         ...
         public virtual async Task<List<tb_Unit>> QueryByNavAsync()
        {
            List<tb_Unit> list = await _unitOfWorkManage.GetDbClient().Queryable<tb_Unit>()
                                ...
                                .Includes(t => t.tb_Unit_ConversionsS )
                                .Includes(t => t.tb_Unit_ConversionsT )
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_Unit>().Where(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
