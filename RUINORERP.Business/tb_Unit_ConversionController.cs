...
namespace RUINORERP.Business
{
    ...
    public partial class tb_Unit_ConversionController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_Unit_ConversionController(ILogger<tb_Unit_ConversionController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_Unit_ConversionServices tb_Unit_ConversionServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_Unit_Conversion>> SaveOrUpdate(tb_Unit_Conversion entity)
        {
            ...
            try
            {
                ...
                if (entity.UnitConversion_ID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_Unit_Conversion>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_Unit_Conversion>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_Unit_Conversion>(entitys);
            }
            return rs;
        }
        ...
        public async override Task<List<T>> BaseQueryByAdvancedNavAsync(bool useLike, object dto)
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_Unit_Conversion>()
                                .Includes(m => m.tb_unit)
                            .Includes(m => m.tb_unitBySourceUnit)
        ...
        public tb_Unit_Conversion AddReEntity(tb_Unit_Conversion entity)
        {
            tb_Unit_Conversion AddEntity =  _tb_Unit_ConversionServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_Unit_Conversion>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_Unit_Conversion> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_Unit_Conversion>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_Unit_Conversion entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_Unit_Conversion>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_Unit_Conversion>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_Unit_Conversion>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_Unit_Conversion>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_Unit_Conversion>(list);
            return list;
        }
         ...
         public virtual async Task<List<tb_Unit_Conversion>> QueryByNavAsync()
        {
            List<tb_Unit_Conversion> list = await _unitOfWorkManage.GetDbClient().Queryable<tb_Unit_Conversion>()
                               ...
                               .Includes(t => t.tb_unitBySourceUnit )
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_Unit_Conversion>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
