...
namespace RUINORERP.Business
{
    ...
    public partial class tb_UserPersonalizationController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_UserPersonalizationController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_UserPersonalizationServices tb_UserPersonalizationServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
