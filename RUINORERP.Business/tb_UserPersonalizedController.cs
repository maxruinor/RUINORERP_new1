...
namespace RUINORERP.Business
{
    ...
    public partial class tb_UserPersonalizedController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_UserPersonalizedController(ILogger<tb_UserPersonalizedController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_UserPersonalizedServices tb_UserPersonalizedServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_UserPersonalized>> SaveOrUpdate(tb_UserPersonalized entity)
        {
            ...
            try
            {
                ...
                if (entity.UserPersonalizedID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_UserPersonalized>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_UserPersonalized>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_UserPersonalized>(entitys);
            }
            return rs;
        }
        ...
        public tb_UserPersonalized AddReEntity(tb_UserPersonalized entity)
        {
            tb_UserPersonalized AddEntity =  _tb_UserPersonalizedServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_UserPersonalized>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_UserPersonalized> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_UserPersonalized>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_UserPersonalized entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_UserPersonalized>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_UserPersonalized>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_UserPersonalized>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_UserPersonalized>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_UserPersonalized>(list);
            return list;
        }
