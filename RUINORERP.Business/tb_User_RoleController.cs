...
namespace RUINORERP.Business
{
    ...
    public partial class tb_User_RoleController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_User_RoleController(ILogger<BaseController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_User_RoleServices tb_User_RoleServices , ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
