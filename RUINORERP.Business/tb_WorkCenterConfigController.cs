...
namespace RUINORERP.Business
{
    ...
    public partial class tb_WorkCenterConfigController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_WorkCenterConfigController(ILogger<tb_WorkCenterConfigController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_WorkCenterConfigServices tb_WorkCenterConfigServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_WorkCenterConfig>> SaveOrUpdate(tb_WorkCenterConfig entity)
        {
            ...
            try
            {
                ...
                if (entity.ConfigID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_WorkCenterConfig>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_WorkCenterConfig>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_WorkCenterConfig>(entitys);
            }
            return rs;
        }
        ...
        public tb_WorkCenterConfig AddReEntity(tb_WorkCenterConfig entity)
        {
            tb_WorkCenterConfig AddEntity =  _tb_WorkCenterConfigServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_WorkCenterConfig>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_WorkCenterConfig> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_WorkCenterConfig>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_WorkCenterConfig entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_WorkCenterConfig>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_WorkCenterConfig>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_WorkCenterConfig>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_WorkCenterConfig>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_WorkCenterConfig>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_WorkCenterConfig>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
