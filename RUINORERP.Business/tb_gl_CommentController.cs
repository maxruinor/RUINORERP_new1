...
namespace RUINORERP.Business
{
    ...
    public partial class tb_gl_CommentController<T>:BaseController<T> where T : class
    {
       ...
       // private readonly ApplicationContext _appContext;
        ...
        public tb_gl_CommentController(ILogger<tb_gl_CommentController<T>> logger, IUnitOfWorkManage unitOfWorkManage,tb_gl_CommentServices tb_gl_CommentServices ,EventDrivenCacheManager eventDrivenCacheManager, ApplicationContext appContext = null): base(logger, unitOfWorkManage, appContext)
        {
            _logger = logger;
        ...
        public async Task<ReturnResults<tb_gl_Comment>> SaveOrUpdate(tb_gl_Comment entity)
        {
            ...
            try
            {
                ...
                if (entity.CommentID > 0)
                {
                    ...
                    if (rs)
                    {
                        _eventDrivenCacheManager.UpdateEntity<tb_gl_Comment>(entity);
                    }
                    Returnobj = entity;
                }
                else
        ...
        public async override Task<bool> BaseDeleteAsync(T model)
        {
            ...
            {
                ////生成时暂时只考虑了一个主键的情况
                _eventDrivenCacheManager.DeleteEntity<tb_gl_Comment>(entity.PrimaryKeyID);
            }
            return rs;
        }
        ...
        public async override Task<bool> BaseDeleteAsync(List<T> models)
        {
            ...
            {
                rs=true;
                _eventDrivenCacheManager.DeleteEntityList<tb_gl_Comment>(entitys);
            }
            return rs;
        }
        ...
        public tb_gl_Comment AddReEntity(tb_gl_Comment entity)
        {
            tb_gl_Comment AddEntity =  _tb_gl_CommentServices.AddReEntity(entity);
             ...
             _eventDrivenCacheManager.UpdateEntity<tb_gl_Comment>(AddEntity);
            entity.ActionStatus = ActionStatus.无操作;
            return AddEntity;
        }
        ...
        public async Task<List<long>> AddAsync(List<tb_gl_Comment> infos)
        {
            ...
            {
                 _eventDrivenCacheManager.UpdateEntityList<tb_gl_Comment>(infos);
            }
            return ids;
        }
        ...
        public async Task<bool> DeleteAsync(tb_gl_Comment entity)
        {
            ...
            if (rs)
            {
                _eventDrivenCacheManager.DeleteEntity<tb_gl_Comment>(entity);
        ...
        public async Task<bool> DeleteAsync(long id)
        {
            ...
            if (rs)
            {
               _eventDrivenCacheManager.DeleteEntity<tb_gl_Comment>(id);
            }
            return rs;
        }
         ...
         public async Task<bool> DeleteAsync(long[] ids)
        {
            ...
            if (rs)
            {
                   ...
                   _eventDrivenCacheManager.DeleteEntities<tb_gl_Comment>(ids.Cast<object>().ToArray());
            }
            return rs;
        }
        ...
        public virtual async Task<List<tb_gl_Comment>> QueryAsync()
        {
            ...
            foreach (var item in list)
            {
             ...
             _eventDrivenCacheManager.UpdateEntityList<tb_gl_Comment>(list);
            return list;
        }
        ...
        {
            var querySqlQueryable = _unitOfWorkManage.GetDbClient().Queryable<tb_gl_Comment>().WhereCustom(useLike,dto);
            return await querySqlQueryable.ToListAsync();
        }
