...
namespace RUINORERP.Common.Extensions
{
    ...
    public static class NumericExtension
    {
        ...
        /// <returns></returns>
        public static string ToUpperAmount(this decimal money)
        {
            return ToUpperAmount((double)money);
        }
        ...
        /// <param name="money"></param>
        /// <returns></returns>
        public static string ToUpperAmount(this double money)
        {
            ...
            try
            {
                money100 = (long)(money * 100);
            }
            catch
            {
                throw new OverflowException("金额数值过大，无法转换为人民币大写格式");
            }
