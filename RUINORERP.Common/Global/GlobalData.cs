...
namespace RUINORERP.Common.Global
{
    ...
    public static class GlobalData
    {
        ...
        { "RUINORERP.Repository", "RUINORERP.Business", "RUINORERP.Services", "RUINORERP.IServices"  };

        static readonly List<string> EntityAssemblys = new List<string> { "RUINORERP.Model" };
