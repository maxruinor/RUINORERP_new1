...
namespace RUINORERP.Common.Logging
{
    ...
    {
        public System.Func<System.Type, bool>? FullNamePredict { get; set; }
    }
    ...
    internal sealed class GenericLogger<T> : ILogger<T>
    {
        ...
        public GenericLogger(ILoggerFactory factory, IOptions<GenericLoggerOptions> options)
        {
            ...
            _logger = factory.CreateLogger(RUINORERP.Common.Helper.TypeHelper.GetTypeDisplayName(typeof(T), includeGenericParameters: includeGenericParameters, nestedTypeDelimiter: '.'));
        }
