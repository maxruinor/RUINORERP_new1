...

{
    ...
    public static class LoggerExtensions
    {
        ...
        public static ILoggingBuilder UseCustomGenericLogger(this ILoggingBuilder loggingBuilder, Action<RUINORERP.Common.Logging.GenericLoggerOptions> genericLoggerConfig)
        {
