...
namespace RUINORERP.Extensions.NacosConfig
{
    /// <summary>
    /// Nacos配置文件变更事件
    /// </summary>
    public class NacosListenConfigurationTask : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            {
                // Add listener
                await _configClient.AddListener("RUINORERP.Api.json", "DEFAULT_GROUP", nacosConfigListener);
            }
            catch (Exception)
            {
            }
        ...
        {
            // Remove listener
            await _configClient.RemoveListener("RUINORERP.Api.json", "DEFAULT_GROUP", nacosConfigListener);
