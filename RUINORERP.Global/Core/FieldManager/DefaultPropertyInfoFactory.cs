...
namespace RUINORERP.Global.Core.FieldManager
{
  /// <summary>
  /// Creates PropertyInfo objects.
  /// </summary>
  internal class DefaultPropertyInfoFactory : RUINORERP.Global.Core.IPropertyInfoFactory
  {
    /// <summary>
    ...
    public RUINORERP.Global.PropertyInfo<T> Create<T>(Type containingType, string name)
    {
      return new RUINORERP.Global.PropertyInfo<T>(name, null, containingType, PropertyInfo<T>.DataBindingFriendlyDefault(), RelationshipTypes.None);
    }
    ...
    /// </param>
    public RUINORERP.Global.PropertyInfo<T> Create<T>(Type containingType, string name, string friendlyName)
    {
