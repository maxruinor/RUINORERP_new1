...
namespace RUINORERP.Model.ChartFramework.Models
{
    ...
    public class ChartData : INotifyPropertyChanged
    {
        ...
        public List<Dictionary<string, object>> RawData { get; set; } = new List<Dictionary<string, object>>();
