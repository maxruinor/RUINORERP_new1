...
namespace RUINORERP.Model.Context
{
    ...
    {
        private readonly AsyncLocal<ContextDictionary> _localContext = new AsyncLocal<ContextDictionary>();
       // private readonly AsyncLocal<ContextDictionary> _clientContext = new AsyncLocal<ContextDictionary>();
        private readonly AsyncLocal<IPrincipal> _principal = new AsyncLocal<IPrincipal>();
        ...
        private readonly AsyncLocal<ApplicationContext> _applicationContext = new AsyncLocal<ApplicationContext>();
