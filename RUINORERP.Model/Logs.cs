...
namespace RUINORERP.Model
{
    ...
    public partial class Logs : BaseEntity, ICloneable
    {
        ...
        [SugarColumn(ColumnDataType = "varchar", SqlParameterDbType = "String", ColumnName = "UserName", Length = 30, IsNullable = true, ColumnDescription = "用户名")]
        ...
        [SugarColumn(ColumnDataType = "varchar", SqlParameterDbType = "String", ColumnName = "Logger", Length = 500, IsNullable = true, ColumnDescription = "记录器")]
        ...
        [SugarColumn(ColumnDataType = "text", SqlParameterDbType = "String", ColumnName = "Message", Length = 2147483647, IsNullable = true, ColumnDescription = "消息")]
