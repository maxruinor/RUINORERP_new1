...
{
    /// <summary>
    /// 对存储过程提供参数的情况。手动创建的不能删除！
    /// </summary>
    public class Proc_SaleOutStatisticsByEmployeePara : BaseEntity, ICloneable
    {
        ...
        /// 出库日期起
        /// </summary>
        [AdvQueryAttribute(ColName = "Start", ColDesc = "出库日期起")]
        [SugarColumn(ColumnDataType = "datetime", SqlParameterDbType = "DateTime", ColumnName = "Start", IsNullable = false, ColumnDescription = "出库日期起")]
        ...
        /// 出库日期止
        /// </summary>
        [AdvQueryAttribute(ColName = "End", ColDesc = "出库日期止")]
        [SugarColumn(ColumnDataType = "datetime", SqlParameterDbType = "DateTime", ColumnName = "End", IsNullable = false, ColumnDescription = "出库日期止")]
        public DateTime End
        {
            get { return _End; }
            set
