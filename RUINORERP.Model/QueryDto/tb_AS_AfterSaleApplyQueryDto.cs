...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_AS_AfterSaleApplyQueryDto:BaseEntityDto
    {
        public tb_AS_AfterSaleApplyQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "CustomerVendor_ID",IsNullable = false,ColumnDescription = "申请客户" )]
        ...
        { 
            ...
            set{SetProperty(ref _CustomerSourceNo, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "Location_ID",IsNullable = false,ColumnDescription = "售后暂存仓" )]
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "ASProcessStatus",IsNullable = false,ColumnDescription = "处理状态" )]
        public int ASProcessStatus 
        { 
            get{return _ASProcessStatus;}
            set{SetProperty(ref _ASProcessStatus, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "TotalInitialQuantity",IsNullable = false,ColumnDescription = "登记数量" )]
        public int TotalInitialQuantity 
        { 
            get{return _TotalInitialQuantity;}
            set{SetProperty(ref _TotalInitialQuantity, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "TotalConfirmedQuantity",IsNullable = false,ColumnDescription = "复核数量" )]
        public int TotalConfirmedQuantity 
        { 
            get{return _TotalConfirmedQuantity;}
            set{SetProperty(ref _TotalConfirmedQuantity, value);}
        }
        ...
        { 
            ...
            set{SetProperty(ref _ApplyDate, value);}
        }
        ...
        { 
            ...
            set{SetProperty(ref _InWarrantyPeriod, value);}
        }
        ...
        { 
            ...
            set{SetProperty(ref _RepairEvaluationOpinion, value);}
        }
        ...
        { 
            ...
            set{SetProperty(ref _MaterialFeeConfirmed, value);}
        }
