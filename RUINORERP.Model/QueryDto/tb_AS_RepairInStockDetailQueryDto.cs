...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_AS_RepairInStockDetailQueryDto:BaseEntityDto
    {
        public tb_AS_RepairInStockDetailQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "RepairInStockID",IsNullable = true,ColumnDescription = "维修入库单" )]
        [FKRelationAttribute("tb_AS_RepairInStock","RepairInStockID")]
        public long? RepairInStockID 
        { 
            get{return _RepairInStockID;}
            set{SetProperty(ref _RepairInStockID, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "RepairOrderDetailID",IsNullable = true,ColumnDescription = "" )]
        public long? RepairOrderDetailID 
        { 
            get{return _RepairOrderDetailID;}
            set{SetProperty(ref _RepairOrderDetailID, value);}
        }
