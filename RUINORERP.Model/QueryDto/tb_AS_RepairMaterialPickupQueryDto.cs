...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_AS_RepairMaterialPickupQueryDto:BaseEntityDto
    {
        public tb_AS_RepairMaterialPickupQueryDto()
        {
        ...
        { 
            ...
            set{SetProperty(ref _MaterialPickupNO, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "TotalReQty",IsNullable = false,ColumnDescription = "总退回数" )]
        ...
        [SugarColumn(ColumnDataType = "decimal",SqlParameterDbType ="Decimal",ColumnName = "TotalSendQty",IsNullable = false,ColumnDescription = "总发数量" )]
