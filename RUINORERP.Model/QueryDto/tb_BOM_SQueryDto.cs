...
namespace RUINORERP.Model.QueryDto
{
    ...
    [Serializable()]
    [SugarTable("tb_BOM_S")]
    public partial class tb_BOM_SQueryDto:BaseEntityDto
    {
        public tb_BOM_SQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "ProdDetailID",IsNullable = false,ColumnDescription = "母件" )]
        ...
        { 
            get{return _Doc_ID;}
            set{SetProperty(ref _Doc_ID, value);}
        }
        ...
        { 
            ...
            set{SetProperty(ref _BOM_S_VERID, value);}
        }
        ...
        /// 自产制造费用
        /// </summary>
        [AdvQueryAttribute(ColName = "ManufacturingCost",ColDesc = "自产制造费用")]
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "ManufacturingCost",IsNullable = false,ColumnDescription = "自产制造费用" )]
        ...
        /// 外发费用
        /// </summary>
        [AdvQueryAttribute(ColName = "OutManuCost",ColDesc = "外发费用")]
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "OutManuCost",IsNullable = false,ColumnDescription = "外发费用" )]
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "TotalMaterialCost",IsNullable = false,ColumnDescription = "总物料费用" )]
        ...
        [SugarColumn(ColumnDataType = "decimal",SqlParameterDbType ="Decimal",ColumnName = "TotalMaterialQty",IsNullable = false,ColumnDescription = "用料总量" )]
        public decimal TotalMaterialQty 
        { 
            get{return _TotalMaterialQty;}
            set{SetProperty(ref _TotalMaterialQty, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "decimal",SqlParameterDbType ="Decimal",ColumnName = "OutputQty",IsNullable = false,ColumnDescription = "产出量" )]
        ...
        [SugarColumn(ColumnDataType = "decimal",SqlParameterDbType ="Decimal",ColumnName = "PeopleQty",IsNullable = false,ColumnDescription = "人数" )]
        public decimal PeopleQty 
        { 
            get{return _PeopleQty;}
            set{SetProperty(ref _PeopleQty, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "decimal",SqlParameterDbType ="Decimal",ColumnName = "WorkingHour",IsNullable = true,ColumnDescription = "工时" )]
        ...
        [SugarColumn(ColumnDataType = "decimal",SqlParameterDbType ="Decimal",ColumnName = "MachineHour",IsNullable = true,ColumnDescription = "机时" )]
        public decimal? MachineHour 
        { 
            get{return _MachineHour;}
            set{SetProperty(ref _MachineHour, value);}
        }
        ...
        { 
            ...
            set{SetProperty(ref _DailyQty, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "SelfProductionAllCosts",IsNullable = false,ColumnDescription = "自产总成本" )]
        public decimal SelfProductionAllCosts 
        { 
            get{return _SelfProductionAllCosts;}
            set{SetProperty(ref _SelfProductionAllCosts, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "OutProductionAllCosts",IsNullable = false,ColumnDescription = "外发总成本" )]
        public decimal OutProductionAllCosts 
        { 
            get{return _OutProductionAllCosts;}
            set{SetProperty(ref _OutProductionAllCosts, value);}
        }
        ...
        { 
            ...
            set{SetProperty(ref _BOM_Iimage, value);}
        }
