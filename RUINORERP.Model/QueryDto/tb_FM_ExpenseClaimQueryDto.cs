...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_FM_ExpenseClaimQueryDto:BaseEntityDto
    {
        public tb_FM_ExpenseClaimQueryDto()
        {
        ...
        { 
            get{return _ClaimNo;}
            set{SetProperty(ref _ClaimNo, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "ClaimlAmount",IsNullable = false,ColumnDescription = "报销金额" )]
        public decimal ClaimlAmount 
        { 
            get{return _ClaimlAmount;}
            set{SetProperty(ref _ClaimlAmount, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "ApprovedAmount",IsNullable = false,ColumnDescription = "核准金额" )]
