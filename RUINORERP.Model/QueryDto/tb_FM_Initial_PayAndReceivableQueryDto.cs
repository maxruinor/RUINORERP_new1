...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_FM_Initial_PayAndReceivableQueryDto:BaseEntityDto
    {
        public tb_FM_Initial_PayAndReceivableQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "ExpenseType_id",IsNullable = true,ColumnDescription = "业务类型" )]
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "CustomerVendor_ID",IsNullable = true,ColumnDescription = "外部交易对象" )]
