...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_FM_PayableDetailQueryDto:BaseEntityDto
    {
        public tb_FM_PayableDetailQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "PayableID",IsNullable = true,ColumnDescription = "应付款单" )]
        [FKRelationAttribute("tb_FM_Payable","PayableID")]
        public long? PayableID 
        { 
            get{return _PayableID;}
            set{SetProperty(ref _PayableID, value);}
        }
