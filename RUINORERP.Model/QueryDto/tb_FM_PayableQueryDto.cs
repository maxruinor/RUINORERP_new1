...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_FM_PayableQueryDto:BaseEntityDto
    {
        public tb_FM_PayableQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "PrePayID",IsNullable = true,ColumnDescription = "预付单" )]
