...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_FM_PaymentBillDetailQueryDto:BaseEntityDto
    {
        public tb_FM_PaymentBillDetailQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "PrePaymentBill_id",IsNullable = true,ColumnDescription = "业务类型" )]
        ...
        { 
            ...
            set{SetProperty(ref _GenerateVoucher, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "TotalAmount",IsNullable = true,ColumnDescription = "付款总金额" )]
        ...
        { 
            get{return _Notes2;}
            set{SetProperty(ref _Notes2, value);}
        }
