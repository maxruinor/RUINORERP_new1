...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_FM_PaymentReceiptDetailQueryDto:BaseEntityDto
    {
        public tb_FM_PaymentReceiptDetailQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "PaymentReceiptID",IsNullable = true,ColumnDescription = "收款单" )]
        [FKRelationAttribute("tb_FM_PaymentReceipt","PaymentReceiptID")]
        public long? PaymentReceiptID 
        { 
            get{return _PaymentReceiptID;}
            set{SetProperty(ref _PaymentReceiptID, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "Account_id",IsNullable = true,ColumnDescription = "收款账号" )]
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "SubAmount",IsNullable = true,ColumnDescription = "收款金额" )]
        ...
        { 
            ...
            set{SetProperty(ref _SubEvidenceImagePath, value);}
        }
