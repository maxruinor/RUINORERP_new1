...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_FM_PaymentReceiptQueryDto:BaseEntityDto
    {
        public tb_FM_PaymentReceiptQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "TotalAmount",IsNullable = true,ColumnDescription = "收款金额" )]
