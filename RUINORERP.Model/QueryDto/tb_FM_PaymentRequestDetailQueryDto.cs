...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_FM_PaymentRequestDetailQueryDto:BaseEntityDto
    {
        public tb_FM_PaymentRequestDetailQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "PaymentRequestID",IsNullable = true,ColumnDescription = "付款申请单" )]
        [FKRelationAttribute("tb_FM_PaymentRequest","PaymentRequestID")]
        public long? PaymentRequestID 
        { 
            get{return _PaymentRequestID;}
            set{SetProperty(ref _PaymentRequestID, value);}
        }
