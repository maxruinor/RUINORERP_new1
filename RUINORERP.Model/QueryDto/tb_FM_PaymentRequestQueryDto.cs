...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_FM_PaymentRequestQueryDto:BaseEntityDto
    {
        public tb_FM_PaymentRequestQueryDto()
        {
        ...
        { 
            ...
            set{SetProperty(ref _PaymentRequestNo, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "PayeeAccountType",IsNullable = false,ColumnDescription = "收款账号类型" )]
        public int PayeeAccountType 
        { 
            get{return _PayeeAccountType;}
            set{SetProperty(ref _PayeeAccountType, value);}
        }
