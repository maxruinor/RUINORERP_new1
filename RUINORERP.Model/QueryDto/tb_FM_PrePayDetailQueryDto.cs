...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_FM_PrePayDetailQueryDto:BaseEntityDto
    {
        public tb_FM_PrePayDetailQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "PrePayID",IsNullable = true,ColumnDescription = "预付款单" )]
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "PrePayAmount",IsNullable = false,ColumnDescription = "预付金额" )]
        public decimal PrePayAmount 
        { 
            get{return _PrePayAmount;}
            set{SetProperty(ref _PrePayAmount, value);}
        }
