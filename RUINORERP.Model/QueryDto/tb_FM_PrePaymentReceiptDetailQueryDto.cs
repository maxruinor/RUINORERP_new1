...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_FM_PrePaymentReceiptDetailQueryDto:BaseEntityDto
    {
        public tb_FM_PrePaymentReceiptDetailQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "PrePayAmount",IsNullable = true,ColumnDescription = "预收金额" )]
