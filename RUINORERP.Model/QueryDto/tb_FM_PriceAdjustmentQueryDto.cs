...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_FM_PriceAdjustmentQueryDto:BaseEntityDto
    {
        public tb_FM_PriceAdjustmentQueryDto()
        {
        ...
        { 
            ...
            set{SetProperty(ref _AdjustNo, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "TotalLocalDiffAmount",IsNullable = false,ColumnDescription = "总差异金额" )]
        public decimal TotalLocalDiffAmount 
        { 
            get{return _TotalLocalDiffAmount;}
            set{SetProperty(ref _TotalLocalDiffAmount, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "TaxTotalDiffLocalAmount",IsNullable = false,ColumnDescription = "总差异税额" )]
        public decimal TaxTotalDiffLocalAmount 
        { 
            get{return _TaxTotalDiffLocalAmount;}
            set{SetProperty(ref _TaxTotalDiffLocalAmount, value);}
        }
