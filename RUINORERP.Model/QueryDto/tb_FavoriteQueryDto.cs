...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_FavoriteQueryDto:BaseEntityDto
    {
        public tb_FavoriteQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "ReferenceID",IsNullable = true,ColumnDescription = "引用ID" )]
        ...
        { 
            ...
            set{SetProperty(ref _Ref_Table_Name, value);}
        }
        ...
        { 
            ...
            set{SetProperty(ref _Public_enabled, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "Owner_by",IsNullable = true,ColumnDescription = "创建人" )]
        public long? Owner_by 
        { 
            get{return _Owner_by;}
            set{SetProperty(ref _Owner_by, value);}
        }
