...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_FinishedGoodsInvQueryDto:BaseEntityDto
    {
        public tb_FinishedGoodsInvQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "TotalNetWorkingHours",IsNullable = false,ColumnDescription = "总工时" )]
        public int TotalNetWorkingHours 
        { 
            get{return _TotalNetWorkingHours;}
            set{SetProperty(ref _TotalNetWorkingHours, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "TotalApportionedCost",IsNullable = false,ColumnDescription = "总分摊成本" )]
        public decimal TotalApportionedCost 
        { 
            get{return _TotalApportionedCost;}
            set{SetProperty(ref _TotalApportionedCost, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "TotalTollFees",IsNullable = false,ColumnDescription = "总托工费用" )]
        public decimal TotalTollFees 
        { 
            get{return _TotalTollFees;}
            set{SetProperty(ref _TotalTollFees, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "TotalLaborCost",IsNullable = false,ColumnDescription = "人工成本" )]
        public decimal TotalLaborCost 
        { 
            get{return _TotalLaborCost;}
            set{SetProperty(ref _TotalLaborCost, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "TotalProductionCost",IsNullable = false,ColumnDescription = "生产总成本" )]
        public decimal TotalProductionCost 
        { 
            get{return _TotalProductionCost;}
            set{SetProperty(ref _TotalProductionCost, value);}
        }
