...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_InventoryQueryDto:BaseEntityDto
    {
        public tb_InventoryQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "Alert_Use",IsNullable = false,ColumnDescription = "使用预警" )]
        public int Alert_Use 
        { 
            get{return _Alert_Use;}
            set{SetProperty(ref _Alert_Use, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "BatchNumber",IsNullable = false,ColumnDescription = "批次管理" )]
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "Alert_Quantity",IsNullable = false,ColumnDescription = "预警值" )]
        public int Alert_Quantity 
        { 
            get{return _Alert_Quantity;}
            set{SetProperty(ref _Alert_Quantity, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "Inv_AdvCost",IsNullable = false,ColumnDescription = "成本" )]
