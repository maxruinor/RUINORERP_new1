...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_InventoryTransactionQueryDto:BaseEntityDto
    {
        public tb_InventoryTransactionQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "ReferenceId",IsNullable = false,ColumnDescription = "业务单据" )]
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "QuantityChange",IsNullable = false,ColumnDescription = "变动数量" )]
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "AfterQuantity",IsNullable = false,ColumnDescription = "变后数量" )]
        public int AfterQuantity 
        { 
            get{return _AfterQuantity;}
            set{SetProperty(ref _AfterQuantity, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "BatchNumber",IsNullable = false,ColumnDescription = "批号" )]
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "OperatorId",IsNullable = true,ColumnDescription = "操作人" )]
