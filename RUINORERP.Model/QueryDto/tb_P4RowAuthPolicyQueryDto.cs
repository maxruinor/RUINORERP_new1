...
namespace RUINORERP.Model.QueryDto
{
    ...
    /// </summary>
    [Serializable()]
    [SugarTable("tb_P4RowAuthPolicy")]
    public partial class tb_P4RowAuthPolicyQueryDto:BaseEntityDto
    {
        public tb_P4RowAuthPolicyQueryDto()
        {
        ...
        private long? _RowAuthPolicyID;
        /// <summary>
        /// 
        /// </summary>
        [AdvQueryAttribute(ColName = "RowAuthPolicyID",ColDesc = "")]
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "RowAuthPolicyID",IsNullable = true,ColumnDescription = "" )]
        [FKRelationAttribute("tb_RowAuthPolicy","RowAuthPolicyID")]
        public long? RowAuthPolicyID 
        { 
            get{return _RowAuthPolicyID;}
            set{SetProperty(ref _RowAuthPolicyID, value);}
        }
