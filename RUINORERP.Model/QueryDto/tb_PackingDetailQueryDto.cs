...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_PackingDetailQueryDto:BaseEntityDto
    {
        public tb_PackingDetailQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "Pack_ID",IsNullable = false,ColumnDescription = "包装" )]
