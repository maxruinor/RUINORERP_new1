...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_PackingQueryDto:BaseEntityDto
    {
        public tb_PackingQueryDto()
        {
        ...
        { 
            ...
            set{SetProperty(ref _PackagingName, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "BundleID",IsNullable = true,ColumnDescription = "套装组合" )]
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "Unit_ID",IsNullable = false,ColumnDescription = "包装单位" )]
        ...
        [SugarColumn(ColumnDataType = "decimal",SqlParameterDbType ="Decimal",ColumnName = "NetWeight",IsNullable = false,ColumnDescription = "净重N.Wt.(g)" )]
