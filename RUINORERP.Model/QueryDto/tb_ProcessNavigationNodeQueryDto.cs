...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_ProcessNavigationNodeQueryDto:BaseEntityDto
    {
        public tb_ProcessNavigationNodeQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "ProcessNavID",IsNullable = false,ColumnDescription = "" )]
        [FKRelationAttribute("tb_ProcessNavigation","ProcessNavID")]
        public long ProcessNavID 
        { 
            get{return _ProcessNavID;}
            set{SetProperty(ref _ProcessNavID, value);}
        }
        ...
        { 
            ...
            set{SetProperty(ref _NodeCode, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "BusinessType",IsNullable = false,ColumnDescription = "" )]
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "ChildNavigationID",IsNullable = true,ColumnDescription = "" )]
        [FKRelationAttribute("tb_ProcessNavigation","ChildNavigationID")]
        public long? ChildNavigationID 
        { 
            get{return _ChildNavigationID;}
            set{SetProperty(ref _ChildNavigationID, value);}
        }
