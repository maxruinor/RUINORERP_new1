...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_ProdSplitQueryDto:BaseEntityDto
    {
        public tb_ProdSplitQueryDto()
        {
        ...
        { 
            get{return _SplitNo;}
            set{SetProperty(ref _SplitNo, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "SplitParentQty",IsNullable = false,ColumnDescription = "母件数量" )]
        public int SplitParentQty 
        { 
            get{return _SplitParentQty;}
            set{SetProperty(ref _SplitParentQty, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "SplitChildTotalQty",IsNullable = false,ColumnDescription = "子件总数量" )]
        public int SplitChildTotalQty 
        { 
            get{return _SplitChildTotalQty;}
            set{SetProperty(ref _SplitChildTotalQty, value);}
        }
