...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_ProduceGoodsRecommendDetailQueryDto:BaseEntityDto
    {
        public tb_ProduceGoodsRecommendDetailQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "RequirementQty",IsNullable = false,ColumnDescription = "请制量" )]
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "RefBillType",IsNullable = true,ColumnDescription = "单据类型" )]
