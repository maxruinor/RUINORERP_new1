...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_ProductionDemandQueryDto:BaseEntityDto
    {
        public tb_ProductionDemandQueryDto()
        {
        ...
        { 
            ...
            set{SetProperty(ref _AnalysisDate, value);}
        }
        ...
        /// 来源单据
        /// </summary>
        [AdvQueryAttribute(ColName = "PPID",ColDesc = "来源单据")]
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "PPID",IsNullable = true,ColumnDescription = "来源单据" )]
        ...
        { 
            ...
            set{SetProperty(ref _PurAllItems, value);}
        }
        ...
        { 
            ...
            set{SetProperty(ref _SuggestBasedOn, value);}
        }
