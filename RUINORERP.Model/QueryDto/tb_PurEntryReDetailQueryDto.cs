...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_PurEntryReDetailQueryDto:BaseEntityDto
    {
        public tb_PurEntryReDetailQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "PurEntryRe_ID",IsNullable = false,ColumnDescription = "" )]
        [FKRelationAttribute("tb_PurEntryRe","PurEntryRe_ID")]
        public long PurEntryRe_ID 
        { 
            get{return _PurEntryRe_ID;}
            set{SetProperty(ref _PurEntryRe_ID, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "SubtotalTrPriceAmount",IsNullable = false,ColumnDescription = "小计" )]
        public decimal SubtotalTrPriceAmount 
        { 
            get{return _SubtotalTrPriceAmount;}
            set{SetProperty(ref _SubtotalTrPriceAmount, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "DiscountAmount",IsNullable = false,ColumnDescription = "优惠金额" )]
