...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_PurEntryReQueryDto:BaseEntityDto
    {
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "ProcessWay",IsNullable = false,ColumnDescription = "处理方式" )]
        public int ProcessWay 
        { 
            get{return _ProcessWay;}
            set{SetProperty(ref _ProcessWay, value);}
        }
