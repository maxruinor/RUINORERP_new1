...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_PurEntryReQueryDto:BaseEntityDto
    {
        public tb_PurEntryReQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "CustomerVendor_ID",IsNullable = false,ColumnDescription = "供应商" )]
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "PurEntryID",IsNullable = true,ColumnDescription = "采购入库单" )]
        ...
        { 
            ...
            set{SetProperty(ref _PurEntryRENo, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "TotalQty",IsNullable = false,ColumnDescription = "合计数量" )]
        public int TotalQty 
        { 
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "ActualAmount",IsNullable = false,ColumnDescription = "实退金额" )]
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "TotalDiscountAmount",IsNullable = true,ColumnDescription = "折扣金额总计" )]
        public decimal? TotalDiscountAmount 
        { 
            get{return _TotalDiscountAmount;}
            set{SetProperty(ref _TotalDiscountAmount, value);}
        }
