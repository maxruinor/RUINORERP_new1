...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_PurOrderReQueryDto:BaseEntityDto
    {
        public tb_PurOrderReQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "PurOrder_ID",IsNullable = true,ColumnDescription = "" )]
        ...
        { 
            ...
            set{SetProperty(ref _PurReturnNo, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "GetPayment",IsNullable = false,ColumnDescription = "实际收回订金货款" )]
        public decimal GetPayment 
        { 
            get{return _GetPayment;}
            set{SetProperty(ref _GetPayment, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "TotalTaxAmount",IsNullable = false,ColumnDescription = "总计税额" )]
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "TotalAmount",IsNullable = false,ColumnDescription = "总计金额" )]
