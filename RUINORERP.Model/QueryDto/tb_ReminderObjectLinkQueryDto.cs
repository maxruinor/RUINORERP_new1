...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_ReminderObjectLinkQueryDto:BaseEntityDto
    {
        public tb_ReminderObjectLinkQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "SourceType",IsNullable = true,ColumnDescription = "提醒源类型" )]
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "SourceValue",IsNullable = true,ColumnDescription = "提醒源值" )]
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "TargetValue",IsNullable = true,ColumnDescription = "提醒目标值" )]
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "ActionType",IsNullable = true,ColumnDescription = "操作类型" )]
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "TargetType",IsNullable = true,ColumnDescription = "提醒目标类型" )]
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "BizType",IsNullable = true,ColumnDescription = "单据类型" )]
        public int? BizType 
        { 
            get{return _BizType;}
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "BillStatus",IsNullable = true,ColumnDescription = "单据状态" )]
        public int? BillStatus 
        { 
            get{return _BillStatus;}
            set{SetProperty(ref _BillStatus, value);}
        }
