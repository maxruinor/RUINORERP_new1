...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_SaleOutQueryDto:BaseEntityDto
    {
        public tb_SaleOutQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "SOrder_ID",IsNullable = true,ColumnDescription = "引用订单" )]
        ...
        { 
            get{return _OutDate;}
            set{SetProperty(ref _OutDate, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "money",SqlParameterDbType ="Decimal",ColumnName = "CollectedMoney",IsNullable = true,ColumnDescription = "实收金额" )]
