...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_StockInDetailQueryDto:BaseEntityDto
    {
        public tb_StockInDetailQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "MainID",IsNullable = false,ColumnDescription = "入库" )]
