...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_StockInQueryDto:BaseEntityDto
    {
        public tb_StockInQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "CustomerVendor_ID",IsNullable = true,ColumnDescription = "外部来源单位" )]
        ...
        { 
            ...
            set{SetProperty(ref _Enter_Date, value);}
        }
