...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_StockOutQueryDto:BaseEntityDto
    {
        public tb_StockOutQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "bigint",SqlParameterDbType ="Int64",ColumnName = "Type_ID",IsNullable = false,ColumnDescription = "出库类型" )]
