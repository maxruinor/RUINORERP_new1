...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_SysGlobalDynamicConfigQueryDto:BaseEntityDto
    {
        public tb_SysGlobalDynamicConfigQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "ValueType",IsNullable = false,ColumnDescription = "配置项的值类型" )]
