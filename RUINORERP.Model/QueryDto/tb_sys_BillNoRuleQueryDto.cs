...
namespace RUINORERP.Model.QueryDto
{
    ...
    public partial class tb_sys_BillNoRuleQueryDto:BaseEntityDto
    {
        public tb_sys_BillNoRuleQueryDto()
        {
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "RuleType",IsNullable = false,ColumnDescription = "规则类型" )]
        public int RuleType 
        { 
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "DateFormat",IsNullable = false,ColumnDescription = "日期格式" )]
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "SequenceLength",IsNullable = false,ColumnDescription = "流水号长度" )]
        public int SequenceLength 
        { 
            get{return _SequenceLength;}
            set{SetProperty(ref _SequenceLength, value);}
        }
        ...
        { 
            ...
            set{SetProperty(ref _UseCheckDigit, value);}
        }
        ...
        { 
            ...
            set{SetProperty(ref _RedisKeyPattern, value);}
        }
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "StorageType",IsNullable = false,ColumnDescription = "存储数据库类型" )]
        ...
        [SugarColumn(ColumnDataType = "int",SqlParameterDbType ="Int32",ColumnName = "ResetMode",IsNullable = false,ColumnDescription = "重置模式" )]
        ...
        { 
            ...
            set{SetProperty(ref _RulePattern, value);}
        }
