...
namespace RUINORERP.Model
{
    ...
    public class View_ProdBorrowingQueryDto:BaseEntity, ICloneable
    {
        public View_ProdBorrowingQueryDto()
        {
        ...
        /// BorrowID
        /// </summary>
        [SugarColumn(ColumnName = "BorrowID",IsNullable = true,ColumnDescription = "BorrowID")]
        ...
        /// 借出单号
        /// </summary>
        [SugarColumn(ColumnName = "BorrowNo",Length=50,IsNullable = true,ColumnDescription = "借出单号")]
        [Display(Name = "借出单号")]
        ...
        /// 接收单位
        /// </summary>
        [SugarColumn(ColumnName = "CustomerVendor_ID",IsNullable = true,ColumnDescription = "接收单位")]
        [Display(Name = "接收单位")]
        ...
        /// 借出人
        /// </summary>
        [SugarColumn(ColumnName = "Employee_ID",IsNullable = true,ColumnDescription = "借出人")]
        [Display(Name = "借出人")]
        ...
        /// 出库日期
        /// </summary>
        [SugarColumn(ColumnName = "Out_date",IsNullable = true,ColumnDescription = "出库日期")]
        [Display(Name = "出库日期")]
        ...
        /// 到期日期
        /// </summary>
        [SugarColumn(ColumnName = "DueDate",IsNullable = true,ColumnDescription = "到期日期")]
        [Display(Name = "到期日期")]
        ...
        /// 借出原因
        /// </summary>
        [SugarColumn(ColumnName = "Reason",Length=500,IsNullable = true,ColumnDescription = "借出原因")]
        [Display(Name = "借出原因")]
        ...
        /// 结案意见
        /// </summary>
        [SugarColumn(ColumnName = "CloseCaseOpinions",Length=200,IsNullable = true,ColumnDescription = "结案意见")]
        [Display(Name = "结案意见")]
        ...
        /// 借出数量
        /// </summary>
        [SugarColumn(ColumnName = "Qty",IsNullable = true,ColumnDescription = "借出数量")]
        [Display(Name = "借出数量")]
        public int? Qty 
        { 
        ...
        /// 归还数量
        /// </summary>
        [SugarColumn(ColumnName = "ReQty",IsNullable = true,ColumnDescription = "归还数量")]
        [Display(Name = "归还数量")]
        public int? ReQty 
        { 
        ...
        /// 售价
        /// </summary>
        [SugarColumn(ColumnName = "Price",IsNullable = true,ColumnDescription = "售价")]
        [Display(Name = "售价")]
        ...
        /// 金额小计
        /// </summary>
        [SugarColumn(ColumnName = "SubtotalPirceAmount",IsNullable = true,ColumnDescription = "金额小计")]
        [Display(Name = "金额小计")]
        ...
        /// 成本
        /// </summary>
        [SugarColumn(ColumnName = "Cost",IsNullable = true,ColumnDescription = "成本")]
        [Display(Name = "成本")]
        public decimal? Cost 
        { 
        ...
        /// 成本小计
        /// </summary>
        [SugarColumn(ColumnName = "SubtotalCostAmount",IsNullable = true,ColumnDescription = "成本小计")]
        [Display(Name = "成本小计")]
        ...
        /// 摘要
        /// </summary>
        [SugarColumn(ColumnName = "Summary",Length=500,IsNullable = true,ColumnDescription = "摘要")]
        [Display(Name = "摘要")]
