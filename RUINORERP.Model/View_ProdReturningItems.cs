...
namespace RUINORERP.Model
{
    ...
    /// </summary>
    [Serializable()]
    [SugarTable("View_ProdReturningItems")]
    public class View_ProdReturningItems:BaseEntity, ICloneable
    {
        public View_ProdReturningItems()
        {
            FieldNameList = fieldNameList;
            if (!PK_FK_ID_Check())
            {
                throw new Exception("View_ProdReturningItems" + "外键ID与对应主主键名称不一致。请修改数据库");
            }
        }
        ...
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "CustomerVendor_ID" ,IsNullable = true,ColumnDescription = "归还单位" )]
        [Display(Name = "归还单位")]
        ...
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "Employee_ID" ,IsNullable = true,ColumnDescription = "归还人" )]
        [Display(Name = "归还人")]
        ...
        public override ConcurrentDictionary<string, string> FieldNameList
        {
            get
            {
                if (fieldNameList == null)
                {
                    ...
                    Type type = typeof(View_ProdReturningItems);
