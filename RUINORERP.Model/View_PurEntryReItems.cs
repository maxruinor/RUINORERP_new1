...
{
    /// <summary>
    /// 采购退货统计 用pb文件生成。选择要生成的视图.检查列的描述。描述不能全空
    /// </summary>
    [Serializable()]
    [SugarTable("View_PurEntryReItems")]
    public partial class View_PurEntryReItems:BaseViewEntity
    {
        public View_PurEntryReItems()
        {
            FieldNameList = fieldNameList;
            if (!PK_FK_ID_Check())
            {
                throw new Exception("View_PurEntryReItems" + "外键ID与对应主主键名称不一致。请修改数据库");
            }
        }
        ...
        [SugarColumn(ColumnDataType = "varchar", SqlParameterDbType ="String",  ColumnName = "PurEntryReNo" ,Length=50,IsNullable = true,ColumnDescription = "退回单号" )]
        [Display(Name = "退回单号")]
        ...
        [SugarColumn(ColumnDataType = "money", SqlParameterDbType ="Decimal",  ColumnName = "SubtotalTrPriceAmount" ,IsNullable = true,ColumnDescription = "小计" )]
        [Display(Name = "小计")]
        ...
        [SugarColumn(ColumnDataType = "int", SqlParameterDbType ="Int32",  ColumnName = "TotalQty" ,IsNullable = true,ColumnDescription = "合计数量" )]
        [Display(Name = "合计数量")]
        public int? TotalQty 
        { 
        ...
        [SugarColumn(ColumnDataType = "varchar", SqlParameterDbType ="String",  ColumnName = "UnitName" ,Length=255,IsNullable = true,ColumnDescription = "单位名称" )]
        [Display(Name = "单位名称")]
        ...
        public override ConcurrentDictionary<string, string> FieldNameList
        {
            get
            {
                if (fieldNameList == null)
                {
                    ...
                    Type type = typeof(View_PurEntryReItems);
