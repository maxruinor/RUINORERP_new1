...
namespace RUINORERP.Model
{
    ...
    public partial class tb_BuyingRequisition: BaseEntity, ICloneable
    {
        ...
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "PuRequisition_ID" , DecimalDigits = 0,IsNullable = false,ColumnDescription = "请购单" , IsPrimaryKey = true)]
        public long PuRequisition_ID
        { 
            get{return _PuRequisition_ID;}
            set{
            base.PrimaryKeyID = _PuRequisition_ID;
        ...
        { 
            ...
            set{
            SetProperty(ref _PuRequisitionNo, value);
            }
        }
        ...
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "Location_ID" , DecimalDigits = 0,IsNullable = true,ColumnDescription = "库位" )]
        ...
        { 
            ...
            set{
            SetProperty(ref _ApplicationDate, value);
            }
        }
        ...
        //tb_BuyingRequisitionDetail.PuRequisition_ID)
        //PuRequisition_ID.FK_TB_BUYIN_REFERENCE_TB_BUYIN)
        //tb_BuyingRequisition.PuRequisition_ID)
...
return rs;
        ...
        public override ConcurrentDictionary<string, string> FieldNameList
        {
            get
            {
                if (fieldNameList == null)
                {
                    ...
                    Type type = typeof(tb_BuyingRequisition);
        ...
        {
            tb_BuyingRequisition loctype = (tb_BuyingRequisition)this.MemberwiseClone(); //创建当前对象的浅拷贝。
            return loctype;
        }
    }
}
