...
namespace RUINORERP.Model
{
    ...
    public partial class tb_CRM_FollowUpPlans: BaseEntity, ICloneable
    {
        ...
        //[Browsable(false)]
        [SugarColumn(IsIgnore = true)]
        [Navigate(NavigateType.OneToMany, nameof(tb_CRM_FollowUpRecords.NextPlanID))]
        public virtual List<tb_CRM_FollowUpRecords> tb_CRM_FollowUpRecordses_next { get; set; }
        //tb_CRM_FollowUpRecords.PlanID)
        //PlanID.FK_CRM_FOLLOWUPRECORDS_REF_FOLLOWUPPLANS_NEXT)
        //tb_CRM_FollowUpPlans.NextPlanID)
