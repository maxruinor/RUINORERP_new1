...
namespace RUINORERP.Model
{
    ...
    public partial class tb_Contacts: BaseEntity, ICloneable
    {
        public tb_Contacts()
        {
            ...
            if (!PK_FK_ID_Check())
            {
                throw new Exception("tb_Contacts" + "外键ID与对应主主键名称不一致。请修改数据库");
            }
        }
...
return rs;
        ...
        {
            tb_Contacts loctype = (tb_Contacts)this.MemberwiseClone(); //创建当前对象的浅拷贝。
            return loctype;
        }
    }
}
