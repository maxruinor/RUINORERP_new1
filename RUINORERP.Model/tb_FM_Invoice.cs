...
namespace RUINORERP.Model
{
    ...
    public partial class tb_FM_Invoice: BaseEntity, ICloneable
    {
        public tb_FM_Invoice()
        {
            
            if (!PK_FK_ID_Check())
            {
                throw new Exception("发票tb_FM_Invoice" + "外键ID与对应主主键名称不一致。请修改数据库");
            }
        }
        ...
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "InvoiceId" , DecimalDigits = 0,IsNullable = false,ColumnDescription = "发票" , IsPrimaryKey = true)]
        public long InvoiceId
        { 
            get{return _InvoiceId;}
            set{
            SetProperty(ref _InvoiceId, value);
                base.PrimaryKeyID = _InvoiceId;
            }
        }
        ...
        { 
            ...
            set{
            SetProperty(ref _InvoiceNo, value);
                        }
        }
        ...
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "CustomerVendor_ID" , DecimalDigits = 0,IsNullable = false,ColumnDescription = "付款单位" )]
        ...
        [SugarColumn(ColumnDataType = "money", SqlParameterDbType ="Decimal",  ColumnName = "TotalWithTax" , DecimalDigits = 4,IsNullable = true,ColumnDescription = "价税合计" )]
        public decimal? TotalWithTax
        { 
            get{return _TotalWithTax;}
            set{
            SetProperty(ref _TotalWithTax, value);
                        }
        }
        ...
        [SugarColumn(ColumnDataType = "money", SqlParameterDbType ="Decimal",  ColumnName = "TotalAmount" , DecimalDigits = 4,IsNullable = true,ColumnDescription = "发票总金额（不含税）" )]
        ...
        /// 付款状态
        /// </summary>
        [AdvQueryAttribute(ColName = nameof(ReceivePaymentType),ColDesc = "付款状态")] 
        [SugarColumn(ColumnDataType = "int", SqlParameterDbType ="Int32",  ColumnName = nameof(ReceivePaymentType) , DecimalDigits = 0,IsNullable = false,ColumnDescription = "付款状态" )]
        ...
        //[Browsable(false)]打印报表时的数据源会不显示
        [SugarColumn(IsIgnore = true)]
        [Navigate(NavigateType.OneToMany, nameof(tb_FM_InvoiceDetail.InvoiceId))]
        public virtual List<tb_FM_InvoiceDetail> tb_FM_InvoiceDetails { get; set; }
        //tb_FM_InvoiceDetail.InvoiceId)
        //InvoiceId.FK_TB_FM_IN_REFERENCE_TB_FM_IN)
        //tb_FM_Invoice.InvoiceId)
...
return rs;
        ...
        {
            tb_FM_Invoice loctype = (tb_FM_Invoice)this.MemberwiseClone(); //创建当前对象的浅拷贝。
            return loctype;
        }
    }
}
