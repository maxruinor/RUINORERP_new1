...
namespace RUINORERP.Model
{
    ...
    public partial class tb_FM_Payment: BaseEntity, ICloneable
    {
        ...
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "PaymentID" , DecimalDigits = 0,IsNullable = false,ColumnDescription = "付款申请单" , IsPrimaryKey = true)]
        ...
        /// 申请单号
        /// </summary>
        [AdvQueryAttribute(ColName = "PaymentNo",ColDesc = "申请单号")] 
        [SugarColumn(ColumnDataType = "varchar", SqlParameterDbType ="String",  ColumnName = "PaymentNo" ,Length=30,IsNullable = false,ColumnDescription = "申请单号" )]
        ...
        //[Browsable(false)]打印报表时的数据源会不显示
        [SugarColumn(IsIgnore = true)]
        [Navigate(NavigateType.OneToMany, nameof(tb_FM_PaymentDetail.PaymentID))]
        public virtual List<tb_FM_PaymentDetail> tb_FM_PaymentDetails { get; set; }
        //tb_FM_PaymentDetail.PaymentID)
        //PaymentID.FK_FM_PAYMENTDETAIL_REF_FM_PAYMENT)
        //tb_FM_Payment.PaymentID)
...
return rs;
        ...
        public override ConcurrentDictionary<string, string> FieldNameList
        {
            get
            {
                if (fieldNameList == null)
                {
                    ...
                    Type type = typeof(tb_FM_Payment);
        ...
        {
            tb_FM_Payment loctype = (tb_FM_Payment)this.MemberwiseClone(); //创建当前对象的浅拷贝。
            return loctype;
        }
    }
}
