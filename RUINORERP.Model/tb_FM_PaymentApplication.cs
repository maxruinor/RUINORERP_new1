...
namespace RUINORERP.Model
{
    ...
    {
        public tb_FM_PaymentApplication()
        {
            base.FieldNameList = fieldNameList;
            if (!PK_FK_ID_Check())
            {
                throw new Exception("付款申请单-目前代替纸的申请单将来完善明细则用付款单的主子表来完成系统可以根据客户来自动生成经人确认tb_FM_PaymentApplication" + "外键ID与对应主主键名称不一致。请修改数据库");
            }
        }
        ...
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "ApplicationID" , DecimalDigits = 0,IsNullable = false,ColumnDescription = "付款申请单" , IsPrimaryKey = true)]
        public long ApplicationID
        { 
            get{return _ApplicationID;}
            set{
            SetProperty(ref _ApplicationID, value);
                base.PrimaryKeyID = _ApplicationID;
            }
        }
        ...
        { 
            ...
            set{
            SetProperty(ref _ApplicationNo, value);
                        }
        }
...
return rs;
        ...
        public override ConcurrentDictionary<string, string> FieldNameList
        {
            get
            {
                if (fieldNameList == null)
                {
                    ...
                    Type type = typeof(tb_FM_PaymentApplication);
        ...
        {
            tb_FM_PaymentApplication loctype = (tb_FM_PaymentApplication)this.MemberwiseClone(); //创建当前对象的浅拷贝。
            return loctype;
        }
    }
}
