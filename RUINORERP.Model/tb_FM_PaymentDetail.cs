...
namespace RUINORERP.Model
{
    ...
    public partial class tb_FM_PaymentDetail: BaseEntity, ICloneable
    {
        ...
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "tb__DepartmentID" , DecimalDigits = 0,IsNullable = true,ColumnDescription = "部门" )]
        [FKRelationAttribute("tb_Department","tb__DepartmentID")]
        public long? tb__DepartmentID
        { 
            get{return _tb__DepartmentID;}
            set{
            SetProperty(ref _tb__DepartmentID, value);
                        }
        }
        ...
        [Navigate(NavigateType.OneToOne, nameof(tb__DepartmentID))]
...
{
  bool rs=true;
         if("DepartmentID"!="tb__DepartmentID")
        {
        // rs=false;
        }
return rs;
