...
namespace RUINORERP.Model
{
    ...
    /// </summary>
    [Serializable()]
    [Description("收款单后进入总账")]
    [SugarTable("tb_FM_PaymentReceipt")]
    public partial class tb_FM_PaymentReceipt: BaseEntity, ICloneable
    {
        public tb_FM_PaymentReceipt()
        {
            base.FieldNameList = fieldNameList;
            if (!PK_FK_ID_Check())
            {
                throw new Exception("收款单后进入总账tb_FM_PaymentReceipt" + "外键ID与对应主主键名称不一致。请修改数据库");
            }
        }
        ...
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "PaymentReceiptID" , DecimalDigits = 0,IsNullable = false,ColumnDescription = "收款单" , IsPrimaryKey = true)]
        public long PaymentReceiptID
        { 
            get{return _PaymentReceiptID;}
            set{
            SetProperty(ref _PaymentReceiptID, value);
                base.PrimaryKeyID = _PaymentReceiptID;
            }
        }
        ...
        /// 收款日期
        /// </summary>
        [AdvQueryAttribute(ColName = "DueDate",ColDesc = "收款日期")] 
        [SugarColumn(ColumnDataType = "date", SqlParameterDbType ="DateTime",  ColumnName = "DueDate" ,IsNullable = false,ColumnDescription = "收款日期" )]
        ...
        /// 收款金额
        /// </summary>
        [AdvQueryAttribute(ColName = "TotalAmount",ColDesc = "收款金额")] 
        [SugarColumn(ColumnDataType = "money", SqlParameterDbType ="Decimal",  ColumnName = "TotalAmount" , DecimalDigits = 4,IsNullable = true,ColumnDescription = "收款金额" )]
        ...
        //[Browsable(false)]打印报表时的数据源会不显示
        [SugarColumn(IsIgnore = true)]
        [Navigate(NavigateType.OneToMany, nameof(tb_FM_PaymentReceiptDetail.PaymentReceiptID))]
        public virtual List<tb_FM_PaymentReceiptDetail> tb_FM_PaymentReceiptDetails { get; set; }
        //tb_FM_PaymentReceiptDetail.PaymentReceiptID)
        //PaymentReceiptID.FK_FM_PAYMENTRECEIPTDETAIL_REF_FM_PAYMENTRECEIPT)
        //tb_FM_PaymentReceipt.PaymentReceiptID)
...
return rs;
        ...
        public override ConcurrentDictionary<string, string> FieldNameList
        {
            get
            {
                if (fieldNameList == null)
                {
                    ...
                    Type type = typeof(tb_FM_PaymentReceipt);
        ...
        {
            tb_FM_PaymentReceipt loctype = (tb_FM_PaymentReceipt)this.MemberwiseClone(); //创建当前对象的浅拷贝。
            return loctype;
        }
    }
}
