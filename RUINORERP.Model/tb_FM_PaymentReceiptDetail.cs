...
namespace RUINORERP.Model
{
    ...
    /// </summary>
    [Serializable()]
    [Description("收款单明细-对应的应收单据项目")]
    [SugarTable("tb_FM_PaymentReceiptDetail")]
    public partial class tb_FM_PaymentReceiptDetail: BaseEntity, ICloneable
    {
        public tb_FM_PaymentReceiptDetail()
        {
            base.FieldNameList = fieldNameList;
            if (!PK_FK_ID_Check())
            {
                throw new Exception("收款单明细-对应的应收单据项目tb_FM_PaymentReceiptDetail" + "外键ID与对应主主键名称不一致。请修改数据库");
            }
        }


        #region 属性
        private long _PaymentReceiptDetailID;
        /// <summary>
        /// 收款单明细
        /// </summary>
 
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "PaymentReceiptDetailID" , DecimalDigits = 0,IsNullable = false,ColumnDescription = "收款单明细" , IsPrimaryKey = true)]
        public long PaymentReceiptDetailID
        { 
            get{return _PaymentReceiptDetailID;}
            set{
            SetProperty(ref _PaymentReceiptDetailID, value);
                base.PrimaryKeyID = _PaymentReceiptDetailID;
            }
        }
        ...
        private long? _PaymentReceiptID;
        /// <summary>
        /// 收款单
        /// </summary>
        [AdvQueryAttribute(ColName = "PaymentReceiptID",ColDesc = "收款单")] 
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "PaymentReceiptID" , DecimalDigits = 0,IsNullable = true,ColumnDescription = "收款单" )]
        [FKRelationAttribute("tb_FM_PaymentReceipt","PaymentReceiptID")]
        public long? PaymentReceiptID
        { 
            get{return _PaymentReceiptID;}
            set{
            SetProperty(ref _PaymentReceiptID, value);
                        }
        }
        ...
        /// 为预收款
        /// </summary>
        [AdvQueryAttribute(ColName = "IsAdvancePayment",ColDesc = "为预收款")] 
        [SugarColumn(ColumnDataType = "bit", SqlParameterDbType ="Boolean",  ColumnName = "IsAdvancePayment" ,IsNullable = true,ColumnDescription = "为预收款" )]
        ...
        /// 收款项目/原因
        /// </summary>
        [AdvQueryAttribute(ColName = "PayReasonItems",ColDesc = "收款项目/原因")] 
        [SugarColumn(ColumnDataType = "varchar", SqlParameterDbType ="String",  ColumnName = "PayReasonItems" ,Length=200,IsNullable = false,ColumnDescription = "收款项目/原因" )]
        ...
        /// 收款账号
        /// </summary>
        [AdvQueryAttribute(ColName = "Account_id",ColDesc = "收款账号")] 
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "Account_id" , DecimalDigits = 0,IsNullable = true,ColumnDescription = "收款账号" )]
        ...
        /// 收款金额
        /// </summary>
        [AdvQueryAttribute(ColName = "SubAmount",ColDesc = "收款金额")] 
        [SugarColumn(ColumnDataType = "money", SqlParameterDbType ="Decimal",  ColumnName = "SubAmount" , DecimalDigits = 4,IsNullable = true,ColumnDescription = "收款金额" )]
        ...
        private string _SubEvidenceImagePath;
        /// <summary>
        /// 凭证图
        /// </summary>
        [AdvQueryAttribute(ColName = "SubEvidenceImagePath",ColDesc = "凭证图")] 
        [SugarColumn(ColumnDataType = "nvarchar", SqlParameterDbType ="String",  ColumnName = "SubEvidenceImagePath" ,Length=300,IsNullable = true,ColumnDescription = "凭证图" )]
        public string SubEvidenceImagePath
        { 
            get{return _SubEvidenceImagePath;}
            set{
            SetProperty(ref _SubEvidenceImagePath, value);
                        }
        }
        ...
        [SugarColumn(IsIgnore = true)]
        //[Browsable(false)] 打印报表时的数据源会不显示
        [Navigate(NavigateType.OneToOne, nameof(PaymentReceiptID))]
        public virtual tb_FM_PaymentReceipt tb_fm_paymentreceipt { get; set; }
...
return rs;
        ...
        public override ConcurrentDictionary<string, string> FieldNameList
        {
            get
            {
                if (fieldNameList == null)
                {
                    ...
                    Type type = typeof(tb_FM_PaymentReceiptDetail);
        ...
        {
            tb_FM_PaymentReceiptDetail loctype = (tb_FM_PaymentReceiptDetail)this.MemberwiseClone(); //创建当前对象的浅拷贝。
            return loctype;
        }
    }
}
