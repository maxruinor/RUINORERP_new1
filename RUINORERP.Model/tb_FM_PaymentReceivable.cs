...
namespace RUINORERP.Model
{
    ...
    public partial class tb_FM_PaymentReceivable: BaseEntity, ICloneable
    {
        public tb_FM_PaymentReceivable()
        {
            base.FieldNameList = fieldNameList;
            if (!PK_FK_ID_Check())
            {
                throw new Exception("应收款单tb_FM_PaymentReceivable" + "外键ID与对应主主键名称不一致。请修改数据库");
            }
        }
        ...
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "PaymentReceivableID" , DecimalDigits = 0,IsNullable = false,ColumnDescription = "应付款单" , IsPrimaryKey = true)]
        public long PaymentReceivableID
        { 
            get{return _PaymentReceivableID;}
            set{
            SetProperty(ref _PaymentReceivableID, value);
                base.PrimaryKeyID = _PaymentReceivableID;
            }
        }
        ...
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "PrePaymentReceiptID" , DecimalDigits = 0,IsNullable = true,ColumnDescription = "预收款单" )]
        ...
        { 
            ...
            set{
            SetProperty(ref _PrePaymentReceiptID, value);
                        }
        }
        ...
        [SugarColumn(ColumnDataType = "money", SqlParameterDbType ="Decimal",  ColumnName = "UntaxedTotalAmont" , DecimalDigits = 4,IsNullable = false,ColumnDescription = "未税本位币" )]
        ...
        [SugarColumn(ColumnDataType = "money", SqlParameterDbType ="Decimal",  ColumnName = "TotalPayableAmount" , DecimalDigits = 4,IsNullable = true,ColumnDescription = "应付总金额" )]
        public decimal? TotalPayableAmount
        { 
            get{return _TotalPayableAmount;}
            set{
            SetProperty(ref _TotalPayableAmount, value);
                        }
        }
        ...
        [SugarColumn(ColumnDataType = "money", SqlParameterDbType ="Decimal",  ColumnName = "TotalPaidAmount" , DecimalDigits = 4,IsNullable = true,ColumnDescription = "已付总金额" )]
        public decimal? TotalPaidAmount
        { 
            get{return _TotalPaidAmount;}
            set{
            SetProperty(ref _TotalPaidAmount, value);
                        }
        }
        ...
        [Navigate(NavigateType.OneToOne, nameof(PrePaymentReceiptID))]
        public virtual tb_FM_PrePaymentReceipt tb_fm_prepaymentreceipt { get; set; }
        ...
        //[Browsable(false)]打印报表时的数据源会不显示
        [SugarColumn(IsIgnore = true)]
        [Navigate(NavigateType.OneToMany, nameof(tb_FM_PaymentReceivableDetail.PaymentReceivableID))]
        public virtual List<tb_FM_PaymentReceivableDetail> tb_FM_PaymentReceivableDetails { get; set; }
        //tb_FM_PaymentReceivableDetail.PaymentReceivableID)
        //PaymentReceivableID.FK_FM_PAYMENTRECEIVABLEDETAIL_REF_FM_PAYMENTRECEIVABLE)
        //tb_FM_PaymentReceivable.PaymentReceivableID)
...
return rs;
        ...
        public override ConcurrentDictionary<string, string> FieldNameList
        {
            get
            {
                if (fieldNameList == null)
                {
                    ...
                    Type type = typeof(tb_FM_PaymentReceivable);
        ...
        {
            tb_FM_PaymentReceivable loctype = (tb_FM_PaymentReceivable)this.MemberwiseClone(); //创建当前对象的浅拷贝。
            return loctype;
        }
    }
}
