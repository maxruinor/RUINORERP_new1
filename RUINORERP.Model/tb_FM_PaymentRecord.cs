...
namespace RUINORERP.Model
{
    ...
    public partial class tb_FM_PaymentRecord: BaseEntity, ICloneable
    {
        ...
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "PaymentId" , DecimalDigits = 0,IsNullable = false,ColumnDescription = "收付款单" , IsPrimaryKey = true)]
        ...
        //[Browsable(false)]打印报表时的数据源会不显示
        [SugarColumn(IsIgnore = true)]
        [Navigate(NavigateType.OneToMany, nameof(tb_FM_PaymentSettlement.PaymentId))]
        public virtual List<tb_FM_PaymentSettlement> tb_FM_PaymentSettlements { get; set; }
        //tb_FM_PaymentSettlement.PaymentId)
        ...
        public override ConcurrentDictionary<string, string> FieldNameList
        {
            get
            {
                if (fieldNameList == null)
                {
                    ...
                    Type type = typeof(tb_FM_PaymentRecord);
