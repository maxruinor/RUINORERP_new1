...
namespace RUINORERP.Model
{
    ...
    {
        public tb_FM_PaymentRequest()
        {
            base.FieldNameList = fieldNameList;
            if (!PK_FK_ID_Check())
            {
                throw new Exception("付款申请单-即为付款单tb_FM_PaymentRequest" + "外键ID与对应主主键名称不一致。请修改数据库");
            }
        }
        ...
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "PaymentRequestID" , DecimalDigits = 0,IsNullable = false,ColumnDescription = "付款申请单" , IsPrimaryKey = true)]
        public long PaymentRequestID
        { 
            get{return _PaymentRequestID;}
            set{
            SetProperty(ref _PaymentRequestID, value);
                base.PrimaryKeyID = _PaymentRequestID;
            }
        }
        ...
        /// 申请单号
        /// </summary>
        [AdvQueryAttribute(ColName = "PaymentRequestNo",ColDesc = "申请单号")] 
        [SugarColumn(ColumnDataType = "varchar", SqlParameterDbType ="String",  ColumnName = "PaymentRequestNo" ,Length=30,IsNullable = false,ColumnDescription = "申请单号" )]
        public string PaymentRequestNo
        { 
            get{return _PaymentRequestNo;}
            set{
            SetProperty(ref _PaymentRequestNo, value);
                        }
        }
        ...
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "CustomerVendor_ID" , DecimalDigits = 0,IsNullable = false,ColumnDescription = "收款单位" )]
        ...
        private int _PayeeAccountType;
        /// <summary>
        /// 收款账号类型
        /// </summary>
        [AdvQueryAttribute(ColName = "PayeeAccountType",ColDesc = "收款账号类型")] 
        [SugarColumn(ColumnDataType = "int", SqlParameterDbType ="Int32",  ColumnName = "PayeeAccountType" , DecimalDigits = 0,IsNullable = false,ColumnDescription = "收款账号类型" )]
        public int PayeeAccountType
        { 
            get{return _PayeeAccountType;}
            set{
            SetProperty(ref _PayeeAccountType, value);
                        }
        }
        ...
        /// 申请日期
        /// </summary>
        [AdvQueryAttribute(ColName = "RequestDate",ColDesc = "申请日期")] 
        [SugarColumn(ColumnDataType = "date", SqlParameterDbType ="DateTime",  ColumnName = "RequestDate" ,IsNullable = false,ColumnDescription = "申请日期" )]
        ...
        /// 应付日期
        /// </summary>
        [AdvQueryAttribute(ColName = "DueDate",ColDesc = "应付日期")] 
        [SugarColumn(ColumnDataType = "date", SqlParameterDbType ="DateTime",  ColumnName = "DueDate" ,IsNullable = false,ColumnDescription = "应付日期" )]
        ...
        [SugarColumn(ColumnDataType = "money", SqlParameterDbType ="Decimal",  ColumnName = "TotalAmount" , DecimalDigits = 4,IsNullable = true,ColumnDescription = "付款金额" )]
        ...
        [Navigate(NavigateType.OneToMany, nameof(tb_FM_PaymentRequestDetail.PaymentRequestID))]
        public virtual List<tb_FM_PaymentRequestDetail> tb_FM_PaymentRequestDetails { get; set; }
        //tb_FM_PaymentRequestDetail.PaymentRequestID)
        //PaymentRequestID.FK_TB_FM_PA_REFERENCE_TB_FM_PA)
        //tb_FM_PaymentRequest.PaymentRequestID)
...
return rs;
        ...
        public override ConcurrentDictionary<string, string> FieldNameList
        {
            get
            {
                if (fieldNameList == null)
                {
                    ...
                    Type type = typeof(tb_FM_PaymentRequest);
        ...
        {
            tb_FM_PaymentRequest loctype = (tb_FM_PaymentRequest)this.MemberwiseClone(); //创建当前对象的浅拷贝。
            return loctype;
        }
    }
}
