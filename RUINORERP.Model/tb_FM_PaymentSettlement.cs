...
namespace RUINORERP.Model
{
    ...
    /// </summary>
    [Serializable()]
    [Description("记录收款 与应收的匹配，核销表-支持多对多、行项级核销 ")]
    ...
    public partial class tb_FM_PaymentSettlement: BaseEntity, ICloneable
    {
        public tb_FM_PaymentSettlement()
        {
            ...
            if (!PK_FK_ID_Check())
            {
                throw new Exception("记录收款 与应收的匹配，核销表-支持多对多、行项级核销 tb_FM_PaymentSettlement" + "外键ID与对应主主键名称不一致。请修改数据库");
            }
        }
        ...
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "PaymentId" , DecimalDigits = 0,IsNullable = true,ColumnDescription = "收付款单" )]
        ...
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "SourceBillDetailID" , DecimalDigits = 0,IsNullable = true,ColumnDescription = "单据明细" )]
        public long? SourceBillDetailID
        { 
            get{return _SourceBillDetailID;}
            set{
            SetProperty(ref _SourceBillDetailID, value);
                        }
        }
        ...
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "Employee_ID" , DecimalDigits = 0,IsNullable = false,ColumnDescription = "核销人" )]
        ...
        [SugarColumn(ColumnDataType = "int", SqlParameterDbType ="Int32",  ColumnName = "SettlementType" , DecimalDigits = 0,IsNullable = false,ColumnDescription = "付款状态" )]
