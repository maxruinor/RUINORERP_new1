...
namespace RUINORERP.Model
{
    ...
    [Serializable()]
    [Description("预收款明细表")]
    [SugarTable("tb_FM_PrePaymentReceiptDetail")]
    public partial class tb_FM_PrePaymentReceiptDetail: BaseEntity, ICloneable
    {
        public tb_FM_PrePaymentReceiptDetail()
        {
            base.FieldNameList = fieldNameList;
            if (!PK_FK_ID_Check())
            {
                throw new Exception("预收款明细表tb_FM_PrePaymentReceiptDetail" + "外键ID与对应主主键名称不一致。请修改数据库");
            }
        }


        #region 属性
        private long _PrePaymentReceiptSubID;
        /// <summary>
        /// 预收明细
        /// </summary>
 
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "PrePaymentReceiptSubID" , DecimalDigits = 0,IsNullable = false,ColumnDescription = "预收明细" , IsPrimaryKey = true)]
        public long PrePaymentReceiptSubID
        { 
            get{return _PrePaymentReceiptSubID;}
            set{
            SetProperty(ref _PrePaymentReceiptSubID, value);
                base.PrimaryKeyID = _PrePaymentReceiptSubID;
            }
        }
        ...
        /// 预收金额
        /// </summary>
        [AdvQueryAttribute(ColName = "PrePayAmount",ColDesc = "预收金额")] 
        [SugarColumn(ColumnDataType = "money", SqlParameterDbType ="Decimal",  ColumnName = "PrePayAmount" , DecimalDigits = 4,IsNullable = true,ColumnDescription = "预收金额" )]
...
return rs;
        ...
        public override ConcurrentDictionary<string, string> FieldNameList
        {
            get
            {
                if (fieldNameList == null)
                {
                    ...
                    Type type = typeof(tb_FM_PrePaymentReceiptDetail);
        ...
        {
            tb_FM_PrePaymentReceiptDetail loctype = (tb_FM_PrePaymentReceiptDetail)this.MemberwiseClone(); //创建当前对象的浅拷贝。
            return loctype;
        }
    }
}
