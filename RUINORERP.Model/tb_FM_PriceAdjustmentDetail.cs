...
namespace RUINORERP.Model
{
    ...
    public partial class tb_FM_PriceAdjustmentDetail : BaseEntity, ICloneable
    {
        ...
        /// 行号
        /// </summary>
        [AdvQueryAttribute(ColName = "LineNumber", ColDesc = "行号")]
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType = "Int64", ColumnName = "LineNumber", DecimalDigits = 0, IsNullable = false, ColumnDescription = "行号")]
