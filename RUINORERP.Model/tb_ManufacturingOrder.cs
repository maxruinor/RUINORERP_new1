...
namespace RUINORERP.Model
{
    ...
    public partial class tb_ManufacturingOrder: BaseEntity, ICloneable
    {
        ...
        /// 母件产品
        /// </summary>
        [AdvQueryAttribute(ColName = "ProdDetailID",ColDesc = "母件产品")] 
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "ProdDetailID" , DecimalDigits = 0,IsNullable = false,ColumnDescription = "母件产品" )]
        ...
        public virtual tb_CustomerVendor tb_customervendorOut { get; set; }
