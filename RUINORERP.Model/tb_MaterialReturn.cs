...
namespace RUINORERP.Model
{
    ...
    public partial class tb_MaterialReturn: BaseEntity, ICloneable
    {
        public tb_MaterialReturn()
        {
            ...
            if (!PK_FK_ID_Check())
            {
                throw new Exception("tb_MaterialReturn" + "外键ID与对应主主键名称不一致。请修改数据库");
            }
        }
        ...
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "CustomerVendor_ID" , DecimalDigits = 0,IsNullable = false,ColumnDescription = "加工厂商" )]
