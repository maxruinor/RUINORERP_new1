...
namespace RUINORERP.Model
{
    ...
    public partial class tb_MenuInfo : BaseEntity, ICloneable
    {
        ...
        [SugarColumn(ColumnDataType = "varchar", SqlParameterDbType = "String", ColumnName = "UIPropertyIdentifier", Length = 150, IsNullable = true, ColumnDescription = "属性标识")]
        ...
        [SugarColumn(ColumnDataType = "varchar", SqlParameterDbType = "String", ColumnName = "BIBizBaseForm", Length = 150, IsNullable = true, ColumnDescription = "注入业务基类")]
        ...
        //[Browsable(false)]打印报表时的数据源会不显示
        [SugarColumn(IsIgnore = true)]
        [Navigate(NavigateType.OneToMany, nameof(tb_P4RowAuthPolicyByRole.MenuID))]
        public virtual List<tb_P4RowAuthPolicyByRole> tb_P4RowAuthPolicyByRoles { get; set; }
        //tb_P4RowAuthPolicyByRole.MenuID)
        //MenuID.FK_TB_P4ROWAUTHPOLICY_REF_TB_MENUINFO)
        //tb_MenuInfo.MenuID)

        //[Browsable(false)]打印报表时的数据源会不显示
        [SugarColumn(IsIgnore = true)]
        [Navigate(NavigateType.OneToMany, nameof(tb_P4RowAuthPolicyByUser.MenuID))]
        public virtual List<tb_P4RowAuthPolicyByUser> tb_P4RowAuthPolicyByUsers { get; set; }
        //tb_P4RowAuthPolicyByUser.MenuID)
        //MenuID.FK_TB_P4ROWAUTHPOLICYBYUSER_REFE_TB_MENUINFO)
        //tb_MenuInfo.MenuID)
