...
namespace RUINORERP.Model
{
    ...
    public partial class tb_ProdDetail: BaseEntity, ICloneable
    {
        ...
        [SugarColumn(IsIgnore = true)]
        [Navigate(NavigateType.OneToMany, nameof(tb_AS_AfterSaleDeliveryDetail.ProdDetailID))]
        ...
        [SugarColumn(IsIgnore = true)]
        [Navigate(NavigateType.OneToMany, nameof(tb_AS_AfterSaleApplyDetail.ProdDetailID))]
        ...
        [SugarColumn(IsIgnore = true)]
        [Navigate(NavigateType.OneToMany, nameof(tb_AS_RepairInStockDetail.ProdDetailID))]
        ...
        [SugarColumn(IsIgnore = true)]
        [Navigate(NavigateType.OneToMany, nameof(tb_AS_RepairOrderMaterialDetail.ProdDetailID))]
        ...
        [SugarColumn(IsIgnore = true)]
        [Navigate(NavigateType.OneToMany, nameof(tb_AS_RepairOrderDetail.ProdDetailID))]
        ...
        public virtual List<tb_ProdConversionDetail> tb_ProdConversionDetailsByProddetailidTo { get; set; }
        ...
        [SugarColumn(IsIgnore = true)]
        [Navigate(NavigateType.OneToMany, nameof(tb_FM_PriceAdjustmentDetail.ProdDetailID))]
        ...
        [SugarColumn(IsIgnore = true)]
        [Navigate(NavigateType.OneToMany, nameof(tb_AS_RepairMaterialPickupDetail.ProdDetailID))]
        ...
        [SugarColumn(IsIgnore = true)]
        [Navigate(NavigateType.OneToMany, nameof(tb_FM_ReceivablePayableDetail.ProdDetailID))]
        ...
        [SugarColumn(IsIgnore = true)]
        [Navigate(NavigateType.OneToMany, nameof(tb_FM_ProfitLossDetail.ProdDetailID))]
