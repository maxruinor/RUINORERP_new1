...
namespace RUINORERP.Model
{
    ...
    public partial class tb_ProdMerge: BaseEntity, ICloneable
    {
        ...
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "MergeID" , DecimalDigits = 0,IsNullable = false,ColumnDescription = "组合单ID" , IsPrimaryKey = true)]
        public long MergeID
        { 
            get{return _MergeID;}
            set{
            SetProperty(ref _MergeID, value);
                base.PrimaryKeyID = _MergeID;
            }
        }
        ...
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "ProdDetailID" , DecimalDigits = 0,IsNullable = false,ColumnDescription = "产出对象" )]
        ...
        [SugarColumn(ColumnDataType = "int", SqlParameterDbType ="Int32",  ColumnName = "MergeTargetQty" , DecimalDigits = 0,IsNullable = false,ColumnDescription = "产出数量" )]
        public int MergeTargetQty
        { 
            get{return _MergeTargetQty;}
            set{
            SetProperty(ref _MergeTargetQty, value);
                        }
        }
        ...
        [SugarColumn(ColumnDataType = "int", SqlParameterDbType ="Int32",  ColumnName = "MergeSourceTotalQty" , DecimalDigits = 0,IsNullable = false,ColumnDescription = "子件总数量" )]
        public int MergeSourceTotalQty
        { 
            get{return _MergeSourceTotalQty;}
            set{
            SetProperty(ref _MergeSourceTotalQty, value);
                        }
        }
        ...
        //tb_ProdMergeDetail.MergeID)
        //MergeID.FK_TB_PRODMergeDetail_REF_PRODMerge)
        //tb_ProdMerge.MergeID)
...
return rs;
        ...
        {
            tb_ProdMerge loctype = (tb_ProdMerge)this.MemberwiseClone(); //创建当前对象的浅拷贝。
            return loctype;
        }
    }
}
