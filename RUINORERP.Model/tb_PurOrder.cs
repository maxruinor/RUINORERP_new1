...
namespace RUINORERP.Model
{
    ...
    public partial class tb_PurOrder : BaseEntity, ICloneable
    {
        ...
        /// 销售订单号
        /// </summary>
        [AdvQueryAttribute(ColName = "SOrderNo", ColDesc = "销售订单号")]
        [SugarColumn(ColumnDataType = "varchar", SqlParameterDbType = "String", ColumnName = "SOrderNo", Length = 50, IsNullable = false, ColumnDescription = "销售订单号")]
        ...
        private decimal _ForeignShipCost;
        /// <summary>
        /// 运费外币
        /// </summary>
