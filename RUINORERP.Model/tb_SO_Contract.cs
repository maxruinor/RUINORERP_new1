...
namespace RUINORERP.Model
{
    ...
    /// </summary>
    [Serializable()]
    [Description("先销售合同再订单,条款内容后面补充 注意一个合同可以多个发票一个发票也可以多个合同")]
    [SugarTable("tb_SO_Contract")]
    public partial class tb_SO_Contract: BaseEntity, ICloneable
    {
        public tb_SO_Contract()
        {
            
            if (!PK_FK_ID_Check())
            {
                throw new Exception("先销售合同再订单,条款内容后面补充 注意一个合同可以多个发票一个发票也可以多个合同tb_SO_Contract" + "外键ID与对应主主键名称不一致。请修改数据库");
            }
        }
        ...
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "SOContractID" , DecimalDigits = 0,IsNullable = false,ColumnDescription = "" , IsPrimaryKey = true)]
        public long SOContractID
        { 
            get{return _SOContractID;}
            set{
            SetProperty(ref _SOContractID, value);
                base.PrimaryKeyID = _SOContractID;
            }
        }
        ...
        /// 销售方
        /// </summary>
        [AdvQueryAttribute(ColName = "ID",ColDesc = "销售方")] 
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "ID" , DecimalDigits = 0,IsNullable = true,ColumnDescription = "销售方" )]
        ...
        /// 采购方
        /// </summary>
        [AdvQueryAttribute(ColName = "CustomerVendor_ID",ColDesc = "采购方")] 
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "CustomerVendor_ID" , DecimalDigits = 0,IsNullable = true,ColumnDescription = "采购方" )]
        ...
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "BillingInfo_ID" , DecimalDigits = 0,IsNullable = true,ColumnDescription = "开票资料" )]
        ...
        private string _SOContractNo;
        /// <summary>
        /// 合同编号
        /// </summary>
        [AdvQueryAttribute(ColName = "SOContractNo",ColDesc = "合同编号")] 
        [SugarColumn(ColumnDataType = "varchar", SqlParameterDbType ="String",  ColumnName = "SOContractNo" ,Length=50,IsNullable = true,ColumnDescription = "合同编号" )]
        public string SOContractNo
        { 
            get{return _SOContractNo;}
            set{
            SetProperty(ref _SOContractNo, value);
                        }
        }
        ...
        [SugarColumn(ColumnDataType = "datetime", SqlParameterDbType ="DateTime",  ColumnName = "EffectiveDate" ,IsNullable = true,ColumnDescription = "生效日期" )]
        ...
        /// 到期日期
        /// </summary>
        [AdvQueryAttribute(ColName = "ExpireDate",ColDesc = "到期日期")] 
        [SugarColumn(ColumnDataType = "datetime", SqlParameterDbType ="DateTime",  ColumnName = "ExpireDate" ,IsNullable = true,ColumnDescription = "到期日期" )]
        ...
        [SugarColumn(IsIgnore = true)]
        //[Browsable(false)] 打印报表时的数据源会不显示
        [Navigate(NavigateType.OneToOne, nameof(BillingInfo_ID))]
        public virtual tb_BillingInformation tb_billinginformation { get; set; }
        ...
        //[Browsable(false)]打印报表时的数据源会不显示
        [SugarColumn(IsIgnore = true)]
        [Navigate(NavigateType.OneToMany, nameof(tb_SO_ContractDetail.SOContractID))]
        public virtual List<tb_SO_ContractDetail> tb_SO_ContractDetails { get; set; }
        //tb_SO_ContractDetail.SOContractID)
        //SOContractID.FK_TB_SO_CONTR_REF_TB_CONTRDETAIL)
        //tb_SO_Contract.SOContractID)
...
return rs;
        ...
        {
            tb_SO_Contract loctype = (tb_SO_Contract)this.MemberwiseClone(); //创建当前对象的浅拷贝。
            return loctype;
        }
    }
}
