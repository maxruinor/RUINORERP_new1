...
namespace RUINORERP.Model
{
    ...
    public partial class tb_SaleOrder: BaseEntity, ICloneable
    {
        ...
        [SugarColumn(ColumnDataType = "nvarchar", SqlParameterDbType ="String",  ColumnName = "VoucherImage" ,Length=2000,IsNullable = true,ColumnDescription = "凭证图片" )]
        ...
        [SugarColumn(ColumnDataType = "varchar", SqlParameterDbType ="String",  ColumnName = "CustomerPONo" ,Length=50,IsNullable = true,ColumnDescription = "客户订单号" )]
