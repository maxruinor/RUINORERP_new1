...
namespace RUINORERP.Model
{
    ...
    public partial class tb_SaleOutReDetail: BaseEntity, ICloneable
    {
        ...
        /// 明细
        /// </summary>
        [AdvQueryAttribute(ColName = "SaleOutDetail_ID",ColDesc = "明细")] 
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "SaleOutDetail_ID" , DecimalDigits = 0,IsNullable = true,ColumnDescription = "明细" )]
