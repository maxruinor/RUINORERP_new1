...
namespace RUINORERP.Model
{
    ...
    /// </summary>
    [Serializable()]
    [Description("tb_SaleOutReRefurbishedMaterialsDetail")]
    [SugarTable("tb_SaleOutReRefurbishedMaterialsDetail")]
    public partial class tb_SaleOutReRefurbishedMaterialsDetail: BaseEntity, ICloneable
    {
        public tb_SaleOutReRefurbishedMaterialsDetail()
        {
            base.FieldNameList = fieldNameList;
            if (!PK_FK_ID_Check())
            {
                throw new Exception("tb_SaleOutReRefurbishedMaterialsDetail" + "外键ID与对应主主键名称不一致。请修改数据库");
            }
        }
        ...
        /// 
        /// </summary>
        [AdvQueryAttribute(ColName = "SaleOutRe_ID",ColDesc = "")] 
        [SugarColumn(ColumnDataType = "bigint", SqlParameterDbType ="Int64",  ColumnName = "SaleOutRe_ID" , DecimalDigits = 0,IsNullable = false,ColumnDescription = "" )]
...
return rs;
        ...
        public override ConcurrentDictionary<string, string> FieldNameList
        {
            get
            {
                if (fieldNameList == null)
                {
                    ...
                    Type type = typeof(tb_SaleOutReRefurbishedMaterialsDetail);
        ...
        {
            tb_SaleOutReRefurbishedMaterialsDetail loctype = (tb_SaleOutReRefurbishedMaterialsDetail)this.MemberwiseClone(); //创建当前对象的浅拷贝。
            return loctype;
        }
    }
}
