...
namespace RUINORERP.Model
{
    ...
    public partial class tb_StockOutDetail: BaseEntity, ICloneable
    {
        public tb_StockOutDetail()
        {
            ...
            if (!PK_FK_ID_Check())
            {
                throw new Exception("tb_StockOutDetail" + "外键ID与对应主主键名称不一致。请修改数据库");
            }
        }
        ...
        //public virtual tb_StockOut tb_MainID { get; set; }
        ...
        public override ConcurrentDictionary<string, string> FieldNameList
        {
            get
            {
                if (fieldNameList == null)
                {
                    ...
                    Type type = typeof(tb_StockOutDetail);
