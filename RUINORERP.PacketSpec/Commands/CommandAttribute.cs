...
namespace RUINORERP.PacketSpec.Commands
{
    /// <summary>
    /// 命令特性，用于标记命令类
    /// 兼容SuperSocket的CommandAttribute
    /// </summary>
    ...
    public class CommandAttribute : Attribute
    {
        ...
        /// <summary>
        /// 命令键 - 用于SuperSocket命令匹配
        /// 与Id属性相同，为了兼容SuperSocket而添加
        /// </summary>
        public uint Key { get { return Id; } }
        ...
        public CommandAttribute(uint id, string name, CommandCategory category)
        {
            Id = id;
            Name = name;
            Category = category;
