...
{
    /// <summary>
    /// 加密解密协议工具类，用于Socket通讯中的数据加解密和数据包处理
    /// </summary>
    public static class EncryptedProtocol
    {
        ...
        /// <returns></returns>
        public static OriginalData DecryptionClientPack(byte[] Head, int HeaderLen, byte[] alldata)
        {
