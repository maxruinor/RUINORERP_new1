using RUINORERP.Repository.IRepository;
using RUINORERP.Repository.Model.Models;
using RUINORERP.Repository.Repository.Base;
using SqlSugar;
using System.Collections.Generic;
using System.Threading.Tasks;
using RUINORERP.Repository.Repository.UnitOfWorks;

namespace RUINORERP.Repository.Repository
{
    /// <summary>
