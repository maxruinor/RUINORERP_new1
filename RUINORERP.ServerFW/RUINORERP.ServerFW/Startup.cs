        ...
        public static void ConfigureContainerByDll(ContainerBuilder builder)
        {
          ...
          .AsClosedTypesOf(typeof(IServices.BASE.IBaseServices<>));
            ...
            */
            ...
            builder.RegisterType<BizPackageInfo>();
 
            builder.RegisterType<ServiceforBiz<BizPackageInfo>>().UsingConstructor(typeof(IServiceProvider), typeof(IOptions<ServerOptions>));

            //.UsingConstructor(typeof(IServiceProvider), typeof(IOptions<>));
            /*
                        builder.RegisterType(typeof(ServiceforBiz<>))
