    ...
    public partial class frmMain : Form
    {
        ...
        private void InitializeServerInstancesDataGridView()
        {
            ...
            dgvServerInstances.Columns.AddRange(new DataGridViewColumn[]
            {
                ...
                new DataGridViewComboBoxColumn { HeaderText = "状态", DataPropertyName = "Status", Width = 100, DataSource = Enum.GetValues(typeof(ServerInstanceStatus)) }
            });
        }
        ...
        private void InitializeAuthorizationDataGridView()
        {
            ...
            dgvAuthorization.Columns.AddRange(new DataGridViewColumn[]
            {
                ...
                new DataGridViewComboBoxColumn { HeaderText = "授权类型", DataPropertyName = "AuthorizationType", Width = 120, DataSource = Enum.GetValues(typeof(AuthorizationType)) },
                ...
                new DataGridViewComboBoxColumn { HeaderText = "状态", DataPropertyName = "Status", Width = 100, DataSource = Enum.GetValues(typeof(AuthorizationStatus)) }
            });
        }
        ...
        private void InitializeUsersDataGridView()
        {
            ...
            dgvUsers.Columns.AddRange(new DataGridViewColumn[]
            {
                ...
                new DataGridViewComboBoxColumn { HeaderText = "状态", DataPropertyName = "Status", Width = 100, DataSource = Enum.GetValues(typeof(UserStatus)) },
