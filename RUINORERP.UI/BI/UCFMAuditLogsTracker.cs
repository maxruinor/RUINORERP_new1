...
namespace RUINORERP.UI.BI
{
    ...
    [MenuAttrAssemblyInfo("财务审计日志业务轨迹跟踪器", true, UIType.单表数据)]
    public partial class UCFMAuditLogsTracker : BaseEditGeneric<tb_FM_AuditLogs>
    {
        public UCFMAuditLogsTracker()
        {
            InitializeComponent();
        ...
        public List<tb_FM_AuditLogs> AuditLogs { get => _AuditLogs; set => _AuditLogs = value; }
