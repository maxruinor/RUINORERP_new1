...
namespace RUINORERP.UI.BI
{
    ...
    public partial class UCFMSubjectList : BaseForm.BaseListWithTree<tb_FM_Subject>
    {
        ...
        protected override void Modify()
        {
            if (base.bindingSourceList.Current != null)
            {
                ...
                object oldobj = CloneHelper.DeepCloneObject_maxnew<tb_FM_Subject>(base.bindingSourceList.Current as tb_FM_Subject);
