...
{
    public class MyUserControl : TabPage
    {
        ...
        protected override void OnLayout(LayoutEventArgs e)
        {
            if (_palette != null)
            {
                ...
                using (ViewLayoutContext viewContext = new ViewLayoutContext(this, renderer))
                {
                    ...
                    //_mementoContent = renderer.RenderStandardContent.LayoutContent(viewContext, innerRect, _paletteContent, this, Orientation, buttonState, false);
                }
            }
