...
{
    public partial class NotificationBox : Krypton.Toolkit.KryptonForm
    {
        #region 声明的变量
        private System.Drawing.Rectangle Rect;//定义一个存储矩形框的数组
        private FormState InfoStyle = FormState.Hide;//定义变量为隐藏
        static private NotificationBox dropDownForm = new NotificationBox();//实例化当前窗体
        ...
        #region 返回当前窗体的实例化对象
        static public NotificationBox Instance()
        {
