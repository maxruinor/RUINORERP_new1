...
namespace RUINORERP.UI.PSI.PUR
{
    ...
    public partial class UCFinishedGoodsInv : BaseBillEditGeneric<tb_FinishedGoodsInv, tb_FinishedGoodsInvQueryDto>
    {
        ...
        public void BindData(tb_FinishedGoodsInv entity)
        {
            ...
            {
                base.InitRequiredToControl(new tb_FinishedGoodsInvValidator(), kryptonSplitContainer1.Panel1.Controls);
            }
            ShowPrintStatus(lblPrintStatus, EditEntity);
        ...
        .ToExpression();//注意 这一句 不能少
            ...
            sgd.SetDependencyObject<ProductSharePart, tb_FinishedGoodsInvDetail>(list);
