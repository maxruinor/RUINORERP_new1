...
namespace RUINORERP.UI.MRP.MP
{
    ...
    public partial class UCManufacturingOrderQuery : BaseBillQueryMC<tb_ManufacturingOrder, tb_ManufacturingOrderDetail>
    {
        ...
        public override void BuildColNameDataDictionary()
        {
            ...
            System.Linq.Expressions.Expression<Func<tb_ManufacturingOrder, int?>> exprDataStatus;
            ...
            System.Linq.Expressions.Expression<Func<tb_ManufacturingOrder, int?>> exprApprovalStatus;
            ...
            System.Linq.Expressions.Expression<Func<tb_ManufacturingOrder, int?>> exprPriority;
            exprPriority = (p) => p.Priority;
            base.MasterColNameDataDictionary.TryAdd(exprPriority.GetMemberInfo().Name, CommonHelper.Instance.GetKeyValuePairs(typeof(Priority)));
            ...
            //System.Linq.Expressions.Expression<Func<tb_ManufacturingOrderDetail, bool?>> expr2;
            //expr2 = (p) => p.Gift;// == name;
            ...
            System.Linq.Expressions.Expression<Func<tb_ManufacturingOrderDetail, long>> expProdDetailID;
