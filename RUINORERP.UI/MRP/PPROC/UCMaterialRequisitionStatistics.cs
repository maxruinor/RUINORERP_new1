...
{
    [MenuAttrAssemblyInfo("生产领料统计", ModuleMenuDefine.模块定义.生产管理, ModuleMenuDefine.生产管理.制程生产, BizType.生产领料统计)]
    public partial class UCMaterialRequisitionStatistics : BaseNavigatorGeneric<View_MaterialRequisitionItems, View_MaterialRequisitionItems>
    {
        public UCMaterialRequisitionStatistics()
        {
            InitializeComponent();
            //生成查询条件的相关实体 是不是也一个组，主子表呢？
            ReladtedEntityType = typeof(View_MaterialRequisitionItems);
        ...
        private void UCSaleOutStatistics_Load(object sender, EventArgs e)
        {
            ...
            //不能在上面的构造函数里面初始化
            base._UCMasterQuery.GridRelated.SetRelatedInfo<View_MaterialRequisitionItems, tb_ManufacturingOrder>(c => c.MONO, r => r.MONO);
            base._UCMasterQuery.GridRelated.SetRelatedInfo<View_MaterialRequisitionItems, tb_MaterialRequisition>(c => c.MaterialRequisitionNO, r => r.MaterialRequisitionNO);
            ...
            base._UCMasterQuery.ColDisplayTypes.Add(typeof(tb_MaterialRequisition));
            base._UCMasterQuery.ColDisplayTypes.Add(typeof(tb_MaterialRequisitionDetail));
            ...
            base._UCOutlookGridGroupAnalysis.GridRelated.SetRelatedInfo<View_MaterialRequisitionItems, tb_ManufacturingOrder>(c => c.MONO, r => r.MONO);
        ...
        {
            BaseProcessor baseProcessor = Startup.GetFromFacByName<BaseProcessor>(typeof(View_MaterialRequisitionItems).Name + "Processor");
        ...
        public override void BuildSummaryCols()
        {
            ...
            base.MasterSummaryCols.Add(c => c.CanQuantity);
            base.MasterSummaryCols.Add(c => c.ReturnQty);
            base.MasterSummaryCols.Add(c => c.ShouldSendQty);
            base.MasterSummaryCols.Add(c => c.SubtotalCost);
            base.MasterSummaryCols.Add(c => c.SubtotalPrice);
