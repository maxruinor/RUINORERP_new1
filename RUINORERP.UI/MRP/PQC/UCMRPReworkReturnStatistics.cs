...
namespace RUINORERP.UI.MRP.PQC
{
    ...
    public partial class UCMRPReworkReturnStatistics : BaseNavigatorGeneric<View_MRP_ReworkReturn, View_MRP_ReworkReturn>
    {
        public UCMRPReworkReturnStatistics()
        {
            ...
            ReladtedEntityType = typeof(View_MRP_ReworkReturn);
        ...
        private void UCSaleOrderStatistics_Load(object sender, EventArgs e)
        {
            ...
            //不能在上面的构造函数里面初始化
            base._UCMasterQuery.GridRelated.SetRelatedInfo<View_MRP_ReworkReturn, tb_MRP_ReworkEntry>(c => c.ReworkReturnNo, r => r.ReworkEntryNo);
            ...
            base._UCOutlookGridGroupAnalysis.GridRelated.SetRelatedInfo<View_MRP_ReworkReturn, tb_MRP_ReworkEntry>(c => c.ReworkReturnNo, r => r.ReworkEntryNo);
        }

        public override void BuildLimitQueryConditions()
        {
            //创建表达式
            var lambda = Expressionable.Create<View_MRP_ReworkReturn>()
        ...
        {
            BaseProcessor baseProcessor = Startup.GetFromFacByName<BaseProcessor>(typeof(View_MRP_ReworkReturn).Name + "Processor");
