...
namespace RUINORERP.UI.PSI.INV
{
    ...
    [MenuAttrAssemblyInfo("借出单统计", ModuleMenuDefine.模块定义.进销存管理, ModuleMenuDefine.进销存管理.借出归还, BizType.借出单统计)]
    public partial class UCProdBorrowingStatistics : BaseNavigatorGeneric<View_ProdBorrowing, View_ProdBorrowing>
    {
        ...
        private void UCPurEntryStatistics_Load(object sender, EventArgs e)
        {
            ...
            base._UCOutlookGridGroupAnalysis.GridRelated.SetRelatedInfo<View_ProdBorrowing, tb_ProdBorrowing>(c => c.BorrowNo, r => r.BorrowNo);
        }
