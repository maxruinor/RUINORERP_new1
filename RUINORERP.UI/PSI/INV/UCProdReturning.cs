...
namespace RUINORERP.UI.PSI.INV
{
    ...
    public partial class UCProdReturning : BaseBillEditGeneric<tb_ProdReturning, tb_ProdReturningQueryDto>
    {
        ...
        private void UCStockIn_Load(object sender, EventArgs e)
        {
            ...
            List<SourceGridDefineColumnItem> listCols = sgh.GetGridColumns<ProductSharePart, tb_ProdReturningDetail>(c => c.ProdDetailID, false);
        ...
        protected async override void Save()
        {
            ...
            if (EditEntity.ActionStatus == ActionStatus.新增 || EditEntity.ActionStatus == ActionStatus.修改)
            {
                ...
                if (!base.Validator<tb_ProdReturningDetail>(details))
                {
                    return;
                }
