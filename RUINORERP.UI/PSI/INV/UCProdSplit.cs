...
{
    [MenuAttrAssemblyInfo("产品分割单", ModuleMenuDefine.模块定义.进销存管理, ModuleMenuDefine.供应链管理.库存管理, BizType.产品分割单)]
    public partial class UCProdSplit : BaseBillEditGeneric<tb_ProdSplit, tb_ProdSplit>
    {
        ...
        public async  void BindData(tb_ProdSplit entity)
        {
            if (entity == null)
            {
        ...
        protected async override Task<ApprovalEntity> Review()
        {
            ...
            List<tb_ProdSplit> _StockIns = new List<tb_ProdSplit>();
