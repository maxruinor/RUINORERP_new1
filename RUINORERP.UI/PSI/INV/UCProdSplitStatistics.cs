...
namespace RUINORERP.UI.PSI.INV
{
    ...
    [MenuAttrAssemblyInfo("分割明细统计", ModuleMenuDefine.模块定义.进销存管理, ModuleMenuDefine.进销存管理.产品分割与组合, BizType.分割明细统计)]
    public partial class UCProdSplitStatistics : BaseNavigatorGeneric<View_ProdSplitItems, View_ProdSplitItems>
    {
        public UCProdSplitStatistics()
        {
            InitializeComponent();
            //生成查询条件的相关实体 视图时要指定
            ReladtedEntityType = typeof(View_ProdSplitItems);
        }
        ...
        {
            base._UCMasterQuery.GridRelated.SetRelatedInfo<View_ProdSplitItems, tb_ProdSplit>(c => c.SplitNo, r => r.SplitNo);
            ...
            base._UCOutlookGridGroupAnalysis.GridRelated.SetRelatedInfo<View_ProdSplitItems, tb_ProdSplit>(c => c.SplitNo, r => r.SplitNo);
        }
        ...
        {
            BaseProcessor baseProcessor = Startup.GetFromFacByName<BaseProcessor>(typeof(View_ProdSplitItems).Name + "Processor");
        ...
        public override async Task Print(RptMode rptMode)
        {
            ...
            List<View_ProdSplitItems> selectlist = GetSelectResult();
            ...
            {
                _PrintConfig = PrintHelper<View_ProdSplitItems>.GetPrintConfig<View_ProdSplitItems>();
            }


            tb_CustomerVendor customerVendor = new tb_CustomerVendor();
            var dto = QueryDto as View_ProdSplitItems;
            ...
            bool rs = PrintHelper<View_ProdSplitItems>.PrintCustomData<PurEntryStatementByCV>(statementByCV, rptMode, _PrintConfig);
            if (rs)
            {
