...
{
    [MenuAttrAssemblyInfo("其他出库单查询", ModuleMenuDefine.模块定义.进销存管理, ModuleMenuDefine.供应链管理.库存管理, BizType.其他出库单)]
    public partial class UCStockOutQuery : BaseBillQueryMC<tb_StockOut, tb_StockOutDetail>
    {
        ...
        public override void BuildColNameDataDictionary()
        {
            ...
            System.Linq.Expressions.Expression<Func<tb_StockOut, int?>> exprApprovalStatus;
            ...
            System.Linq.Expressions.Expression<Func<tb_StockOut, int?>> exprDataStatus;
            ...
            System.Linq.Expressions.Expression<Func<tb_StockOutDetail, long>> expProdDetailID;
