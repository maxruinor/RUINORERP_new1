...
{
    [MenuAttrAssemblyInfo("采购入库分析", ModuleMenuDefine.模块定义.进销存管理, ModuleMenuDefine.进销存管理.采购管理, BizType.采购入库统计)]
    public partial class UCPurEntryAnalysis : BaseNavigatorGeneric<View_PurEntryItems, View_PurEntryItems>
    {
        public UCPurEntryAnalysis()
        {
            InitializeComponent();
            //生成查询条件的相关实体 视图时要指定
        ...
        private void UCPurEntryAnalysis_Load(object sender, EventArgs e)
        {   
