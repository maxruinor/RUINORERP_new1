...
namespace RUINORERP.UI.PSI.PUR
{
    ...
    public partial class UCPurOrderStatistics : BaseMasterQueryWithCondition<View_PurOrderItems>
    {
        ...
        {
            //不能在上面的构造函数里面初始化
            base._UCBillMasterQuery.GridRelated.SetRelatedInfo<View_PurOrderItems, tb_PurOrder>(c => c.PurOrderNo, r => r.PurOrder_ID);
            base._UCBillMasterQuery.GridRelated.SetRelatedInfo<View_PurOrderItems, tb_SaleOrder>(c => c.SOrder_ID, r => r.SOrder_ID);
            ...
            _UCBillOutlookGridAnalysis.GridRelated.SetRelatedInfo<View_PurOrderItems, tb_SaleOrder>(c => c.SOrder_ID, r => r.SOrder_ID);
