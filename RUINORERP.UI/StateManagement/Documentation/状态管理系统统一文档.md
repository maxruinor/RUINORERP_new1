...
2. **UI层状态变更**: 可使用 `StatusChangeEventArgs`
...
// UI层状态变更事件处理
void OnStatusChanged(object sender, StatusChangeEventArgs e)
{
...
- 2025年11月: 修正事件参数类型说明，明确指出不存在StatusChangedEventArgs类，详细说明StateTransitionEventArgs和StatusChangeEventArgs的用途和适用场景
