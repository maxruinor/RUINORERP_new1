...
namespace RUINORERP.UI.SysConfig
{
    ...
    /// </summary>
    [MenuAttrAssemblyInfo("动态参数", ModuleMenuDefine.模块定义.系统设置, ModuleMenuDefine.系统设置.动态参数)]
    public partial class UCGlobalDynamicConfig : UserControl
    {
        ...
        private void UCGlobalDynamicConfig_Load(object sender, EventArgs e)
        {
            ...
            List<tb_SysGlobalDynamicConfig> configList = MainForm.Instance.AppContext.Db.CopyNew().Queryable<tb_SysGlobalDynamicConfig>()
                 .ToList();

            //&& t.tb_ButtonInfo != null && t.tb_ButtonInfo.MenuID == selectMenu.MenuID
            bindingSource1.DataSource = configList.ToBindingSortCollection();
        ...
        internal void InitListData()
        {
            ...
            FieldNameList1 = UIHelper.GetFieldNameColList(typeof(tb_SysGlobalDynamicConfig));
            dataGridView1.XmlFileName = "UCSysGlobalDynamicConfig";
            ...
            dataGridView2.XmlFileName = "UCSysGlobalDynamicConfig";
