...
{
    [MenuAttrAssemblyInfo("工作台配置", ModuleMenuDefine.模块定义.系统设置, ModuleMenuDefine.系统设置.权限管理)]
    public partial class UCWorkCenterConfig : UserControl
    {
        public UCWorkCenterConfig()
        {
            InitializeComponent();
