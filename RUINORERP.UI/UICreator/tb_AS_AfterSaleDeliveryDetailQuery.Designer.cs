...
namespace RUINORERP.UI
{
    ...
    /// 售后交付明细
    /// </summary>
    partial class tb_AS_AfterSaleDeliveryDetailQuery
    {
     ...
     this.lblASDeliveryID = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.cmbASDeliveryID = new ComponentFactory.Krypton.Toolkit.KryptonComboBox();
...
this.Controls.Add(this.txtCustomerPartNo );
            ...
            this.Name = "tb_AS_AfterSaleDeliveryDetailQuery";
     ...
     //for start
              ...
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblASDeliveryID;
private ComponentFactory.Krypton.Toolkit.KryptonComboBox cmbASDeliveryID;
