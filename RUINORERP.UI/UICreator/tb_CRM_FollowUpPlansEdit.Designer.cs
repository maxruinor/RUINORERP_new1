...
this.txtPlanStartDate = new Krypton.Toolkit.KryptonTextBox();

this.lblPlanEndDate = new Krypton.Toolkit.KryptonLabel();
this.txtPlanEndDate = new Krypton.Toolkit.KryptonTextBox();
...
private Krypton.Toolkit.KryptonTextBox txtPlanStartDate;

    
        
              private Krypton.Toolkit.KryptonLabel lblPlanEndDate;
private Krypton.Toolkit.KryptonTextBox txtPlanEndDate;
