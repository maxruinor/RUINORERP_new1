...
namespace RUINORERP.UI
{
    ...
    /// 文档表
    /// </summary>
    partial class tb_DocumentsEdit
    {
     ...
     // this.btnCancel = new ComponentFactory.Krypton.Toolkit.KryptonButton();
      ...
      //for definition
     this.lblFiles_Path = new Krypton.Toolkit.KryptonLabel();
this.txtFiles_Path = new Krypton.Toolkit.KryptonTextBox();
...
this.Controls.Add(this.txtFiles_Path );
     ...
     //for start
              ...
              private Krypton.Toolkit.KryptonLabel lblFiles_Path;
private Krypton.Toolkit.KryptonTextBox txtFiles_Path;
