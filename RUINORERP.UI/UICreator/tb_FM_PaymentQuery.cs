...
namespace RUINORERP.UI
{
    ...
    /// 付款申请单-即为付款单数据查询
    /// </summary>
     [MenuAttribute(typeof(tb_FM_PaymentQuery), "付款申请单-即为付款单数据查询", true)]
    public partial class tb_FM_PaymentQuery:UserControl
    {
     public tb_FM_PaymentQuery() {
       ...
       // RuleFor(tb_FM_Payment => tb_FM_Payment.PaymentID).NotEmpty();
