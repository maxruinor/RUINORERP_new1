...
namespace RUINORERP.UI
{
    ...
    /// 价格调整单数据查询
    /// </summary>
     [MenuAttribute(typeof(tb_FM_PriceAdjustmentQuery), "价格调整单数据查询", true)]
    public partial class tb_FM_PriceAdjustmentQuery:UserControl
    {
     public tb_FM_PriceAdjustmentQuery() {
       ...
       // RuleFor(tb_FM_PriceAdjustment => tb_FM_PriceAdjustment.AdjustId).NotEmpty();
