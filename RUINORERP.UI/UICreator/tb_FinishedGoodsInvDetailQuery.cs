...
namespace RUINORERP.UI
{
    ...
    /// 成品入库单明细数据查询
    /// </summary>
     [MenuAttribute(typeof(tb_FinishedGoodsInvDetailQuery), "成品入库单明细数据查询", true)]
    public partial class tb_FinishedGoodsInvDetailQuery:UserControl
    {
     public tb_FinishedGoodsInvDetailQuery() {
       ...
       // RuleFor(tb_FinishedGoodsInvDetail => tb_FinishedGoodsInvDetail.Sub_ID).NotEmpty();
       ...
       //===============
        ...
        public void LoadDroplistData()
        {
          ...
          // DataBindingHelper.InitDataToCmb<tb_FinishedGoodsInv>(k => k.FG_ID, v=>v.XXNAME, cmbFG_ID);
