...
namespace RUINORERP.UI
{
    ...
    /// 开票资料
    /// </summary>
    partial class tb_InvoiceInfoEdit
    {
...
this.lblPICompanyName = new Krypton.Toolkit.KryptonLabel();
this.txtPICompanyName = new Krypton.Toolkit.KryptonTextBox();

this.lblPITaxID = new Krypton.Toolkit.KryptonLabel();
this.txtPITaxID = new Krypton.Toolkit.KryptonTextBox();

this.lblPIAddress = new Krypton.Toolkit.KryptonLabel();
this.txtPIAddress = new Krypton.Toolkit.KryptonTextBox();

this.lblPITEL = new Krypton.Toolkit.KryptonLabel();
this.txtPITEL = new Krypton.Toolkit.KryptonTextBox();

this.lblPIBankName = new Krypton.Toolkit.KryptonLabel();
this.txtPIBankName = new Krypton.Toolkit.KryptonTextBox();

this.lblPIBankNo = new Krypton.Toolkit.KryptonLabel();
this.txtPIBankNo = new Krypton.Toolkit.KryptonTextBox();

this.lblNotes = new Krypton.Toolkit.KryptonLabel();
this.txtNotes = new Krypton.Toolkit.KryptonTextBox();
this.txtNotes.Multiline = true;

this.lbl信用天数 = new Krypton.Toolkit.KryptonLabel();
this.txt信用天数 = new Krypton.Toolkit.KryptonTextBox();

this.lbl往来余额 = new Krypton.Toolkit.KryptonLabel();
this.txt往来余额 = new Krypton.Toolkit.KryptonTextBox();

this.lbl应收款 = new Krypton.Toolkit.KryptonLabel();
this.txt应收款 = new Krypton.Toolkit.KryptonTextBox();

this.lbl预收款 = new Krypton.Toolkit.KryptonLabel();
this.txt预收款 = new Krypton.Toolkit.KryptonTextBox();

this.lbl纳税号 = new Krypton.Toolkit.KryptonLabel();
this.txt纳税号 = new Krypton.Toolkit.KryptonTextBox();

this.lbl开户行 = new Krypton.Toolkit.KryptonLabel();
this.txt开户行 = new Krypton.Toolkit.KryptonTextBox();

this.lbl银行帐号 = new Krypton.Toolkit.KryptonLabel();
this.txt银行帐号 = new Krypton.Toolkit.KryptonTextBox();
...
private Krypton.Toolkit.KryptonComboBox cmbCustomerVendor_ID;
              ...
              private Krypton.Toolkit.KryptonLabel lblPICompanyName;
private Krypton.Toolkit.KryptonTextBox txtPICompanyName;

    
        
              private Krypton.Toolkit.KryptonLabel lblPITaxID;
private Krypton.Toolkit.KryptonTextBox txtPITaxID;

    
        
              private Krypton.Toolkit.KryptonLabel lblPIAddress;
private Krypton.Toolkit.KryptonTextBox txtPIAddress;
...
private Krypton.Toolkit.KryptonTextBox txtPITEL;
              ...
              private Krypton.Toolkit.KryptonLabel lblPIBankName;
private Krypton.Toolkit.KryptonTextBox txtPIBankName;

    
        
              private Krypton.Toolkit.KryptonLabel lblPIBankNo;
private Krypton.Toolkit.KryptonTextBox txtPIBankNo;
...
private Krypton.Toolkit.KryptonTextBox txtNotes;
              ...
              private Krypton.Toolkit.KryptonLabel lbl信用天数;
private Krypton.Toolkit.KryptonTextBox txt信用天数;

    
        
              private Krypton.Toolkit.KryptonLabel lbl往来余额;
private Krypton.Toolkit.KryptonTextBox txt往来余额;

    
        
              private Krypton.Toolkit.KryptonLabel lbl应收款;
private Krypton.Toolkit.KryptonTextBox txt应收款;

    
        
              private Krypton.Toolkit.KryptonLabel lbl预收款;
private Krypton.Toolkit.KryptonTextBox txt预收款;

    
        
              private Krypton.Toolkit.KryptonLabel lbl纳税号;
private Krypton.Toolkit.KryptonTextBox txt纳税号;

    
        
              private Krypton.Toolkit.KryptonLabel lbl开户行;
private Krypton.Toolkit.KryptonTextBox txt开户行;

    
        
              private Krypton.Toolkit.KryptonLabel lbl银行帐号;
private Krypton.Toolkit.KryptonTextBox txt银行帐号;
