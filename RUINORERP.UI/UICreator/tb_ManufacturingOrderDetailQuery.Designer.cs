...
namespace RUINORERP.UI
{
    ...
    /// </summary>
    partial class tb_ManufacturingOrderDetailQuery
    {
...
this.lblOverSentQty = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.txtOverSentQty = new ComponentFactory.Krypton.Toolkit.KryptonTextBox();

this.lblWastageQty = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.txtWastageQty = new ComponentFactory.Krypton.Toolkit.KryptonTextBox();

this.lblCurrentIinventory = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.txtCurrentIinventory = new ComponentFactory.Krypton.Toolkit.KryptonTextBox();
...
this.lblIsExternalProduce = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.chkIsExternalProduce = new ComponentFactory.Krypton.Toolkit.KryptonCheckBox();
...
this.lblAssemblyPosition = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.txtAssemblyPosition = new ComponentFactory.Krypton.Toolkit.KryptonTextBox();
this.txtAssemblyPosition.Multiline = true;

this.lblAlternativeProducts = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.txtAlternativeProducts = new ComponentFactory.Krypton.Toolkit.KryptonTextBox();

this.lblPrelevel_BOM_Desc = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.txtPrelevel_BOM_Desc = new ComponentFactory.Krypton.Toolkit.KryptonTextBox();
...
this.Controls.Add(this.txtPrelevel_BOM_Desc );
            ...
            this.Name = "tb_ManufacturingOrderDetailQuery";
...
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtActualSentQty;
              ...
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblOverSentQty;
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtOverSentQty;

    
        
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblWastageQty;
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtWastageQty;

    
        
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblCurrentIinventory;
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtCurrentIinventory;
...
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtSubtotalUnitCost;
              ...
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblIsExternalProduce;
private ComponentFactory.Krypton.Toolkit.KryptonCheckBox chkIsExternalProduce;
...
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtSummary;
              ...
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblAssemblyPosition;
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtAssemblyPosition;

    
        
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblAlternativeProducts;
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtAlternativeProducts;

    
        
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblPrelevel_BOM_Desc;
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtPrelevel_BOM_Desc;
