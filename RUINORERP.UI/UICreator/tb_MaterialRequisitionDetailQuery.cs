...
namespace RUINORERP.UI
{
    ...
    /// 领料单明细数据查询
    /// </summary>
     [MenuAttribute(typeof(tb_MaterialRequisitionDetailQuery), "领料单明细数据查询", true)]
    public partial class tb_MaterialRequisitionDetailQuery:UserControl
    {
     public tb_MaterialRequisitionDetailQuery() {
       ...
       // RuleFor(tb_MaterialRequisitionDetail => tb_MaterialRequisitionDetail.Detail_ID).NotEmpty();
