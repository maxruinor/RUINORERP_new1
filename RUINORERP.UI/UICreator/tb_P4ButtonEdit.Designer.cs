...
namespace RUINORERP.UI
{
    ...
    partial class tb_P4ButtonEdit
    {
     ...
     // this.btnCancel = new ComponentFactory.Krypton.Toolkit.KryptonButton();
      ...
      //for definition
     this.lblButtonInfo_ID = new Krypton.Toolkit.KryptonLabel();
this.cmbButtonInfo_ID = new Krypton.Toolkit.KryptonComboBox();
...
this.Controls.Add(this.txtModified_by );
     ...
     //for start
              ...
              private Krypton.Toolkit.KryptonLabel lblButtonInfo_ID;
private Krypton.Toolkit.KryptonComboBox cmbButtonInfo_ID;
