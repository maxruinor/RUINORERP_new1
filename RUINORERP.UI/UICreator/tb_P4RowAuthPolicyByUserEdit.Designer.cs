...
namespace RUINORERP.UI
{
    ...
    /// 行级权限规则-用户关联表
    /// </summary>
    partial class tb_P4RowAuthPolicyByUserEdit
    {
     ...
     // this.btnCancel = new ComponentFactory.Krypton.Toolkit.KryptonButton();
      ...
      //for definition
     this.lblPolicyId = new Krypton.Toolkit.KryptonLabel();
this.cmbPolicyId = new Krypton.Toolkit.KryptonComboBox();
...
this.Controls.Add(this.txtModified_by );
            ...
            this.Name = "tb_P4RowAuthPolicyByUserEdit";
     ...
     //for start
              ...
              private Krypton.Toolkit.KryptonLabel lblPolicyId;
private Krypton.Toolkit.KryptonComboBox cmbPolicyId;
