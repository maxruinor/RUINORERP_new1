...
namespace RUINORERP.UI
{
    ...
    /// 价格记录表数据查询
    /// </summary>
     [MenuAttribute(typeof(tb_PriceRecordQuery), "价格记录表数据查询", true)]
    public partial class tb_PriceRecordQuery:UserControl
    {
     public tb_PriceRecordQuery() {
       ...
       // RuleFor(tb_PriceRecord => tb_PriceRecord.RecordID).NotEmpty();
