...
namespace RUINORERP.UI
{
    ...
    /// 打印模板
    /// </summary>
    partial class tb_PrintTemplateEdit
    {
     ...
     // this.btnCancel = new ComponentFactory.Krypton.Toolkit.KryptonButton();
      ...
      //for definition
     this.lblPrintConfigID = new Krypton.Toolkit.KryptonLabel();
this.cmbPrintConfigID = new Krypton.Toolkit.KryptonComboBox();

this.lblTemplate_Name = new Krypton.Toolkit.KryptonLabel();
this.txtTemplate_Name = new Krypton.Toolkit.KryptonTextBox();
...
this.lblTemplateFileData = new Krypton.Toolkit.KryptonLabel();
this.txtTemplateFileData = new Krypton.Toolkit.KryptonTextBox();
this.txtTemplateFileData.Multiline = true;


this.lblIsDefaultTemplate = new Krypton.Toolkit.KryptonLabel();
this.chkIsDefaultTemplate = new Krypton.Toolkit.KryptonCheckBox();
...
this.Controls.Add(this.chkisdeleted );
            ...
            this.Name = "tb_PrintTemplateEdit";
     ...
     //for start
              ...
              private Krypton.Toolkit.KryptonLabel lblPrintConfigID;
private Krypton.Toolkit.KryptonComboBox cmbPrintConfigID;

    
        
              private Krypton.Toolkit.KryptonLabel lblTemplate_Name;
private Krypton.Toolkit.KryptonTextBox txtTemplate_Name;
...
private Krypton.Toolkit.KryptonTextBox txtBizName;
              ...
              private Krypton.Toolkit.KryptonLabel lblTemplateFileData;
private Krypton.Toolkit.KryptonTextBox txtTemplateFileData;
              ...
              private Krypton.Toolkit.KryptonLabel lblIsDefaultTemplate;
private Krypton.Toolkit.KryptonCheckBox chkIsDefaultTemplate;
