...
namespace RUINORERP.UI
{
    ...
    /// 借出单明细数据查询
    /// </summary>
     [MenuAttribute(typeof(tb_ProdBorrowingDetailQuery), "借出单明细数据查询", true)]
    public partial class tb_ProdBorrowingDetailQuery:UserControl
    {
     public tb_ProdBorrowingDetailQuery() {
       ...
       // RuleFor(tb_ProdBorrowingDetail => tb_ProdBorrowingDetail.BorrowDetaill_ID).NotEmpty();
