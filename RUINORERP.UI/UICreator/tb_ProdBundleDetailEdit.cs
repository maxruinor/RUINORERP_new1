...
/*
        ...
        tb_ProdBundleDetail entity = new tb_ProdBundleDetail();
                     entity.BundleID = Int64.Parse(txtBundleID.Text);
                        ...
                        entity.SaleUnitPrice = Decimal.Parse(txtSaleUnitPrice.Text);
        ...
        */
        ...
        _EditEntity = entity;
          ...
          // DataBindingHelper.BindData4Cmb<tb_ProdDetail>(entity, k => k.ProdDetailID, v=>v.XXNAME, cmbProdDetailID);
           ...
           DataBindingHelper.BindData4TextBox<tb_ProdBundleDetail>(entity, t => t.SaleUnitPrice.ToString(), txtSaleUnitPrice, BindDataType4TextBox.Money,false);
           ...
           DataBindingHelper.BindData4CheckBox<tb_ProdBundleDetail>(entity, t => t.Is_enabled, chkIs_enabled, false);
//有默认值
           DataBindingHelper.BindData4CheckBox<tb_ProdBundleDetail>(entity, t => t.Is_available, chkIs_available, false);
//有默认值
