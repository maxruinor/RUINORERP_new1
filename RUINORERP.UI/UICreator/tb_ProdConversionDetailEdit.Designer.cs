...
Type_ID_from主外字段不一致。Type_ID_to主外字段不一致。
ProdDetailID_from主外字段不一致。this.lblLocation_ID = new Krypton.Toolkit.KryptonLabel();
this.cmbLocation_ID = new Krypton.Toolkit.KryptonComboBox();
Type_ID_from主外字段不一致。Type_ID_to主外字段不一致。
ProdDetailID_from主外字段不一致。Type_ID_from主外字段不一致。Type_ID_to主外字段不一致。this.lblProdDetailID_from = new Krypton.Toolkit.KryptonLabel();
this.txtProdDetailID_from = new Krypton.Toolkit.KryptonTextBox();

ProdDetailID_from主外字段不一致。this.lblProdDetailID = new Krypton.Toolkit.KryptonLabel();
...
ProdDetailID_from主外字段不一致。Type_ID_from主外字段不一致。Type_ID_to主外字段不一致。this.lblType_ID_from = new Krypton.Toolkit.KryptonLabel();
...
ProdDetailID_from主外字段不一致。Type_ID_from主外字段不一致。Type_ID_to主外字段不一致。this.lblConversionQty = new Krypton.Toolkit.KryptonLabel();
...
ProdDetailID_from主外字段不一致。Type_ID_from主外字段不一致。Type_ID_to主外字段不一致。this.lblType_ID_to = new Krypton.Toolkit.KryptonLabel();
...
this.Controls.Add(this.cmbConversionID);
           ...
           //#####Location_ID###Int64
//属性测试50Location_ID
ProdDetailID_from主外字段不一致。//属性测试50Location_ID
//属性测试50Location_ID
//属性测试50Location_ID
...
this.Controls.Add(this.cmbConversionID );
                ...
                ProdDetailID_from主外字段不一致。this.Controls.Add(this.lblLocation_ID );
this.Controls.Add(this.cmbLocation_ID );

                ProdDetailID_from主外字段不一致。Type_ID_from主外字段不一致。Type_ID_to主外字段不一致。this.Controls.Add(this.lblProdDetailID_from );
this.Controls.Add(this.txtProdDetailID_from );

                ProdDetailID_from主外字段不一致。this.Controls.Add(this.lblProdDetailID );
this.Controls.Add(this.cmbProdDetailID );

                this.Controls.Add(this.lblSKU_from );
this.Controls.Add(this.txtSKU_from );

                ProdDetailID_from主外字段不一致。Type_ID_from主外字段不一致。Type_ID_to主外字段不一致。this.Controls.Add(this.lblType_ID_from );
this.Controls.Add(this.txtType_ID_from );
...
this.Controls.Add(this.txtproperty_from );
                ...
                ProdDetailID_from主外字段不一致。Type_ID_from主外字段不一致。Type_ID_to主外字段不一致。this.Controls.Add(this.lblConversionQty );
this.Controls.Add(this.txtConversionQty );

                this.Controls.Add(this.lblSKU_to );
this.Controls.Add(this.txtSKU_to );

                ProdDetailID_from主外字段不一致。Type_ID_from主外字段不一致。Type_ID_to主外字段不一致。this.Controls.Add(this.lblType_ID_to );
this.Controls.Add(this.txtType_ID_to );
...
Type_ID_from主外字段不一致。Type_ID_to主外字段不一致。
              ...
              ProdDetailID_from主外字段不一致。private Krypton.Toolkit.KryptonLabel lblLocation_ID;
private Krypton.Toolkit.KryptonComboBox cmbLocation_ID;
Type_ID_from主外字段不一致。Type_ID_to主外字段不一致。
    
        
              ProdDetailID_from主外字段不一致。Type_ID_from主外字段不一致。Type_ID_to主外字段不一致。private Krypton.Toolkit.KryptonLabel lblProdDetailID_from;
private Krypton.Toolkit.KryptonTextBox txtProdDetailID_from;

    
        
              ProdDetailID_from主外字段不一致。private Krypton.Toolkit.KryptonLabel lblProdDetailID;
...
private Krypton.Toolkit.KryptonTextBox txtSKU_from;
              ...
              ProdDetailID_from主外字段不一致。Type_ID_from主外字段不一致。Type_ID_to主外字段不一致。private Krypton.Toolkit.KryptonLabel lblType_ID_from;
...
private Krypton.Toolkit.KryptonTextBox txtproperty_from;
              ...
              ProdDetailID_from主外字段不一致。Type_ID_from主外字段不一致。Type_ID_to主外字段不一致。private Krypton.Toolkit.KryptonLabel lblConversionQty;
...
private Krypton.Toolkit.KryptonTextBox txtSKU_to;
              ...
              ProdDetailID_from主外字段不一致。Type_ID_from主外字段不一致。Type_ID_to主外字段不一致。private Krypton.Toolkit.KryptonLabel lblType_ID_to;
