...
namespace RUINORERP.UI
{
    ...
    /// 产品转换单明细
    /// </summary>
    partial class tb_ProdConversionDetailQuery
    {
     ...
     ProdDetailID_from主外字段不一致。this.lblConversionID = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.cmbConversionID = new ComponentFactory.Krypton.Toolkit.KryptonComboBox();
ProdDetailID_to主外字段不一致。Type_ID_from主外字段不一致。Type_ID_to主外字段不一致。
ProdDetailID_from主外字段不一致。ProdDetailID_to主外字段不一致。Type_ID_from主外字段不一致。Type_ID_to主外字段不一致。
...
this.lblTargetInitCost = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.txtTargetInitCost = new ComponentFactory.Krypton.Toolkit.KryptonTextBox();
...
this.Controls.Add(this.txtSummary );
            ...
            this.Name = "tb_ProdConversionDetailQuery";
     ...
     //for start
              ...
              ProdDetailID_from主外字段不一致。private ComponentFactory.Krypton.Toolkit.KryptonLabel lblConversionID;
private ComponentFactory.Krypton.Toolkit.KryptonComboBox cmbConversionID;
ProdDetailID_to主外字段不一致。Type_ID_from主外字段不一致。Type_ID_to主外字段不一致。
...
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtSKU_to;
              ...
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblTargetInitCost;
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtTargetInitCost;
