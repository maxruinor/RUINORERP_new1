...
namespace RUINORERP.UI
{
    ...
    /// 组合单明细
    /// </summary>
    partial class tb_ProdMergeDetailEdit
    {
     ...
     // this.btnCancel = new ComponentFactory.Krypton.Toolkit.KryptonButton();
      ...
      //for definition
     this.lblMergeID = new Krypton.Toolkit.KryptonLabel();
this.cmbMergeID = new Krypton.Toolkit.KryptonComboBox();
...
this.Controls.Add(this.txtSummary );
            ...
            this.Name = "tb_ProdMergeDetailEdit";
     ...
     //for start
              ...
              private Krypton.Toolkit.KryptonLabel lblMergeID;
private Krypton.Toolkit.KryptonComboBox cmbMergeID;
