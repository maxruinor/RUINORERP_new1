...
namespace RUINORERP.UI
{
    ...
    /// 归还单明细
    /// </summary>
    partial class tb_ProdReturningDetailQuery
    {
     ...
     this.lblReturnID = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.cmbReturnID = new ComponentFactory.Krypton.Toolkit.KryptonComboBox();
...
this.Controls.Add(this.txtSubtotalPirceAmount );
            ...
            this.Name = "tb_ProdReturningDetailQuery";
     ...
     //for start
              ...
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblReturnID;
private ComponentFactory.Krypton.Toolkit.KryptonComboBox cmbReturnID;
