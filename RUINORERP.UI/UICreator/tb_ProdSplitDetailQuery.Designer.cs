...
namespace RUINORERP.UI
{
    ...
    /// 拆分单明细
    /// </summary>
    partial class tb_ProdSplitDetailQuery
    {
     ...
     this.lblSplitID = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.cmbSplitID = new ComponentFactory.Krypton.Toolkit.KryptonComboBox();
...
this.Controls.Add(this.txtSummary );
            ...
            this.Name = "tb_ProdSplitDetailQuery";
     ...
     //for start
              ...
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblSplitID;
private ComponentFactory.Krypton.Toolkit.KryptonComboBox cmbSplitID;
