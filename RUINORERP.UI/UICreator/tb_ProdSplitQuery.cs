...
namespace RUINORERP.UI
{
    ...
    /// 产品拆分单数据查询
    /// </summary>
     [MenuAttribute(typeof(tb_ProdSplitQuery), "产品拆分单数据查询", true)]
    public partial class tb_ProdSplitQuery:UserControl
    {
     public tb_ProdSplitQuery() {
       ...
       // RuleFor(tb_ProdSplit => tb_ProdSplit.SplitID).NotEmpty();
