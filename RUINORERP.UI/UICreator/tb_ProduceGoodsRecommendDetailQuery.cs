...
namespace RUINORERP.UI
{
    ...
    /// 自制成品建议数据查询
    /// </summary>
     [MenuAttribute(typeof(tb_ProduceGoodsRecommendDetailQuery), "自制成品建议数据查询", true)]
    public partial class tb_ProduceGoodsRecommendDetailQuery:UserControl
    {
     public tb_ProduceGoodsRecommendDetailQuery() {
       ...
       // RuleFor(tb_ProduceGoodsRecommendDetail => tb_ProduceGoodsRecommendDetail.PDCID).NotEmpty();
