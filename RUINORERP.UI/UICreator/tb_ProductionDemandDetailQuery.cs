...
namespace RUINORERP.UI
{
    ...
    /// 生产需求分析表明细数据查询
    /// </summary>
     [MenuAttribute(typeof(tb_ProductionDemandDetailQuery), "生产需求分析表明细数据查询", true)]
    public partial class tb_ProductionDemandDetailQuery:UserControl
    {
     public tb_ProductionDemandDetailQuery() {
       ...
       // RuleFor(tb_ProductionDemandDetail => tb_ProductionDemandDetail.PDCID).NotEmpty();
