...
namespace RUINORERP.UI
{
    ...
    /// 项目及成员关系表
    /// </summary>
    partial class tb_ProjectGroupEmployeesEdit
    {
...
this.lblAssigned = new Krypton.Toolkit.KryptonLabel();
this.chkAssigned = new Krypton.Toolkit.KryptonCheckBox();
this.chkAssigned.Values.Text ="";

this.lblDefaultGroup = new Krypton.Toolkit.KryptonLabel();
this.chkDefaultGroup = new Krypton.Toolkit.KryptonCheckBox();
...
this.Controls.Add(this.chkDefaultGroup );
            ...
            this.Name = "tb_ProjectGroupEmployeesEdit";
...
private Krypton.Toolkit.KryptonComboBox cmbEmployee_ID;
              ...
              private Krypton.Toolkit.KryptonLabel lblAssigned;
private Krypton.Toolkit.KryptonCheckBox chkAssigned;

    
        
              private Krypton.Toolkit.KryptonLabel lblDefaultGroup;
private Krypton.Toolkit.KryptonCheckBox chkDefaultGroup;
