...
namespace RUINORERP.UI
{
    ...
    /// 采购商品建议数据查询
    /// </summary>
     [MenuAttribute(typeof(tb_PurGoodsRecommendDetailQuery), "采购商品建议数据查询", true)]
    public partial class tb_PurGoodsRecommendDetailQuery:UserControl
    {
     public tb_PurGoodsRecommendDetailQuery() {
       ...
       // RuleFor(tb_PurGoodsRecommendDetail => tb_PurGoodsRecommendDetail.PGRCID).NotEmpty();
