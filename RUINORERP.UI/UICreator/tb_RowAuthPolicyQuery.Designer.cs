...
namespace RUINORERP.UI
{
    ...
    /// 行级权限规则
    /// </summary>
    partial class tb_RowAuthPolicyQuery
    {
     ...
     this.lblPolicyName = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.txtPolicyName = new ComponentFactory.Krypton.Toolkit.KryptonTextBox();

this.lblTargetTable = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.txtTargetTable = new ComponentFactory.Krypton.Toolkit.KryptonTextBox();

this.lblTargetEntity = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.txtTargetEntity = new ComponentFactory.Krypton.Toolkit.KryptonTextBox();

this.lblIsJoinRequired = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.chkIsJoinRequired = new ComponentFactory.Krypton.Toolkit.KryptonCheckBox();
this.chkIsJoinRequired.Values.Text ="";

this.lblTargetTableJoinField = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.txtTargetTableJoinField = new ComponentFactory.Krypton.Toolkit.KryptonTextBox();

this.lblJoinTableJoinField = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.txtJoinTableJoinField = new ComponentFactory.Krypton.Toolkit.KryptonTextBox();

this.lblJoinTable = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.txtJoinTable = new ComponentFactory.Krypton.Toolkit.KryptonTextBox();

this.lblJoinType = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.txtJoinType = new ComponentFactory.Krypton.Toolkit.KryptonTextBox();

this.lblJoinOnClause = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.txtJoinOnClause = new ComponentFactory.Krypton.Toolkit.KryptonTextBox();
this.txtJoinOnClause.Multiline = true;

this.lblFilterClause = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.txtFilterClause = new ComponentFactory.Krypton.Toolkit.KryptonTextBox();
this.txtFilterClause.Multiline = true;

this.lblEntityType = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.txtEntityType = new ComponentFactory.Krypton.Toolkit.KryptonTextBox();
...
this.lblPolicyDescription = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.txtPolicyDescription = new ComponentFactory.Krypton.Toolkit.KryptonTextBox();
...
this.Controls.Add(this.dtpModified_at );
     ...
     //for start
              ...
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblPolicyName;
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtPolicyName;

    
        
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblTargetTable;
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtTargetTable;

    
        
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblTargetEntity;
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtTargetEntity;

    
        
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblIsJoinRequired;
private ComponentFactory.Krypton.Toolkit.KryptonCheckBox chkIsJoinRequired;

    
        
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblTargetTableJoinField;
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtTargetTableJoinField;

    
        
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblJoinTableJoinField;
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtJoinTableJoinField;

    
        
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblJoinTable;
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtJoinTable;

    
        
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblJoinType;
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtJoinType;

    
        
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblJoinOnClause;
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtJoinOnClause;

    
        
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblFilterClause;
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtFilterClause;

    
        
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblEntityType;
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtEntityType;
...
private ComponentFactory.Krypton.Toolkit.KryptonCheckBox chkIsEnabled;
              ...
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblPolicyDescription;
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtPolicyDescription;
