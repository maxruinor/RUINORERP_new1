...
namespace RUINORERP.UI
{
    ...
    /// 薪资发放表
    /// </summary>
    partial class tb_SalaryPaymentEdit
    {
     ...
     // this.btnCancel = new ComponentFactory.Krypton.Toolkit.KryptonButton();
      ...
      //for definition
     this.lblsalary_month = new Krypton.Toolkit.KryptonLabel();
this.dtpsalary_month = new Krypton.Toolkit.KryptonDateTimePicker();
...
this.Controls.Add(this.txtamount );
            ...
            this.Name = "tb_SalaryPaymentEdit";
     ...
     //for start
              ...
              private Krypton.Toolkit.KryptonLabel lblsalary_month;
private Krypton.Toolkit.KryptonDateTimePicker dtpsalary_month;
