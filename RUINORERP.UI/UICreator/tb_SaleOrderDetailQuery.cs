...
namespace RUINORERP.UI
{
    ...
    /// 销售订单明细数据查询
    /// </summary>
     [MenuAttribute(typeof(tb_SaleOrderDetailQuery), "销售订单明细数据查询", true)]
    public partial class tb_SaleOrderDetailQuery:UserControl
    {
     public tb_SaleOrderDetailQuery() {
       ...
       // RuleFor(tb_SaleOrderDetail => tb_SaleOrderDetail.SaleOrderDetail_ID).NotEmpty();
