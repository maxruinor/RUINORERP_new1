...
namespace RUINORERP.UI
{
    ...
    /// 销售出库退回明细数据查询
    /// </summary>
     [MenuAttribute(typeof(tb_SaleOutReDetailQuery), "销售出库退回明细数据查询", true)]
    public partial class tb_SaleOutReDetailQuery:UserControl
    {
     public tb_SaleOutReDetailQuery() {
       ...
       // RuleFor(tb_SaleOutReDetail => tb_SaleOutReDetail.SOutReturnDetail_ID).NotEmpty();
