...
namespace RUINORERP.UI
{
    ...
    /// 步骤定义
    /// </summary>
    partial class tb_StepBodyQuery
    {
     ...
     this.lblPara_Id = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.cmbPara_Id = new ComponentFactory.Krypton.Toolkit.KryptonComboBox();
...
this.lblTypeFullName = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.txtTypeFullName = new ComponentFactory.Krypton.Toolkit.KryptonTextBox();

this.lblAssemblyFullName = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
this.txtAssemblyFullName = new ComponentFactory.Krypton.Toolkit.KryptonTextBox();
...
this.Controls.Add(this.txtAssemblyFullName );
     ...
     //for start
              ...
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblPara_Id;
private ComponentFactory.Krypton.Toolkit.KryptonComboBox cmbPara_Id;
...
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtDisplayName;
              ...
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblTypeFullName;
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtTypeFullName;

    
        
              private ComponentFactory.Krypton.Toolkit.KryptonLabel lblAssemblyFullName;
private ComponentFactory.Krypton.Toolkit.KryptonTextBox txtAssemblyFullName;
