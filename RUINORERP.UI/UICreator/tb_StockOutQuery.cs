...
namespace RUINORERP.UI
{
    ...
    /// 出库单数据查询
    /// </summary>
     [MenuAttribute(typeof(tb_StockOutQuery), "出库单数据查询", true)]
    public partial class tb_StockOutQuery:UserControl
    {
     public tb_StockOutQuery() {
       ...
       // RuleFor(tb_StockOut => tb_StockOut.MainID).NotEmpty();
