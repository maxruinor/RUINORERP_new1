...
Location_ID_from主外字段不一致。Location_ID_to主外字段不一致。          Location_ID_from主外字段不一致。Location_ID_to主外字段不一致。 DataBindingHelper.BindData4TextBox<tb_StockTransfer>(entity, t => t.TotalQty, txtTotalQty, BindDataType4TextBox.Qty,false);
           ...
           DataBindingHelper.BindData4DataTime<tb_StockTransfer>(entity, t => t.Transfer_date, dtpTransfer_date,false);
