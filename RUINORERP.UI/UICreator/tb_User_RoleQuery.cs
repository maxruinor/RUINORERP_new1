...
namespace RUINORERP.UI
{
    ...
    /// 用户角色关系表数据查询
    /// </summary>
     [MenuAttribute(typeof(tb_User_RoleQuery), "用户角色关系表数据查询", true)]
    public partial class tb_User_RoleQuery:UserControl
    {
     public tb_User_RoleQuery() {
       ...
       // RuleFor(tb_User_Role => tb_User_Role.ID).NotEmpty();
