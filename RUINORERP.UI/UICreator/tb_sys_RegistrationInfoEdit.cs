...
/*
        ...
        tb_sys_RegistrationInfo entity = new tb_sys_RegistrationInfo();
                     entity.CompanyName = txtCompanyName.Text ;
                       ...
                       entity.LicenseType = Int32.Parse(txtLicenseType.Text);
        ...
        */
        ...
        _EditEntity = entity;
           ...
           DataBindingHelper.BindData4TextBox<tb_sys_RegistrationInfo>(entity, t => t.LicenseType, txtLicenseType, BindDataType4TextBox.Qty,false);
