...
namespace RUINORERP.UI.UserPersonalized
{
    ...
    public partial class frmInputDataColSetting : KryptonForm
    {
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            foreach (ListViewItem item in listView1.Items)
            {
                if (item.Tag is tb_UIInputDataField columnDisplays)
                {
        ...
        private async void frmMenuPersonalization_Load(object sender, EventArgs e)
        {
            ...
            DataBindingHelper.BindData4CheckBox<tb_UIMenuPersonalization>(MenuPersonSetting, k => k.EnableInputPresetValue, chkEnableInputPresetValue, false);
        ...
        private void LoadColumnDisplayList()
        {
            ...
            foreach (tb_UIInputDataField keyValue in InputFields)
            {
                ...
                //用这个来保存
                //lvi.ImageKey = keyValue.i.ToString();
        ...
        public tb_UIMenuPersonalization MenuPersonSetting { get; set; }
