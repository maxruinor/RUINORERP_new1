...
namespace RUINORERP.UI.WorkFlowDesigner.Nodes
{
    ...
    [NetronGraphShape("审核", "8ED1469D-90B2-43ab-B000-4FF5C682F536", "工作流", "RUINORERP.UI.WorkFlowDesigner.Nodes.ApprovalStep",
         "单据处理流程中的审核步骤图形")]
    public class ApprovalStep : BaseNode
    {
        #region Fields
        ...
        public ApprovalStep() : base()
        {
            ...
            NodeStepPropertyValue = new WF.BizOperation.Steps.ApprovalStep();
        ...
        /// </summary>
        public ApprovalStep(IGraphSite site) : base(site)
        {
        ...
        protected ApprovalStep(SerializationInfo info, StreamingContext context) : base(info, context)
        {
