...
namespace RUINORERP.UI.WorkFlowDesigner.Nodes
{
    ...
    [NetronGraphShape("通知", "8ED1469D-90B2-42ab-B000-4FF5C682F536", "工作流", "RUINORERP.UI.WorkFlowDesigner.Nodes.NotificationStep",
         "单据处理流程中的通知步骤图形")]
    public class NotificationStep : BaseNode
    {
        #region Fields
        ...
        /// Constructor
        /// </summary>
        public NotificationStep() : base()
        {
            NodeType = WFNodeType.Step;
            NodeStepPropertyValue = new WF.BizOperation.Steps.NotificationStep();
            Text = "通知";
        ...
        /// </summary>
        public NotificationStep(IGraphSite site) : base(site)
        {
        ...
        protected NotificationStep(SerializationInfo info, StreamingContext context) : base(info, context)
        {
