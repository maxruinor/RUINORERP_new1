...
namespace RUINORERP.UI.WorkFlowDesigner.Nodes
{
    ...
    public class OrSignNode : BaseNode
    {
        ...
        private OrSignStepExtension _extension; // 扩展属性
        ...
        public OrSignNode() : base()
        {
            ...
            _extension = new OrSignStepExtension(); // 初始化扩展属性
        ...
        protected OrSignNode(SerializationInfo info, StreamingContext context) : base(info, context)
        {
            ...
            _extension = (OrSignStepExtension)info.GetValue("Extension", typeof(OrSignStepExtension));
        }
        #endregion
        ...
        [Browsable(false)]
        public OrSignStepExtension Extension
        {
        ...
        public override void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue("Extension", _extension, typeof(OrSignStepExtension));
        }
