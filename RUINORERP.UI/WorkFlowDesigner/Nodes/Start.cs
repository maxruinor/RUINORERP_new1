...
namespace RUINORERP.UI.WorkFlowDesigner.Nodes
{
    ...
    [NetronGraphShape("开始", "8ED1469D-90B2-43ab-B000-4FF5C682F502", "工作流", "RUINORERP.UI.WorkFlowDesigner.Nodes.Start",
         "流程开始的节点图形")]
    public class Start : BaseNode
    {
        ...
        public Start() : base()
        {
            ...
            NodeStepPropertyValue = new WorkFlowContextData();
        ...
        /// </summary>
        public Start(IGraphSite site) : base(site)
        {
        ...
        protected override void SetPropertyBagValue(object sender, PropertySpecEventArgs e)
        {
            ...
            switch (e.Property.Name)
            {
                ...
                case "DataType":
                    ...
                    if (!(e.Value.ToString() == null))
                    {
                        _DataType = System.Convert.ToString(e.Value);
                    }
                    else
                    {
                        //MessageBox.Show("Not a valid label", "Invalid label", MessageBoxButtons.OK, MessageBoxIcon.Warning)
