...
namespace RUINORERP.UI.WorkFlowDesigner.Nodes
{
    ...
    [NetronGraphShape("提交", "8ED1469D-90B2-43ab-B000-4FF5C682F533", "工作流", "RUINORERP.UI.WorkFlowDesigner.Nodes.SubmitStep",
         "单据处理流程中的提交步骤图形")]
    public class SubmitStep : BaseNode
    {
        #region Fields
        ...
        /// Constructor
        /// </summary>
        public SubmitStep() : base()
        {
            NodeType = WFNodeType.Step;
            NodeStepPropertyValue = new WF.BizOperation.Steps.SubmitStep();
        ...
        /// </summary>
        public SubmitStep(IGraphSite site) : base(site)
        {
        ...
        protected SubmitStep(SerializationInfo info, StreamingContext context) : base(info, context)
        {
