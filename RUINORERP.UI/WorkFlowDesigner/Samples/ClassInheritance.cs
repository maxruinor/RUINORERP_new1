...
namespace RUINORERP.UI.WorkFlowDesigner
{
	...
	public class ClassInheritance : SampleBase
	{
		...
		public override void Run()
		{
            ...
            //the label
            Netron.GraphLib.BasicShapes.TextLabel shape = mediator.GraphControl.AddShape("4F878611-3196-4d12-BA36-705F502C8A6B", new PointF(50,400)) as Netron.GraphLib.BasicShapes.TextLabel;
			...
			mediator.GraphControl.GraphLayoutAlgorithm = Netron.GraphLib.GraphLayoutAlgorithms.Tree;
