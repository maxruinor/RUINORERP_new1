...
namespace RUINORERP.UI.WorkFlowDesigner
{
    ...
    public class TabFactory
    {
        ...
        private WFNodePropertiesTab wfNodePropertiesTab;
        ...
        private FlowNodeViewerTab   flowNodeTab;
        ...
        public WFNodePropertiesTab WFNodePropertiesTab
        {
            get
            {
                if (wfNodePropertiesTab == null)
                    CreateWFNodePropertiesTab(new TabCodon("节点属性", "节点属性", TabTypes.WFNodePropertiesTab));
                return wfNodePropertiesTab;
            }
        }
        ...
        public FlowNodeViewerTab FlowNodeViewerTab
        {
            ...
            {
                if (flowNodeTab == null)
                    CreateFlowNodesTab(new TabCodon("Shapes", "Shapes", TabTypes.FlowNodeViewer));
                return flowNodeTab;
            }
        }
        ...
        public object GetTab(TabCodon codon)
        {
            switch (codon.TabType)
            {
                ...
                case TabTypes.WFNodePropertiesTab:
                    if (wfNodePropertiesTab == null)
                        CreateWFNodePropertiesTab(codon);
                    return wfNodePropertiesTab;
        ...
        private void CreateWFNodePropertiesTab(TabCodon codon)
        {
            wfNodePropertiesTab = new WFNodePropertiesTab(this.mediator);
            wfNodePropertiesTab.Text = codon.Text;
            wfNodePropertiesTab.TabIdentifier = codon.CodonName;
            RaiseNewTab(wfNodePropertiesTab);
        ...
        private void CreateFlowNodesTab(TabCodon codon)
        {
            flowNodeTab = new FlowNodeViewerTab(this.mediator);
            flowNodeTab.Text = codon.Text;
            flowNodeTab.TabIdentifier = codon.CodonName;
            RaiseNewTab(flowNodeTab);
        ...
        private void CreateShapeFavoritesTab(TabCodon codon)
        {
            ...
            //string defaultFolder = ConfigurationSettings.AppSettings.Get
            //			("TemplateBrowserInitialDirectory");

            string defaultFolder = ConfigurationManager.AppSettings.Get
            ("TemplateBrowserInitialDirectory");
        ...
        private void CreateDiagramBrowserTab(TabCodon codon)
        {
            ...
            string initialPath = ConfigurationManager.AppSettings.Get("DiagramBrowserInitialDirectory");
