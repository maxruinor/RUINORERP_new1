...
namespace RUINORERP.UI.WorkFlowDesigner
{
    ...
    public class GraphTab : DockContent, ICobaltTab
    {
       ...
       // graphControl.onselectshape += new Netron.GraphLib.SelectShapeEventHandler(OnShapeSelected);
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            //添加流程节点的dll，因为业务太强写到的UI层
            graphControl.AddLibrary(Application.ExecutablePath);
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.graphControl.DefaultConnectionEnd = Netron.GraphLib.ConnectionEnd.RightFilledArrow;
    ...
    "r use the context menu to add shapes.";
        ...
        private void OnShowPropertieValue(object sender, object props)
        {
            try
            {
                mediator.ShowWFNodeProperties(props);
