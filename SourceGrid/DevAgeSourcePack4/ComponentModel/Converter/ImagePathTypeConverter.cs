...
namespace DevAge.ComponentModel.Converter
{
    ...
    /// Ô¶³ÌÍ¼Æ¬×ª»»Æ÷
    /// </summary>
    public class ImagePathTypeConverter :
#if !MINI
 System.ComponentModel.TypeConverter
    ...
    {
        #region Constructors
        public ImagePathTypeConverter(Type p_BaseType)  
        {
                                        ...
                                        Type sourceType)
        {
            if (sourceType == typeof(string))
                return true;
            if (sourceType == typeof(DevAge.Windows.Forms.DevAgeTextBox))
                return true;
