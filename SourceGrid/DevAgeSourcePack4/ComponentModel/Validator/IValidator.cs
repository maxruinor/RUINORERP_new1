...
namespace DevAge.ComponentModel.Validator
{
    ...
    public interface IValidator
    {
        ...
        /// by watson 添加 tag值
        object ObjectToValue(object tag_Object, object p_Object);
        ...
        /// by watson 添加 tag值
        object ValueToObject(object tag_Value, object p_Value, Type p_ReturnObjectType);
        /// <summary>
        ...
        /// <param name="p_Value"></param>
        /// <returns></returns>
        string ValueToString(object tag_value, object p_Value);
        /// <summary>
        ...
        /// <param name="p_Value"></param>
        /// <returns></returns>
        string ValueToDisplayString(object tag_value, object p_Value);
