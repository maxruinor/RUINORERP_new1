...
{
    /// <summary>
    /// Allow to customize the tooltiptext of a cell. This class read the tooltiptext from the ICellToolTipText.GetToolTipText.  
    /// This behavior can be shared between multiple cells.
    /// 允许自定义单元格的工具提示文本。此类从ICellToolTipText.GetToolTipText读取工具提示文本。此行为可以在多个单元格之间共享。
    /// </summary>
    public class ToolTipText : ControllerBase
    {
        ...
        /// </summary>
        public virtual void ApplyToolTipText(CellContext sender, EventArgs e)
        {
