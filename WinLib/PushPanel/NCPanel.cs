...
using WinLib.PushPanelEx.PushPanelEx;
...
namespace WinLib.PushPanelEx
{
    ...
    public class NCPanel : Panel
    {
            ...
            if (base.BackgroundImage != null)
            {
                ...
                try
                {
                    using (ImageDc imageDc = new ImageDc(bounds.Width, bounds.Height))
                    {
                       ...
                       WinLib.PushPanelEx.Win32.NativeMethods.BitBlt(
                            hDC,
                            clientRect.X,
                            clientRect.Y,
                            clientRect.Width,
        ...
        {
            IntPtr hDC = WinLib.PushPanelEx.Win32.NativeMethods.GetWindowDC(m.HWnd);
            ...
            try
            {
                ...
                {
                    WinLib.PushPanelEx.Win32.NativeMethods.ExcludeClipRect(
                        bufferedDC.Hdc,
                        client.Left,
                        client.Top,
                        client.Right,
            ...
            {
                WinLib.PushPanelEx.Win32.NativeMethods.ReleaseDC(m.HWnd, hDC);
            }
        }
        ...
        internal WINDOWINFO GetWindowInfo()
        {
            ...
            WinLib.PushPanelEx.Win32.NativeMethods.GetWindowInfo(base.Handle, ref info);
            return info;
        }

        protected void ChangeFrame()
        {
            WinLib.PushPanelEx.Win32.NativeMethods.SetWindowPos(
                base.Handle,
                IntPtr.Zero,
                0, 0, 0, 0,
        ...
        {
            WinLib.PushPanelEx.Win32.NativeMethods.RedrawWindow(
                base.Handle,
                IntPtr.Zero,
                IntPtr.Zero,
            ...
            IntPtr hDC, Rectangle bounds, Point offset)
        {
            ...
            {
                WinLib.PushPanelEx.Win32.NativeMethods.SendMessage(
                    base.Parent.Handle,
                    WM.WM_ERASEBKGND,
                    imageDc.Hdc,
                    0);
